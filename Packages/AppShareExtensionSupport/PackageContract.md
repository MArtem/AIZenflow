# AppShareExtensionSupport Package Contract
...
Standalone share extension import/storage support package. It owns generic share-item mechanics, not product-specific destinations.
