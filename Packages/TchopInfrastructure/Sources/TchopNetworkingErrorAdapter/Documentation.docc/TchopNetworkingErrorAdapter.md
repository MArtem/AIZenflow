...
@Metadata {
    @DisplayName("TchopNetworkingErrorAdapter")
}
...
`TchopNetworkingErrorAdapter` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
