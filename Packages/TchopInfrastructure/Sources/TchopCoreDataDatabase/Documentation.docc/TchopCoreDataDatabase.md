...
@Metadata {
    @DisplayName("TchopCoreDataDatabase")
}
...
`TchopCoreDataDatabase` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
