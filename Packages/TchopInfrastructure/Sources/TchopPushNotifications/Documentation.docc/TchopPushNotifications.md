...
@Metadata {
    @DisplayName("TchopPushNotifications")
}
...
`TchopPushNotifications` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
