# AppOnDeviceAI Package Contract
...
Standalone on-device AI abstraction package. Its FoundationModels implementation is compile-gated and fallback behavior is always available.
