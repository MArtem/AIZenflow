...
## Назначение
Проверить signal, determinism, coverage of failure paths, readability и maintenance cost.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **проверить signal, determinism, coverage of failure paths, readability и maintenance cost**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-14: «Test code review».
...
Особый фокус: проверить signal, determinism, coverage of failure paths, readability и maintenance cost.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
