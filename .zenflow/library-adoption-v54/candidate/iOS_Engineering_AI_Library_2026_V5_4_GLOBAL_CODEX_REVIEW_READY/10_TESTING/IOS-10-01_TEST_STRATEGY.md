...
## Назначение
Построить pyramid по рискам: unit/integration/UI/performance/snapshot только там, где оправдано.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **построить pyramid по рискам: unit/integration/UI/performance/snapshot только там, где оправдано**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-01: «Test strategy».
...
Особый фокус: построить pyramid по рискам: unit/integration/UI/performance/snapshot только там, где оправдано.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
