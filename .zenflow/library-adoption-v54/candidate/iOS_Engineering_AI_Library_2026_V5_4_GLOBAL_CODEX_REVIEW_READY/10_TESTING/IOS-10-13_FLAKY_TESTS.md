...
## Назначение
Классифицировать race/time/network/shared-state/order issues, не лечить retries.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **классифицировать race/time/network/shared-state/order issues, не лечить retries**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-13: «Flaky test diagnosis».
...
Особый фокус: классифицировать race/time/network/shared-state/order issues, не лечить retries.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-13.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
