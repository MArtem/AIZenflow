...
## Назначение
Стабилизировать существующие XCTest suites и мигрировать постепенно.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **стабилизировать существующие XCTest suites и мигрировать постепенно**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-03: «XCTest maintenance».
...
Особый фокус: стабилизировать существующие XCTest suites и мигрировать постепенно.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
