...
## Назначение
Контролировать clock, cancellation, task completion, actor boundaries без sleeps.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **контролировать clock, cancellation, task completion, actor boundaries без sleeps**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-05: «Async/concurrency tests».
...
Особый фокус: контролировать clock, cancellation, task completion, actor boundaries без sleeps.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
