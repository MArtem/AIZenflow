...
## Назначение
Критические user journeys, stable accessibility identifiers, launch state и deterministic fixtures.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **критические user journeys, stable accessibility identifiers, launch state и deterministic fixtures**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-04: «XCUITest».
...
Особый фокус: критические user journeys, stable accessibility identifiers, launch state и deterministic fixtures.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
