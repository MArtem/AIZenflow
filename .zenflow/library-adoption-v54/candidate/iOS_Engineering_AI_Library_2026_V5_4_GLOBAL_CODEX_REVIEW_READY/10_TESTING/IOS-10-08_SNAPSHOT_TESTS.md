...
## Назначение
Использовать избирательно; фиксировать locale/dynamic type/device traits и tolerances.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать избирательно; фиксировать locale/dynamic type/device traits и tolerances**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-08: «Snapshot tests».
...
Особый фокус: использовать избирательно; фиксировать locale/dynamic type/device traits и tolerances.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
