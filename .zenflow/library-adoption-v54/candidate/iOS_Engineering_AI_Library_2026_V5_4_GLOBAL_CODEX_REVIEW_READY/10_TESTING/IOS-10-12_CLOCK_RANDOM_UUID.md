...
id: IOS-10-12
type: skill
title: Deterministic time/random/UUID
domain: Testing
priority: production
baseline: Swift 6 / modern iOS
---

# Deterministic time/random/UUID
...
2. Зафиксируй инварианты и failure modes именно для задачи: **инъецировать controllable dependencies для воспроизводимых тестов**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-12: «Deterministic time/random/UUID».
...
Особый фокус: инъецировать controllable dependencies для воспроизводимых тестов.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
