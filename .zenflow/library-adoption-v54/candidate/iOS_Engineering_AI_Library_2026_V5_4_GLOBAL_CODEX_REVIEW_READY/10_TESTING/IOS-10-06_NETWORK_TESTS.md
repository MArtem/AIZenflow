...
## Назначение
URLProtocol/fakes, request assertions, error mapping, retry/cancellation и decoding fixtures.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **URLProtocol/fakes, request assertions, error mapping, retry/cancellation и decoding fixtures**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-06: «Networking tests».
...
Особый фокус: URLProtocol/fakes, request assertions, error mapping, retry/cancellation и decoding fixtures.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
