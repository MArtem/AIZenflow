...
## Назначение
@Test/#expect/#require, parameterized tests, tags, async tests и parallel-safety.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **@Test/#expect/#require, parameterized tests, tags, async tests и parallel-safety**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-02: «Swift Testing».
...
Особый фокус: @Test/#expect/#require, parameterized tests, tags, async tests и parallel-safety.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
