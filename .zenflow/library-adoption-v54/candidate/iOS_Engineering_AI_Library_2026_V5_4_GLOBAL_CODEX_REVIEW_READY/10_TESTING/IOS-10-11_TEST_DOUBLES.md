...
2. Зафиксируй инварианты и failure modes именно для задачи: **fake/stub/spy выбирать по поведению; избегать brittle mocks по implementation details**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-11: «Test doubles».
...
Особый фокус: fake/stub/spy выбирать по поведению; избегать brittle mocks по implementation details.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
