...
## Назначение
Isolated stores, migrations, conflict handling, transactions и corrupted data cases.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **isolated stores, migrations, conflict handling, transactions и corrupted data cases**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-10-07: «Persistence tests».
...
Особый фокус: isolated stores, migrations, conflict handling, transactions и corrupted data cases.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-10-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
