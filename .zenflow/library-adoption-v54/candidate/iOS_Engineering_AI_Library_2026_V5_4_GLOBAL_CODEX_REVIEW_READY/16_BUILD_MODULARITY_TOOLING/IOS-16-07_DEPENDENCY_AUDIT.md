...
2. Зафиксируй инварианты и failure modes именно для задачи: **necessity, maintenance, platform support, Swift 6 readiness, privacy, binary size, license, removal cost**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-07: «Third-party dependency audit».
...
Особый фокус: necessity, maintenance, platform support, Swift 6 readiness, privacy, binary size, license, removal cost.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
