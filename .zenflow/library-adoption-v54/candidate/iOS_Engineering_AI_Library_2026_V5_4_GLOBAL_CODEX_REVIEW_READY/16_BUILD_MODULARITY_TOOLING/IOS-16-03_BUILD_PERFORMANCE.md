...
2. Зафиксируй инварианты и failure modes именно для задачи: **измерить type-checking/modules/scripts/generated code/dependency graph, улучшать без хаков**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-03: «Build performance».
...
Особый фокус: измерить type-checking/modules/scripts/generated code/dependency graph, улучшать без хаков.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
