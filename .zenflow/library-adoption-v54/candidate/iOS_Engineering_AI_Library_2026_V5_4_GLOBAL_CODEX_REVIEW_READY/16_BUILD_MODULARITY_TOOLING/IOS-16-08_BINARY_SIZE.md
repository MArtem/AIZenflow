...
2. Зафиксируй инварианты и failure modes именно для задачи: **измерить symbols/resources/architectures/dependencies, optimize without degrading modularity blindly**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-08: «Binary size».
...
Особый фокус: измерить symbols/resources/architectures/dependencies, optimize without degrading modularity blindly.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
