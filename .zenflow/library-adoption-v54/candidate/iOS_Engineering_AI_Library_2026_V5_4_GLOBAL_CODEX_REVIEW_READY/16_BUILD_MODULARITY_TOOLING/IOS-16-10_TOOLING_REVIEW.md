...
2. Зафиксируй инварианты и failure modes именно для задачи: **проверить build determinism, scripts, cache assumptions, developer ergonomics и CI parity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-10: «Tooling review».
...
Особый фокус: проверить build determinism, scripts, cache assumptions, developer ergonomics и CI parity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
