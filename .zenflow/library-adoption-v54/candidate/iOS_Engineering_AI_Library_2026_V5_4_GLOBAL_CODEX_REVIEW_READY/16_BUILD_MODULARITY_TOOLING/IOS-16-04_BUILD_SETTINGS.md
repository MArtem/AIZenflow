...
2. Зафиксируй инварианты и failure modes именно для задачи: **конфигурации, xcconfig, flags, warnings, Swift mode и environment separation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-04: «Build settings».
...
Особый фокус: конфигурации, xcconfig, flags, warnings, Swift mode и environment separation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
