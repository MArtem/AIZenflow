...
2. Зафиксируй инварианты и failure modes именно для задачи: **разделить public config и secrets, xcconfig/env/CI handling, no secret in bundle/source**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-09: «Configuration/secrets».
...
Особый фокус: разделить public config и secrets, xcconfig/env/CI handling, no secret in bundle/source.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
