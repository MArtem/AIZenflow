...
2. Зафиксируй инварианты и failure modes именно для задачи: **автоматизировать consistent style без конфликтов с compiler/readability и без noisy churn**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-06: «Lint/format».
...
Особый фокус: автоматизировать consistent style без конфликтов с compiler/readability и без noisy churn.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
