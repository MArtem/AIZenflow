...
2. Зафиксируй инварианты и failure modes именно для задачи: **targets/products/resources/plugins, dependency graph, visibility и test structure**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-01: «Swift Package design».
...
Особый фокус: targets/products/resources/plugins, dependency graph, visibility и test structure.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
