...
2. Зафиксируй инварианты и failure modes именно для задачи: **избежать cycles, layer violations, transitive dependency sprawl и slow rebuilds**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-02: «Module graph».
...
Особый фокус: избежать cycles, layer violations, transitive dependency sprawl и slow rebuilds.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
