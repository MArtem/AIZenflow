...
domain: Build, Modularity & Tooling
priority: production
...
2. Зафиксируй инварианты и failure modes именно для задачи: **детерминированный generation, checked-in policy, schema versioning, CI verification и no hidden side effects**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-16-05: «Code generation».
...
Особый фокус: детерминированный generation, checked-in policy, schema versioning, CI verification и no hidden side effects.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-16-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
