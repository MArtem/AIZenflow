...
5. Проверь: Dynamic Type, baselines, wrapping, locale, accessibility, rendering cost.
...
## Готовый prompt
```text
Примени skill IOS-26-04: «Typography system» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: Dynamic Type-first typography, variable fonts where appropriate, truncation/wrapping and localization expansion.
Проверь: Dynamic Type, baselines, wrapping, locale, accessibility, rendering cost.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
