...
## Назначение
Типизировать color/spacing/type/radius/motion tokens, support dark/high-contrast and avoid magic values.
...
5. Проверь: semantic naming, dynamic color, scale, a11y, cross-platform consistency, migration.
...
## Готовый prompt
```text
Примени skill IOS-26-01: «Design tokens» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: типизировать color/spacing/type/radius/motion tokens, support dark/high-contrast and avoid magic values.
Проверь: semantic naming, dynamic color, scale, a11y, cross-platform consistency, migration.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
