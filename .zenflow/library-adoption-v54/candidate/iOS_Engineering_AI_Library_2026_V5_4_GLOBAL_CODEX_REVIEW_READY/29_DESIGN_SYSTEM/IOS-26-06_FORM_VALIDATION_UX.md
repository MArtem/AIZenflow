...
5. Проверь: timing, cancellation, focus, a11y announcements, localization, security.
...
## Готовый prompt
```text
Примени skill IOS-26-06: «Validation UX» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: field vs form validation, async validation cancellation, error focus/announcement and localization.
Проверь: timing, cancellation, focus, a11y announcements, localization, security.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
