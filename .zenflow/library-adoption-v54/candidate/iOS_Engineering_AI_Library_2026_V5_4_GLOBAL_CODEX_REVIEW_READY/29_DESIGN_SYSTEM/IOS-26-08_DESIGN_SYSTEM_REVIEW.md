...
5. Проверь: token drift, component duplication, a11y, API stability, migration, performance.
...
## Готовый prompt
```text
Примени skill IOS-26-08: «Design system review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: consistency without rigidity, API sprawl, a11y coverage, performance and adoption/migration path.
Проверь: token drift, component duplication, a11y, API stability, migration, performance.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
