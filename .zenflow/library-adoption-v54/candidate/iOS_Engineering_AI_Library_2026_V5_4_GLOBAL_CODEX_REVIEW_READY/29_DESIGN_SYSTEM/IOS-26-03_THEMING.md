...
5. Проверь: scope, dynamic updates, contrast, snapshot matrix, performance, fallback.
...
## Готовый prompt
```text
Примени skill IOS-26-03: «Theming» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: semantic theme values, environment/scoping, dark mode, high contrast and brand variants without global mutation.
Проверь: scope, dynamic updates, contrast, snapshot matrix, performance, fallback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
