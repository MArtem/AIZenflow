...
5. Проверь: API surface, state matrix, a11y, theming, previews, tests.
...
## Готовый prompt
```text
Примени skill IOS-26-02: «Component library» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: строить composable components with clear states, accessibility, previews, docs and visual regression strategy.
Проверь: API surface, state matrix, a11y, theming, previews, tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
