...
5. Проверь: symbol availability, RTL, contrast, labels, variable rendering, asset size.
...
## Готовый prompt
```text
Примени skill IOS-26-05: «Icons/SF Symbols» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: semantic symbols, rendering modes, localization/RTL, accessibility labels and fallback assets.
Проверь: symbol availability, RTL, contrast, labels, variable rendering, asset size.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-26-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
