...
2. Зафиксируй инварианты и failure modes именно для задачи: **reduce nondeterminism, capture environment/state, seed/clock/network fixtures и minimal repro**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-05: «Bug reproduction».
...
Особый фокус: reduce nondeterminism, capture environment/state, seed/clock/network fixtures и minimal repro.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
