...
2. Зафиксируй инварианты и failure modes именно для задачи: **stop writes, preserve evidence, schema/migration validation, recovery path и user data safety**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-08: «Data corruption».
...
Особый фокус: stop writes, preserve evidence, schema/migration validation, recovery path и user data safety.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
