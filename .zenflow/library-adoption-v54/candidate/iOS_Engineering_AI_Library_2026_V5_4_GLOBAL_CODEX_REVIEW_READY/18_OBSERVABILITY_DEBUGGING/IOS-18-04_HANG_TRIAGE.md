...
2. Зафиксируй инварианты и failure modes именно для задачи: **thread stacks, main actor sync work, locks, I/O, layout и signpost evidence**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-04: «Hang/main-thread stall».
...
Особый фокус: thread stacks, main actor sync work, locks, I/O, layout и signpost evidence.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
