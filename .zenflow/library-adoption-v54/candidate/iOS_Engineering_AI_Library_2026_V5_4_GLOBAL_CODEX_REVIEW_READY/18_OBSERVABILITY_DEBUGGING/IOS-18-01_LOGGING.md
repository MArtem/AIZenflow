...
2. Зафиксируй инварианты и failure modes именно для задачи: **subsystem/category, levels, privacy, stable event names, correlation и no sensitive payload**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-01: «OSLog strategy».
...
Особый фокус: subsystem/category, levels, privacy, stable event names, correlation и no sensitive payload.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
