...
2. Зафиксируй инварианты и failure modes именно для задачи: **symbolication, affected versions/devices, stack ownership, reproduction, regression range и fix verification**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-03: «Crash triage».
...
Особый фокус: symbolication, affected versions/devices, stack ownership, reproduction, regression range и fix verification.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
