...
2. Зафиксируй инварианты и failure modes именно для задачи: **success/failure/latency/cancellation funnels, SLOs, dimensions without PII и alert thresholds**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-09: «Feature observability».
...
Особый фокус: success/failure/latency/cancellation funnels, SLOs, dimensions without PII и alert thresholds.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
