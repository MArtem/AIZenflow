...
2. Зафиксируй инварианты и failure modes именно для задачи: **TSAN/strict concurrency/compiler diagnostics/log sequencing и isolation redesign**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-06: «Race diagnosis».
...
Особый фокус: TSAN/strict concurrency/compiler diagnostics/log sequencing и isolation redesign.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
