...
2. Зафиксируй инварианты и failure modes именно для задачи: **достаточны ли logs/metrics/ids/state transitions для расследования без reproducing everything**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-10: «Debuggability review».
...
Особый фокус: достаточны ли logs/metrics/ids/state transitions для расследования без reproducing everything.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
