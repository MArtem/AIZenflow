...
2. Зафиксируй инварианты и failure modes именно для задачи: **production performance/crash signals, custom metrics/signposts, aggregation и privacy-aware telemetry**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-18-02: «MetricKit».
...
Особый фокус: production performance/crash signals, custom metrics/signposts, aggregation и privacy-aware telemetry.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-18-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
