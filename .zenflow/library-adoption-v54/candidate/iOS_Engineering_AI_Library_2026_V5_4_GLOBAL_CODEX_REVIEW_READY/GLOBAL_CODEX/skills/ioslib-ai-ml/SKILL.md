---
name: ioslib-ai-ml
description: Use for Foundation Models, Core AI, Core ML, Vision, on-device inference, tool calling, prompts, evals, fallback, or AI feature architecture on Apple platforms.
---
...
## Goal
Treat model capability as a versioned dependency with privacy, evals and deterministic safety boundaries.
