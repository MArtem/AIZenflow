---
name: ioslib-media-graphics
description: Use for AVFoundation, audio sessions, camera, video, Core Image, Core Graphics, Core Animation, Metal, PDFKit, or media performance/lifecycle.
---
...
## Goal
Protect scarce resource lifecycle, interruption behavior and measured rendering/media performance.
