---
name: ioslib-architecture
description: Use for module boundaries, state ownership, dependency direction, DI, use-case/service design, navigation ownership, or architecture refactors.
---
...
## Goal
Choose the simplest architecture that protects actual project invariants and testability.
