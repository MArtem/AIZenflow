---
name: ioslib-code-review
description: Use to review Swift/iOS code or a local diff for correctness, concurrency, lifecycle, API, persistence, security, performance, accessibility, and regression risks with concrete findings only.
---
...
## Goal
Find reproducible or plausible failure modes; avoid style-noise.
