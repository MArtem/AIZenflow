---
name: ioslib-persistence
description: Use for SwiftData, Core Data, SQLite, file storage, caches, transactions, model contexts, or persistence correctness and performance.
---
...
## Goal
Protect data integrity, isolation, schema semantics and recovery.
