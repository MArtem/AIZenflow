---
name: ioslib-repo-intake
description: Use when first entering an iOS repository, when project facts are stale, or before broad work that needs verified targets, schemes, Swift mode, dependencies, tests, CI, persistence, auth, and extension topology.
---
...
## Goal
Inspect repository structure and populate/refresh project facts without changing product code.
