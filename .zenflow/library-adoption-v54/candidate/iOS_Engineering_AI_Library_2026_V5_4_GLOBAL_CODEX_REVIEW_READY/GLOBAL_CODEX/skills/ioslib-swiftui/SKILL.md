---
name: ioslib-swiftui
description: Use for SwiftUI implementation/review involving state, Observation, identity, view updates, navigation, tasks, performance, accessibility, or UIKit bridging.
---
...
## Goal
Protect state/identity/lifecycle semantics and avoid wrapper cargo-culting.
