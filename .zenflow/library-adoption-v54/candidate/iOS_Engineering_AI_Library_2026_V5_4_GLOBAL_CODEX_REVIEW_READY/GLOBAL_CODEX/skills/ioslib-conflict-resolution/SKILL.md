---
name: ioslib-conflict-resolution
description: Use when iOS specialists disagree; resolve with invariants and the smallest missing evidence or experiment rather than vote or authority.
---

# ioslib-conflict-resolution
...
## Goal
Use when iOS specialists disagree; resolve with invariants and the smallest missing evidence or experiment rather than vote or authority.
