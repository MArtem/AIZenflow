---
name: ioslib-uikit
description: Use for UIKit controller/view lifecycle, containment, reuse, Auto Layout, collections/tables, diffable data sources, presentation, or SwiftUI bridging.
---
...
## Goal
Make lifecycle, ownership and update ordering explicit.
