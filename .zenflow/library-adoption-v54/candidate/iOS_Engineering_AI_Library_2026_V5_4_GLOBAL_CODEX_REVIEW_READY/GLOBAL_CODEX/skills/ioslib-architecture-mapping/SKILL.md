---
name: ioslib-architecture-mapping
description: Use when repository architecture, state ownership, navigation roots or module boundaries must be mapped before a change.
---

# ioslib-architecture-mapping
...
## Goal
Map concrete structural signals and ownership evidence; keep architecture naming heuristic unless explicitly established.
