---
name: ioslib-parallel-investigation
description: Use for independent read-only repository investigations such as module discovery, root-cause hypotheses or cross-domain evidence gathering.
---

# ioslib-parallel-investigation
...
## Goal
Use for independent read-only repository investigations such as module discovery, root-cause hypotheses or cross-domain evidence gathering.
