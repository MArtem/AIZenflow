---
name: ioslib-test-flake
description: Use when iOS tests are intermittent, order-dependent, timing-sensitive, simulator-dependent, or failing only in CI.
---
...
## Goal
Find the nondeterminism source instead of hiding it with retries or sleeps.
