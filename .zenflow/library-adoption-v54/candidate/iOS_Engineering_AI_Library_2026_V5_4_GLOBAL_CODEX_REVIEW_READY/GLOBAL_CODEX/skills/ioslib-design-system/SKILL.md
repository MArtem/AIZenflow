---
name: ioslib-design-system
description: Use for design tokens, reusable SwiftUI/UIKit components, theming, typography, spacing, accessibility semantics, component APIs, or visual consistency refactors.
---
...
## Goal
Treat component semantics and accessibility as stable API, not screenshot-only styling.
