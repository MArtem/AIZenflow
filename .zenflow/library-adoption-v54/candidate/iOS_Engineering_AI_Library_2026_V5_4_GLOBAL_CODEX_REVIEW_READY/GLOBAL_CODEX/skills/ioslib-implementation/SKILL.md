---
name: ioslib-implementation
description: Use when implementing or modifying iOS behavior in an existing repository and the task needs repository-aware Swift code, tests, compatibility, and evidence rather than a standalone snippet.
---
...
## Goal
Implement the smallest coherent behavior change while preserving local architecture and repository contracts.
