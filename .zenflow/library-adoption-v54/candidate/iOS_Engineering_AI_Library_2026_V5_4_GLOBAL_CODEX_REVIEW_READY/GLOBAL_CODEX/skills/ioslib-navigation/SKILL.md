---
name: ioslib-navigation
description: Use for SwiftUI/UIKit navigation architecture, deep links, universal links, restoration, auth gating, route parsing, or cross-target handoff.
---
...
## Goal
Treat routes as stable state with validation, ownership and restoration semantics.
