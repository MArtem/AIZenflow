---
name: ioslib-change-plan
description: Use before R2+ iOS changes, architecture work, migrations, public API changes, or any change where blast radius and rollback need to be explicit before editing.
---
...
## Goal
Produce an execution-ready change plan grounded in call sites, invariants, alternatives and verification.
