---
name: ioslib-swift-concurrency
description: Use for Swift 6 concurrency implementation, review, migration, actor isolation, Sendable diagnostics, Tasks, AsyncSequence, continuations, cancellation, or suspected races.
---
...
## Goal
Make isolation and task lifetime correct by design instead of suppressing compiler diagnostics.
