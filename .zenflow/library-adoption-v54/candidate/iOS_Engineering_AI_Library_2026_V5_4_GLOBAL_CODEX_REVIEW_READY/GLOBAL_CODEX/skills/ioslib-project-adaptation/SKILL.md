---
name: ioslib-project-adaptation
description: Adapt an iOS repository into evidence-labelled project context, target/build maps, risks and active skills without modifying product code.
---

# ioslib-project-adaptation
...
## Goal
Build/refresh the V4 project model, render generated context, keep observed/derived/heuristic/unknown separate, and validate artifacts.
