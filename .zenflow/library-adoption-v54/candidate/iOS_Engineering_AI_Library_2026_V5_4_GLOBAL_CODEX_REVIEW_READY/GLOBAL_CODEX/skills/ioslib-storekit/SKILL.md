---
name: ioslib-storekit
description: Use for StoreKit 2 purchases, subscriptions, transaction verification, entitlement state, restore flows, server sync, or purchase-related release changes.
---
...
## Goal
Protect verified transaction and entitlement invariants across app/server lifecycle.
