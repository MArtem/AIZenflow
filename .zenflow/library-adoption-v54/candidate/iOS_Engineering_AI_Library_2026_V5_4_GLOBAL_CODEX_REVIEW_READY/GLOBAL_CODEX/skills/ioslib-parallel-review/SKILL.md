---
name: ioslib-parallel-review
description: Use for independent read-only iOS review lenses whose findings must be evidence-ranked, deduplicated and conflict-resolved before synthesis.
---

# ioslib-parallel-review
...
## Goal
Use for independent read-only iOS review lenses whose findings must be evidence-ranked, deduplicated and conflict-resolved before synthesis.
