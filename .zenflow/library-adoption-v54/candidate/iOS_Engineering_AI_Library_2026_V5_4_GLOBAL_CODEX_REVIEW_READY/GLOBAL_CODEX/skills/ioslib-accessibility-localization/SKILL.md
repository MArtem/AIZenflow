---
name: ioslib-accessibility-localization
description: Use for accessibility, Dynamic Type, VoiceOver, switch/keyboard access, contrast, reduce motion, RTL, localization, plurals, dates/numbers, or layout expansion.
---
...
## Goal
Treat inclusive behavior and locale correctness as functional requirements.
