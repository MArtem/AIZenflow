---
name: ioslib-observability
description: Use to add or review logs, OSLog, signposts, MetricKit metrics, analytics, breadcrumbs, diagnostics, and production evidence for critical flows.
---
...
## Goal
Instrument specific diagnostic questions without leaking sensitive data or creating noisy telemetry.
