---
name: ioslib-context-drift
description: Use when project context may be stale after target, dependency, CI, migration, auth, release or module changes.
---

# ioslib-context-drift
...
## Goal
Compare model fingerprint and generated artifacts, identify what changed, refresh context and preserve human decision records.
