---
name: ioslib-risk-mapping
description: Use before broad or high-impact work to identify repository-specific blast-radius boundaries and route audits.
---
...
## Goal
Generate risk leads with severity, confidence, evidence and matching audit skills; never call heuristic leads confirmed defects.
