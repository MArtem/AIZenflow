---
name: ioslib-active-skill-selection
description: Use to reduce context and select the narrowest relevant iOS engineering skills for the current repository/task.
---

# ioslib-active-skill-selection
...
## Goal
Select baseline and domain skills from affected targets, detected technologies and risk boundaries while allowing explicit task overrides.
