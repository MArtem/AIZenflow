---
name: ioslib-testing
description: Use for Swift Testing, XCTest, XCUITest, integration/contract tests, test architecture, fixtures, async tests, and selecting the right regression coverage.
---
...
## Goal
Test observable contracts with deterministic synchronization and meaningful failure diagnostics.
