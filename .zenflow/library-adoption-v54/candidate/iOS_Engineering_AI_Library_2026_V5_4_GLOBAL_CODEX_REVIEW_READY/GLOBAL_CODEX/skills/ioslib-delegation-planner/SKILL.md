---
name: ioslib-delegation-planner
description: Use to decide whether an iOS task should use subagents and to create a bounded DAG with roles, dependencies, read/write scopes, evidence and stop conditions.
---

# ioslib-delegation-planner
...
## Goal
Use to decide whether an iOS task should use subagents and to create a bounded DAG with roles, dependencies, read/write scopes, evidence and stop conditions.
