---
name: ioslib-diagnostic
description: Use for bugs, incorrect behavior, hangs, races, leaks, data loss, or regressions where root cause is not yet proven.
---
...
## Goal
Form falsifiable hypotheses and obtain discriminating evidence before changing architecture.
