---
name: ioslib-offline-sync
description: Use for local-first/offline features, synchronization engines, conflict resolution, retry queues, deduplication, or eventual consistency.
---
...
## Goal
Define authoritative state and deterministic conflict/replay semantics.
