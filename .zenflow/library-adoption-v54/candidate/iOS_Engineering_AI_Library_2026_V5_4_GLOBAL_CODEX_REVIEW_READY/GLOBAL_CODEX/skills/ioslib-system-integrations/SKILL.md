---
name: ioslib-system-integrations
description: Use for Bluetooth, NFC, HealthKit, Core Location, WatchConnectivity, CarPlay, Home/Matter, Nearby Interaction, notifications, background tasks, or extension integrations.
---
...
## Goal
Model permissions, system lifecycle, unavailable states and cross-target ownership explicitly.
