---
name: ioslib-legacy-modernization
description: Use for large UIKit/Objective-C/old Swift/concurrency/persistence modernization where new and old paths must coexist safely.
---
...
## Goal
Migrate bounded slices with characterization tests, compatibility shims and explicit cleanup criteria.
