---
name: ioslib-crash-debugging
description: Use when investigating iOS crashes from crash logs, stack traces, exceptions, signals, watchdogs, or reproducible crash scenarios.
---
...
## Goal
Localize crash mechanism and violated invariant using symbolicated evidence and surrounding ownership/lifecycle.
