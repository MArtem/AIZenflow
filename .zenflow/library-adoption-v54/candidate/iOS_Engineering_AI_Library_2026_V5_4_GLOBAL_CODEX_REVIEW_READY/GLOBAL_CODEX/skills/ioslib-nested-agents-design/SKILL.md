---
name: ioslib-nested-agents-design
description: Use when proposing or reviewing directory-scoped AGENTS.md rules for an iOS repository.
---

# ioslib-nested-agents-design
...
## Goal
Propose narrow stable subtree rules, reason about precedence, avoid duplication, and stage candidates for human placement.
