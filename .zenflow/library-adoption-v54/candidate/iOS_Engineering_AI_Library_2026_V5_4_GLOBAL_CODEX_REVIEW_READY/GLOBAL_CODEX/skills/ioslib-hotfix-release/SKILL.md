---
name: ioslib-hotfix-release
description: Use for urgent production fixes where blast radius must be minimized and release/rollback evidence matters more than cleanup or broad refactoring.
---
...
## Goal
Patch the proven root cause with containment, telemetry and reversible rollout.
