---
name: ioslib-build-ci
description: Use for xcodebuild, schemes, destinations, build settings, CI failures, caching, SPM resolution, generated code, signing diagnostics, and deterministic test execution.
---
...
## Goal
Reproduce the actual merge/release gate and isolate environment/toolchain differences.
