---
name: ioslib-data-migration
description: Use when changing persisted schemas, stores, serialization formats, keys, identifiers, or moving between SwiftData/Core Data/SQLite/files.
---
...
## Goal
Design migrations before destructive model changes and prove representative old-data upgrade.
