---
name: ioslib-multi-agent-orchestrator
description: Use when the user or repository policy explicitly asks for bounded multi-agent iOS work; build a minimal task graph, delegate independent nodes, synthesize evidence, integrate and verify.
---

# ioslib-multi-agent-orchestrator
...
## Goal
Use when the user or repository policy explicitly asks for bounded multi-agent iOS work; build a minimal task graph, delegate independent nodes, synthesize evidence, integrate and verify.
