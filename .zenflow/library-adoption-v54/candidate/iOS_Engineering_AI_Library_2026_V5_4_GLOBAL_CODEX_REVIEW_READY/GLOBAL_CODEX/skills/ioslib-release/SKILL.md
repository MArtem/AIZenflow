---
name: ioslib-release
description: Use for release readiness, TestFlight/App Store gates, version/build changes, signing configuration review, rollout, crash/performance signals, or release checklists.
---
...
## Goal
Require evidence, migration readiness, observability and rollback before shipping.
