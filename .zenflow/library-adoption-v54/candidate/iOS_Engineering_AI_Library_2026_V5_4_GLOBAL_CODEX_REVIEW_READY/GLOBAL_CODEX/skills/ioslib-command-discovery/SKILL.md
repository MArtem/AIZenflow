---
name: ioslib-command-discovery
description: Use when build/test/lint/release commands are missing, stale, failing, or need repository-specific verification.
---

# ioslib-command-discovery
...
## Goal
Trace CI to repository scripts and Xcode schemes; distinguish observed canonical candidates from synthesized suggestions.
