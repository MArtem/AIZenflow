---
name: ioslib-pr-review
description: Use for end-to-end pull request review when the change spans multiple files or targets and needs risk-ranked findings, compatibility analysis, test-gap review, and release impact.
---
...
## Goal
Review the PR as a system change, not isolated lines.
