---
name: ioslib-memory-leaks
description: Use for retain cycles, leaks, unexpected object lifetime, unbounded caches, observers, timers, Combine/AsyncSequence subscriptions, or task/resource cleanup.
---
...
## Goal
Trace the actual retaining path and make lifetime ownership explicit.
