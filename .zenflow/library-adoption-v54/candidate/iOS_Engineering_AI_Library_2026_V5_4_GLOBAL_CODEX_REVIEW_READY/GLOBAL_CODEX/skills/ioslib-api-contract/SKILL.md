---
name: ioslib-api-contract
description: Use when backend schemas, OpenAPI/GraphQL/JSON models, pagination, error contracts, enum evolution, timestamps, or client/server version compatibility change.
---
...
## Goal
Prevent silent decoding/semantic breakage across client/server rollout.
