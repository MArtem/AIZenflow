---
name: ioslib-dependencies
description: Use before adding/upgrading/removing SPM packages, binary SDKs, CocoaPods, build plugins, or third-party integrations.
---

# iOS Dependency Governance
...
## Goal
Admit dependencies only with a justified boundary, compatibility and exit plan.
