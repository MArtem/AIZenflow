---
name: ioslib-task-router
description: Use for ambiguous or cross-cutting iOS engineering tasks to choose the smallest set of repository skills and deep playbooks before implementation, review, diagnosis, or migration.
---
...
## Goal
Route the task by observable outcome and risk boundary; avoid loading the full library.
