---
name: ioslib-modularity-spm
description: Use for Swift Package extraction, module boundaries, target graph, build plugins, resources, package APIs, or modularization planning.
---
...
## Goal
Create boundaries that reflect ownership and change patterns, not arbitrary folder splitting.
