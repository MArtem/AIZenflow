---
name: ioslib-performance
description: Use for CPU, memory, launch, hang, scrolling, rendering, I/O, energy, binary size, or latency regressions that need measurement-driven optimization.
---
...
## Goal
Measure the user-relevant bottleneck and require before/after evidence.
