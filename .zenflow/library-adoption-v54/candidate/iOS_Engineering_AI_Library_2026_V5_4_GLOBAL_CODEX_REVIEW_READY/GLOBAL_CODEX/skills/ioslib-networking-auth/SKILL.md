---
name: ioslib-networking-auth
description: Use for URLSession/API clients, auth sessions, token refresh, retries, HTTP errors, caching, uploads/downloads, WebSockets, or offline-aware networking.
---
...
## Goal
Protect API semantics, session ownership and concurrency-safe recovery paths.
