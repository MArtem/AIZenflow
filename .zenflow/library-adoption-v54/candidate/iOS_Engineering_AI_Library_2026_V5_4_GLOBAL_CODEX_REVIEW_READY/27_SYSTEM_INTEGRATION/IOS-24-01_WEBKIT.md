...
5. Проверь: navigation policy, JS bridge surface, process termination, cookies, downloads, security.
...
## Готовый prompt
```text
Примени skill IOS-24-01: «WKWebView integration» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: process/navigation lifecycle, async JS bridge, content worlds, downloads, cookies, auth and safe URL policy.
Проверь: navigation policy, JS bridge surface, process termination, cookies, downloads, security.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
