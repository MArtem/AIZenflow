...
5. Проверь: entitlements, lifecycle, background semantics, privacy, versioning, fallback.
...
## Готовый prompt
```text
Примени skill IOS-24-14: «System integration review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: entitlements, scene/background lifecycle, delivery guarantees, version skew, privacy and recovery.
Проверь: entitlements, lifecycle, background semantics, privacy, versioning, fallback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
