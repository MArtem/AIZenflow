...
5. Проверь: sampling rate, energy, sensor absence, queueing, privacy, calibration.
...
## Готовый prompt
```text
Примени skill IOS-24-10: «Core Motion» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: update frequency, reference frames, energy, background behavior, sensor availability and filtering.
Проверь: sampling rate, energy, sensor absence, queueing, privacy, calibration.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
