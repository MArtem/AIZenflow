...
5. Проверь: authorization, network/device state, ownership, background, privacy, recovery.
...
## Готовый prompt
```text
Примени skill IOS-24-12: «Home/Matter integration» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: authorization, home/accessory topology, commissioning lifecycle, errors and privacy.
Проверь: authorization, network/device state, ownership, background, privacy, recovery.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
