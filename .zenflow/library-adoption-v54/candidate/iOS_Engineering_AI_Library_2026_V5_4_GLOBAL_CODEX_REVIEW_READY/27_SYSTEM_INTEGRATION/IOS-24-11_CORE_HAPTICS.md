...
5. Проверь: capability, engine reset, resource lifetime, Reduce Motion/sensory alternative, latency.
...
## Готовый prompt
```text
Примени skill IOS-24-11: «Core Haptics» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: engine lifecycle, capability checks, interruption/reset, pattern assets and accessibility alternatives.
Проверь: capability, engine reset, resource lifetime, Reduce Motion/sensory alternative, latency.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
