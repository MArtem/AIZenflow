...
5. Проверь: delivery semantics, ordering, deduplication, versioning, background, storage.
...
## Готовый prompt
```text
Примени skill IOS-24-07: «WatchConnectivity» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: reachable vs background transfers, queues, deduplication, ordering, app state and version skew.
Проверь: delivery semantics, ordering, deduplication, versioning, background, storage.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
