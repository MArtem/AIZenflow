...
5. Проверь: identifier stability, privacy, indexing cost, deletion, deep links, availability.
...
## Готовый prompt
```text
Примени skill IOS-24-03: «Core Spotlight» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: index stable identifiers, batching, deletion, privacy-sensitive content, deep links и reindex strategy.
Проверь: identifier stability, privacy, indexing cost, deletion, deep links, availability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
