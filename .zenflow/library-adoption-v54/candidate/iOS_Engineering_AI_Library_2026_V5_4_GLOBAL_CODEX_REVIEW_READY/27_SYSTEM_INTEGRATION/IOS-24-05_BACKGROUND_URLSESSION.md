...
5. Проверь: session identity, relaunch, file ownership, retry/idempotency, power/network policy, tests.
...
## Готовый prompt
```text
Примени skill IOS-24-05: «Background URLSession» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: identifier/session restoration, file handoff, discretionary scheduling, completion handlers и retries.
Проверь: session identity, relaunch, file ownership, retry/idempotency, power/network policy, tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-24-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
