...
2. Зафиксируй инварианты и failure modes именно для задачи: **отделить transport/persistence DTO от domain model там, где это защищает инварианты и уменьшает churn**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-09: «Domain modeling».
...
Особый фокус: отделить transport/persistence DTO от domain model там, где это защищает инварианты и уменьшает churn.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
