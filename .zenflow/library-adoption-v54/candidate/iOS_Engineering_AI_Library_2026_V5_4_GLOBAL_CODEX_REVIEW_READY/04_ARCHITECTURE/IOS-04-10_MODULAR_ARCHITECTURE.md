...
2. Зафиксируй инварианты и failure modes именно для задачи: **проектировать граф модулей по ownership/build/test boundaries, избегая циклов и микромодулей**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-10: «Modular architecture».
...
Особый фокус: проектировать граф модулей по ownership/build/test boundaries, избегая циклов и микромодулей.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
