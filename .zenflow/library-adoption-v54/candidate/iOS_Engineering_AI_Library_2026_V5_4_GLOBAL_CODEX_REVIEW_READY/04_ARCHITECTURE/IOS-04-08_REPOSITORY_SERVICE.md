...
id: IOS-04-08
type: skill
title: Repository/service boundaries
domain: Architecture
priority: production
...
2. Зафиксируй инварианты и failure modes именно для задачи: **разделить remote/local/cache orchestration по контракту данных и business semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-08: «Repository/service boundaries».
...
Особый фокус: разделить remote/local/cache orchestration по контракту данных и business semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
