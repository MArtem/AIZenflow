...
2. Зафиксируй инварианты и failure modes именно для задачи: **не превращать ViewModel в god object; отделить UI state, commands, dependencies и async lifetime**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-03: «Pragmatic MVVM».
...
Особый фокус: не превращать ViewModel в god object; отделить UI state, commands, dependencies и async lifetime.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
