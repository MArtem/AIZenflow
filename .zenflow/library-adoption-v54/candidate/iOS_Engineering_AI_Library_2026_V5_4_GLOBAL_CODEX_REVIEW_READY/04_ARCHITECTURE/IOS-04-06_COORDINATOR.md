...
# Coordinator/navigation architecture
...
2. Зафиксируй инварианты и failure modes именно для задачи: **изолировать navigation decisions, deep links и ownership, не превращая coordinator в service locator**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-06: «Coordinator/navigation architecture».
...
Особый фокус: изолировать navigation decisions, deep links и ownership, не превращая coordinator в service locator.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
