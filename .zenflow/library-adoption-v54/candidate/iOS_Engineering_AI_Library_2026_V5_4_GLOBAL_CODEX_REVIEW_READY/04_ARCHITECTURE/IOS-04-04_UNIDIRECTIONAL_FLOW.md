...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать actions/reducer/effects для сложного state, сохраняя traceability и testability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-04: «Unidirectional data flow».
...
Особый фокус: использовать actions/reducer/effects для сложного state, сохраняя traceability и testability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
