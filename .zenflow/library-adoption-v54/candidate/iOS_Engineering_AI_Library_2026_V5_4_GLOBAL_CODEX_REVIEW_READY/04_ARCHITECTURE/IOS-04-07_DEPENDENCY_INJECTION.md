...
2. Зафиксируй инварианты и failure modes именно для задачи: **явно передавать dependencies, scopes и test doubles без глобального container abuse**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-07: «Dependency injection».
...
Особый фокус: явно передавать dependencies, scopes и test doubles без глобального container abuse.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
