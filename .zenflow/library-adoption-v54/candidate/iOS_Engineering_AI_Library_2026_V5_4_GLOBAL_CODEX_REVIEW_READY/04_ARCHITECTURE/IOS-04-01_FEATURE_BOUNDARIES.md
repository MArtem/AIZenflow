...
2. Зафиксируй инварианты и failure modes именно для задачи: **разделить presentation/domain/data/infrastructure ровно настолько, насколько требует coupling/testability/team ownership**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-01: «Feature boundaries».
...
Особый фокус: разделить presentation/domain/data/infrastructure ровно настолько, насколько требует coupling/testability/team ownership.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
