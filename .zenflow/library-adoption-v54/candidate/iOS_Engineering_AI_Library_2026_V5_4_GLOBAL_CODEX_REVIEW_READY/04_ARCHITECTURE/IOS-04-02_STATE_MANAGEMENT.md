...
2. Зафиксируй инварианты и failure modes именно для задачи: **выбрать source of truth, state transitions, derived state и side effects без дублирования state**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-02: «State management».
...
Особый фокус: выбрать source of truth, state transitions, derived state и side effects без дублирования state.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
