...
id: IOS-04-05
type: skill
title: Clean-like boundaries
domain: Architecture
priority: production
baseline: Swift 6 / modern iOS
---

# Clean-like boundaries
...
2. Зафиксируй инварианты и failure modes именно для задачи: **применять dependency inversion на действительно изменчивых границах без protocol explosion**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-05: «Clean-like boundaries».
...
Особый фокус: применять dependency inversion на действительно изменчивых границах без protocol explosion.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
