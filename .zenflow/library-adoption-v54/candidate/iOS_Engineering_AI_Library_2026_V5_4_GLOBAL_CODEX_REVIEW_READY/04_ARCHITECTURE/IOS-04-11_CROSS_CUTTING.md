...
2. Зафиксируй инварианты и failure modes именно для задачи: **логирование, analytics, auth, feature flags, clocks/UUID и configuration вводить через прозрачные границы**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-11: «Cross-cutting concerns».
...
Особый фокус: логирование, analytics, auth, feature flags, clocks/UUID и configuration вводить через прозрачные границы.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
