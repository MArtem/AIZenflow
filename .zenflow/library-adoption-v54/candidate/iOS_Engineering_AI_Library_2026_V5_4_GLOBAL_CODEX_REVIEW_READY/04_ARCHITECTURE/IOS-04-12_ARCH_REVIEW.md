...
2. Зафиксируй инварианты и failure modes именно для задачи: **оценивать change amplification, dependency direction, test seams, performance, migration и operational complexity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-04-12: «Architecture review».
...
Особый фокус: оценивать change amplification, dependency direction, test seams, performance, migration и operational complexity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-04-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
