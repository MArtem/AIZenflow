...
## Назначение
Certificates/profiles/automatic signing strategy, CI key security и rotation.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **certificates/profiles/automatic signing strategy, CI key security и rotation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-03: «Code signing».
...
Особый фокус: certificates/profiles/automatic signing strategy, CI key security и rotation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
