...
id: IOS-17-04
type: skill
title: Version/build versioning
domain: CI/CD & Release
priority: production
baseline: Swift 6 / modern iOS
---

# Version/build versioning

## Назначение
SemVer/product version policy, build numbers, release branches и migration compatibility.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **SemVer/product version policy, build numbers, release branches и migration compatibility**.
...
5. Проверь тематические quality gates: reproducibility, secrets, flakiness, rollback, migration safety, release monitoring.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-04: «Version/build versioning».
...
Особый фокус: SemVer/product version policy, build numbers, release branches и migration compatibility.
Проверь: reproducibility, secrets, flakiness, rollback, migration safety, release monitoring.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
