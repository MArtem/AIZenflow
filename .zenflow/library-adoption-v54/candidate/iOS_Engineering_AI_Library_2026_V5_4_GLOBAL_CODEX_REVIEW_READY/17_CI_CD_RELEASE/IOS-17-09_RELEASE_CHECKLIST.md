...
## Назначение
Tests, migrations, privacy, permissions, analytics, crash/perf, accessibility, localization и store compliance.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **tests, migrations, privacy, permissions, analytics, crash/perf, accessibility, localization и store compliance**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-09: «Release gate».
...
Особый фокус: tests, migrations, privacy, permissions, analytics, crash/perf, accessibility, localization и store compliance.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
