...
2. Зафиксируй инварианты и failure modes именно для задачи: **minimal diff, cherry-pick safety, expedited validation, kill switch и postmortem follow-up**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-08: «Hotfix workflow».
...
Особый фокус: minimal diff, cherry-pick safety, expedited validation, kill switch и postmortem follow-up.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
