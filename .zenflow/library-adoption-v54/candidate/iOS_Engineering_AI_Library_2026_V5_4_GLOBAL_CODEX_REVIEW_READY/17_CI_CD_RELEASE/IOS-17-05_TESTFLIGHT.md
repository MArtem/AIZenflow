...
## Назначение
Groups, staged validation, feedback/crash metrics, feature flags и rollback.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **groups, staged validation, feedback/crash metrics, feature flags и rollback**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-05: «TestFlight rollout».
...
Особый фокус: groups, staged validation, feedback/crash metrics, feature flags и rollback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
