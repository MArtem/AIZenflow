...
## Назначение
Metadata/privacy/export/compliance, phased release, monitoring и rollback/kill switch.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **metadata/privacy/export/compliance, phased release, monitoring и rollback/kill switch**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-06: «App Store release».
...
Особый фокус: metadata/privacy/export/compliance, phased release, monitoring и rollback/kill switch.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
