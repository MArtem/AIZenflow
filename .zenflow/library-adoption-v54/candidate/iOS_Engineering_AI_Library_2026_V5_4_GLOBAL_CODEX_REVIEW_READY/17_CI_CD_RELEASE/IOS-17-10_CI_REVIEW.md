...
2. Зафиксируй инварианты и failure modes именно для задачи: **flakiness, missing gates, secret exposure, caching correctness, environment drift и release observability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-10: «CI/CD review».
...
Особый фокус: flakiness, missing gates, secret exposure, caching correctness, environment drift и release observability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
