...
## Назначение
User-facing vs internal change log, risk areas, migrations, experiments и support notes.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **user-facing vs internal change log, risk areas, migrations, experiments и support notes**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-07: «Release notes».
...
Особый фокус: user-facing vs internal change log, risk areas, migrations, experiments и support notes.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
