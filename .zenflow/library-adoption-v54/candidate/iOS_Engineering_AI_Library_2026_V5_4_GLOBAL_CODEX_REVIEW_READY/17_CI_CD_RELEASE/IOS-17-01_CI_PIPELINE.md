...
## Назначение
Быстрые gates, build matrix, tests, lint, artifacts, caching, reproducibility и secrets isolation.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **быстрые gates, build matrix, tests, lint, artifacts, caching, reproducibility и secrets isolation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-17-01: «CI pipeline».
...
Особый фокус: быстрые gates, build matrix, tests, lint, artifacts, caching, reproducibility и secrets isolation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-17-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
