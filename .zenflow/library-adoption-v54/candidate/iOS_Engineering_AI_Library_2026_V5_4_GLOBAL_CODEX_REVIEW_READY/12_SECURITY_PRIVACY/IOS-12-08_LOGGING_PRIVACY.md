...
2. Зафиксируй инварианты и failure modes именно для задачи: **OSLog privacy, redaction, no tokens/PII, correlation identifiers и retention policy**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-08: «Privacy-safe logging».
...
Особый фокус: OSLog privacy, redaction, no tokens/PII, correlation identifiers и retention policy.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
