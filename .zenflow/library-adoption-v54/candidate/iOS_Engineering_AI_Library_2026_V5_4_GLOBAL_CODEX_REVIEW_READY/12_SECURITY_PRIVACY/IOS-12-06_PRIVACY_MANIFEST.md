...
2. Зафиксируй инварианты и failure modes именно для задачи: **аудит collected data, tracking domains, Required Reason APIs и third-party SDK manifests**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-06: «Privacy manifest».
...
Особый фокус: аудит collected data, tracking domains, Required Reason APIs и third-party SDK manifests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
