...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать стандартные primitives/protocols, key management, nonce/randomness и avoid custom crypto**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-05: «CryptoKit usage».
...
Особый фокус: использовать стандартные primitives/protocols, key management, nonce/randomness и avoid custom crypto.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
