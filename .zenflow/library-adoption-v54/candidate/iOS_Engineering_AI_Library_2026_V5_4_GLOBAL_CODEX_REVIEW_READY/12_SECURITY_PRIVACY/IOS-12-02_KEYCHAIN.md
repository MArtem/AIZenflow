...
2. Зафиксируй инварианты и failure modes именно для задачи: **accessibility class, access groups, migration, deletion, biometric/user-presence semantics и error handling**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-02: «Keychain secrets».
...
Особый фокус: accessibility class, access groups, migration, deletion, biometric/user-presence semantics и error handling.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
