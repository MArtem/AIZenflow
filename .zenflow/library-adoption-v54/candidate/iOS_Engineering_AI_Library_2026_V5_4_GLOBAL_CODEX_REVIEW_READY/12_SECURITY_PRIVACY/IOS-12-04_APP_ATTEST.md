...
2. Зафиксируй инварианты и failure modes именно для задачи: **server challenge, key lifecycle, assertions, failure/fallback policy и anti-abuse limitations**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-04: «App Attest/DeviceCheck».
...
Особый фокус: server challenge, key lifecycle, assertions, failure/fallback policy и anti-abuse limitations.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
