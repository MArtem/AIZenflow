...
2. Зафиксируй инварианты и failure modes именно для задачи: **assets, attackers, trust boundaries, abuse cases, mitigations и residual risk**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-01: «Mobile threat model».
...
Особый фокус: assets, attackers, trust boundaries, abuse cases, mitigations и residual risk.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
