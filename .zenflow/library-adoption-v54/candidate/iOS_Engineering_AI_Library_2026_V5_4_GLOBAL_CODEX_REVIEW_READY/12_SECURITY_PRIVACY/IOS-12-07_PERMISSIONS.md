...
2. Зафиксируй инварианты и failure modes именно для задачи: **минимизация, just-in-time rationale, denied/restricted states и Settings recovery UX**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-07: «Permissions».
...
Особый фокус: минимизация, just-in-time rationale, denied/restricted states и Settings recovery UX.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
