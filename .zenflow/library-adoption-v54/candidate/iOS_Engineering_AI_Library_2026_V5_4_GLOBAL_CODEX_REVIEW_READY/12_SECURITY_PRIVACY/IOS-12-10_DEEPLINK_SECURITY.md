...
2. Зафиксируй инварианты и failure modes именно для задачи: **validate scheme/host/path/params, authz after routing, replay/parameter abuse и open redirect**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-10: «Deep-link security».
...
Особый фокус: validate scheme/host/path/params, authz after routing, replay/parameter abuse и open redirect.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
