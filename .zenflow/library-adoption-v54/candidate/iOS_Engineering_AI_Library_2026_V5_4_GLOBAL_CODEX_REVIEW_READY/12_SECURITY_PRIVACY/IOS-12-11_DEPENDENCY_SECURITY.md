...
2. Зафиксируй инварианты и failure modes именно для задачи: **maintainer/updates/license/signature/privacy/transitive deps/CVEs и removal plan**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-11: «Dependency supply-chain».
...
Особый фокус: maintainer/updates/license/signature/privacy/transitive deps/CVEs и removal plan.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
