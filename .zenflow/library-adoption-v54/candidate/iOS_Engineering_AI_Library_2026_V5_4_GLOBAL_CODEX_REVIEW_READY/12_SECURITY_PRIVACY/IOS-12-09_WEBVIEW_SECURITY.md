...
2. Зафиксируй инварианты и failure modes именно для задачи: **navigation policy, JS bridge surface, content worlds, untrusted URLs, file access и cookie/session boundaries**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-12-09: «WKWebView security».
...
Особый фокус: navigation policy, JS bridge surface, content worlds, untrusted URLs, file access и cookie/session boundaries.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-12-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
