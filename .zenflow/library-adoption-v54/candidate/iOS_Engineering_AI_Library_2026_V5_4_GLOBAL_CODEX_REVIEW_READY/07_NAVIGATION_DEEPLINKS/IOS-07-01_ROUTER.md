...
2. Зафиксируй инварианты и failure modes именно для задачи: **описать destinations и navigation actions типами, не строками**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-01: «Typed routing».
...
Особый фокус: описать destinations и navigation actions типами, не строками.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
