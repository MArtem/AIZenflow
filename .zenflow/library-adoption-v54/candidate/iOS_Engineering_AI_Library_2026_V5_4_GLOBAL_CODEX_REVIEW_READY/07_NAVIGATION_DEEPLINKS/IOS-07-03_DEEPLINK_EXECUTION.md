...
id: IOS-07-03
type: skill
title: Deep-link execution
domain: Navigation & Deep Links
priority: production
...
2. Зафиксируй инварианты и failure modes именно для задачи: **маршрутизировать через state restoration/auth/loading без гонок и duplicate navigation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-03: «Deep-link execution».
...
Особый фокус: маршрутизировать через state restoration/auth/loading без гонок и duplicate navigation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
