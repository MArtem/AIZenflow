...
2. Зафиксируй инварианты и failure modes именно для задачи: **проектировать associated domains flow, fallback, analytics и security considerations**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-04: «Universal Links».
...
Особый фокус: проектировать associated domains flow, fallback, analytics и security considerations.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
