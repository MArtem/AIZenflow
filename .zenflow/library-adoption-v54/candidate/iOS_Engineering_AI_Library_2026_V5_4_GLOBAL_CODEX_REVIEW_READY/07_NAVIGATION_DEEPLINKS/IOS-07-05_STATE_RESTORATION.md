...
2. Зафиксируй инварианты и failure modes именно для задачи: **восстанавливать navigation/document/user state безопасно и version-aware**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-05: «State restoration».
...
Особый фокус: восстанавливать navigation/document/user state безопасно и version-aware.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
