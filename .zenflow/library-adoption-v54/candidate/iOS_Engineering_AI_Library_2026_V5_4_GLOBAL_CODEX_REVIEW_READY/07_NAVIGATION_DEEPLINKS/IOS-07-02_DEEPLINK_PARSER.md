...
2. Зафиксируй инварианты и failure modes именно для задачи: **валидировать URL, versioning, auth gates, feature availability и malformed inputs**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-02: «Deep-link parsing».
...
Особый фокус: валидировать URL, versioning, auth gates, feature availability и malformed inputs.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
