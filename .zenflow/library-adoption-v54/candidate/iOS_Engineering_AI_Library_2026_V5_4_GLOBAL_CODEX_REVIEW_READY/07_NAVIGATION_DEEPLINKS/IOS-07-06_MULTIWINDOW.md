...
2. Зафиксируй инварианты и failure modes именно для задачи: **разделить scene-specific state, routing, document/session ownership и lifecycle**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-07-06: «Multiwindow/scenes».
...
Особый фокус: разделить scene-specific state, routing, document/session ownership и lifecycle.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-07-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
