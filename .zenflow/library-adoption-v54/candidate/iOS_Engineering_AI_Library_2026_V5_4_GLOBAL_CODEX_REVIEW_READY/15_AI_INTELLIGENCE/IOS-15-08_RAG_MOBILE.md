...
id: IOS-15-08
type: skill
title: Mobile retrieval/grounding
domain: AI / Intelligence
priority: production
baseline: Swift 6 / modern iOS
---

# Mobile retrieval/grounding

## Назначение
Index boundaries, freshness, citations/provenance, offline storage и privacy.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **index boundaries, freshness, citations/provenance, offline storage и privacy**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-08: «Mobile retrieval/grounding».
...
Особый фокус: index boundaries, freshness, citations/provenance, offline storage и privacy.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
