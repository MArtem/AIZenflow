...
## Назначение
Golden datasets, task metrics, safety/privacy, latency/cost, regression suites и human review.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **golden datasets, task metrics, safety/privacy, latency/cost, regression suites и human review**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-03: «AI feature evaluation».
...
Особый фокус: golden datasets, task metrics, safety/privacy, latency/cost, regression suites и human review.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
