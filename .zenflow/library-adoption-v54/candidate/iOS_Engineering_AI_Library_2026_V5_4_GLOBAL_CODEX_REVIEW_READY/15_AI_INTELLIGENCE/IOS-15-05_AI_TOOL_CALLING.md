...
id: IOS-15-05
type: skill
title: AI tool/function calling
...
## Назначение
Typed schemas, authorization per tool, idempotency, confirmation boundaries и audit logging.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **typed schemas, authorization per tool, idempotency, confirmation boundaries и audit logging**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-05: «AI tool/function calling».
...
Особый фокус: typed schemas, authorization per tool, idempotency, confirmation boundaries и audit logging.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
