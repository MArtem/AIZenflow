...
2. Зафиксируй инварианты и failure modes именно для задачи: **quality/evals/privacy/security/latency/fallback/accessibility/observability gate**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-10: «AI feature review».
...
Особый фокус: quality/evals/privacy/security/latency/fallback/accessibility/observability gate.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
