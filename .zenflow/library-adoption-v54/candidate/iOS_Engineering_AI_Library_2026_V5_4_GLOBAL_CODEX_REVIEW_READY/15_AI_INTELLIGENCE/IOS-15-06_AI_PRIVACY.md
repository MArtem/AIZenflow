...
## Назначение
Data minimization, on-device preference, consent, retention, server provider boundaries и redaction.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **data minimization, on-device preference, consent, retention, server provider boundaries и redaction**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-06: «AI privacy».
...
Особый фокус: data minimization, on-device preference, consent, retention, server provider boundaries и redaction.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
