...
id: IOS-15-09
type: skill
title: AI abuse/safety review
domain: AI / Intelligence
priority: production
baseline: Swift 6 / modern iOS
---

# AI abuse/safety review

## Назначение
Prompt injection, data exfiltration, tool misuse, unsafe actions, rate limits и user confirmation.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **prompt injection, data exfiltration, tool misuse, unsafe actions, rate limits и user confirmation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-09: «AI abuse/safety review».
...
Особый фокус: prompt injection, data exfiltration, tool misuse, unsafe actions, rate limits и user confirmation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
