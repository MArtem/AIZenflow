...
## Назначение
Capability/availability gating, structured prompting, tool use, privacy, latency, fallback и evaluation.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **capability/availability gating, structured prompting, tool use, privacy, latency, fallback и evaluation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-15-01: «Foundation Models».
...
Особый фокус: capability/availability gating, structured prompting, tool use, privacy, latency, fallback и evaluation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-15-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
