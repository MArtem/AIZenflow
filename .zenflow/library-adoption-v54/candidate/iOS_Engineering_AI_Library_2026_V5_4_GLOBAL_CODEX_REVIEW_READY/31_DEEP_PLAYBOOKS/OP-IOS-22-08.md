...
id: OP-IOS-22-08
type: deep-playbook
source_skill: IOS-22-08
title: Core Animation — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-08 — Core Animation

## Mission
делать layer-backed animation, transactions, presentation/model layers, timing и Reduce Motion

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-08_CORE_ANIMATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Animation».
...
- For **Core Animation**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-08 «Core Animation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: делать layer-backed animation, transactions, presentation/model layers, timing и Reduce Motion.
