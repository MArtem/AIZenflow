...
id: OP-IOS-06-05
type: deep-playbook
source_skill: IOS-06-05
title: UITableView modernization — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-05 — UITableView modernization

## Mission
diffable/modern cells, self-sizing, reuse, prefetch и smooth updates

Этот playbook — operational-версия `06_UIKIT/IOS-06-05_TABLE_VIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UITableView modernization».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-05 «UITableView modernization» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: diffable/modern cells, self-sizing, reuse, prefetch и smooth updates.
