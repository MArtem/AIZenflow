...
id: OP-IOS-19-04
type: deep-playbook
source_skill: IOS-19-04
title: God object split — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-04 — God object split

## Mission
разделять по responsibilities/state ownership/dependencies без искусственных layers

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-04_GOD_OBJECT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «God object split».
...
- For **God object split**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-04 «God object split» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: разделять по responsibilities/state ownership/dependencies без искусственных layers.
