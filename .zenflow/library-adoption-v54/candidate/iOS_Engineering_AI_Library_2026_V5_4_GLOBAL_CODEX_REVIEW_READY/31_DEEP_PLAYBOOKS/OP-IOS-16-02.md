...
id: OP-IOS-16-02
type: deep-playbook
source_skill: IOS-16-02
title: Module graph — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-02 — Module graph

## Mission
избежать cycles, layer violations, transitive dependency sprawl и slow rebuilds

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-02_MODULE_GRAPH.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Module graph».
...
- For **Module graph**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-02 «Module graph» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: избежать cycles, layer violations, transitive dependency sprawl и slow rebuilds.
