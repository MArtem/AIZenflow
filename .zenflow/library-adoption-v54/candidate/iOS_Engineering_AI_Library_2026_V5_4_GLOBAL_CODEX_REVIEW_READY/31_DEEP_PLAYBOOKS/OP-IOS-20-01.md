...
id: OP-IOS-20-01
type: deep-playbook
source_skill: IOS-20-01
title: Swift 6 migration program — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-01 — Swift 6 migration program

## Mission
по-модульно включать strict concurrency, классифицировать diagnostics и избегать unchecked escape hatches

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-01_SWIFT6_MIGRATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Swift 6 migration program».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-01 «Swift 6 migration program» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: по-модульно включать strict concurrency, классифицировать diagnostics и избегать unchecked escape hatches.
