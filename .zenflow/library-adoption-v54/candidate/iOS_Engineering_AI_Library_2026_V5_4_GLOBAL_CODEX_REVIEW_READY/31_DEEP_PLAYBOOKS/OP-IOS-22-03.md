...
id: OP-IOS-22-03
type: deep-playbook
source_skill: IOS-22-03
title: AVAudioEngine — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-03 — AVAudioEngine

## Mission
построить audio graph, format conversion, realtime-thread safety, interruption recovery и latency

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-03_AUDIO_ENGINE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AVAudioEngine».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-03 «AVAudioEngine» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: построить audio graph, format conversion, realtime-thread safety, interruption recovery и latency.
