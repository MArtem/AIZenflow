...
id: OP-IOS-23-06
type: deep-playbook
source_skill: IOS-23-06
title: RealityKit — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-06 — RealityKit

## Mission
entity/component ownership, asset loading, async resources, collision/physics и performance

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-06_REALITYKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «RealityKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-06 «RealityKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: entity/component ownership, asset loading, async resources, collision/physics и performance.
