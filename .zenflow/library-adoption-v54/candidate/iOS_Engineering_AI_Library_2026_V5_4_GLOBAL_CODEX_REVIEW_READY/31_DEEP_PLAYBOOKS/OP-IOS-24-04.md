...
id: OP-IOS-24-04
type: deep-playbook
source_skill: IOS-24-04
title: NSUserActivity/Handoff — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-04 — NSUserActivity/Handoff

## Mission
activity types, eligibility, state serialization, continuity, privacy и restoration

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-04_HANDOFF.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «NSUserActivity/Handoff».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-04 «NSUserActivity/Handoff» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: activity types, eligibility, state serialization, continuity, privacy и restoration.
