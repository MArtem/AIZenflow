...
id: OP-IOS-14-14
type: deep-playbook
source_skill: IOS-14-14
title: Adaptive Apple platforms — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-14 — Adaptive Apple platforms

## Mission
size/resizing/input/windowing и shared code без lowest-common-denominator UI

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-14_VISIONOS_IPAD.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Adaptive Apple platforms».
...
- For **Adaptive Apple platforms**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-14 «Adaptive Apple platforms» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: size/resizing/input/windowing и shared code без lowest-common-denominator UI.
