...
id: OP-IOS-05-13
type: deep-playbook
source_skill: IOS-05-13
title: Previews/dev fixtures — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-13 — Previews/dev fixtures

## Mission
создавать deterministic previews с fixtures, error/loading states, locale, Dynamic Type и dark mode

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-13_PREVIEWS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Previews/dev fixtures».
...
- For **Previews/dev fixtures**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-13 «Previews/dev fixtures» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: создавать deterministic previews с fixtures, error/loading states, locale, Dynamic Type и dark mode.
