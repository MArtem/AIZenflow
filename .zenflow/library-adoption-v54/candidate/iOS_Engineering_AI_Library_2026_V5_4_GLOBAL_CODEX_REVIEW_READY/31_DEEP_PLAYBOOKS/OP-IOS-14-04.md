...
id: OP-IOS-14-04
type: deep-playbook
source_skill: IOS-14-04
title: Push notifications — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-04 — Push notifications

## Mission
token lifecycle, categories/actions, foreground handling, deep links, privacy и delivery assumptions

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-04_PUSH_NOTIFICATIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Push notifications».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-04 «Push notifications» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: token lifecycle, categories/actions, foreground handling, deep links, privacy и delivery assumptions.
