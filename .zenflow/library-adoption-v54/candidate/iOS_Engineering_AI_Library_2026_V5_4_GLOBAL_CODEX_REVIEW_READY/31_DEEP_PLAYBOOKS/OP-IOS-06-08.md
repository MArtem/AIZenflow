...
id: OP-IOS-06-08
type: deep-playbook
source_skill: IOS-06-08
title: UIKit memory — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-08 — UIKit memory

## Mission
delegates, closures, timers, observers, display links, child controllers и reusable cell capture cycles

Этот playbook — operational-версия `06_UIKIT/IOS-06-08_UIKIT_MEMORY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UIKit memory».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-08 «UIKit memory» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: delegates, closures, timers, observers, display links, child controllers и reusable cell capture cycles.
