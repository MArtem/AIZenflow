...
id: OP-IOS-12-03
type: deep-playbook
source_skill: IOS-12-03
title: Authentication flow — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-03 — Authentication flow

## Mission
OAuth/OIDC/PKCE/passkeys/system web auth, token lifecycle, logout, account switching и session fixation risks

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-03_AUTHENTICATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Authentication flow».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-03 «Authentication flow» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: OAuth/OIDC/PKCE/passkeys/system web auth, token lifecycle, logout, account switching и session fixation risks.
