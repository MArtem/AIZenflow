...
id: OP-IOS-07-01
type: deep-playbook
source_skill: IOS-07-01
title: Typed routing — Operational Deep Playbook
section: 07_NAVIGATION_DEEPLINKS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-07-01 — Typed routing

## Mission
описать destinations и navigation actions типами, не строками

Этот playbook — operational-версия `07_NAVIGATION_DEEPLINKS/IOS-07-01_ROUTER.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Typed routing».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-07-01 «Typed routing» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: описать destinations и navigation actions типами, не строками.
