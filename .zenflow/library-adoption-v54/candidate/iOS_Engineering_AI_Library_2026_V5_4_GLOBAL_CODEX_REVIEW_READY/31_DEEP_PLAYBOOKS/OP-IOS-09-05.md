...
id: OP-IOS-09-05
type: deep-playbook
source_skill: IOS-09-05
title: Data migrations — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-05 — Data migrations

## Mission
versioning, lightweight/custom migration, backups, rollback, telemetry и large-store performance

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-05_MIGRATIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Data migrations».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-05 «Data migrations» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: versioning, lightweight/custom migration, backups, rollback, telemetry и large-store performance.
