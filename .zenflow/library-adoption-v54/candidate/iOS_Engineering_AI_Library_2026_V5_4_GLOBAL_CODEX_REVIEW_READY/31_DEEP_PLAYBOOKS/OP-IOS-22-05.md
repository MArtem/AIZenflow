...
id: OP-IOS-22-05
type: deep-playbook
source_skill: IOS-22-05
title: Media export/transcode — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-05 — Media export/transcode

## Mission
asset reading/writing/export sessions, progress/cancellation, temp storage, HDR/codec compatibility и disk pressure

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-05_VIDEO_EXPORT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Media export/transcode».
...
- For **Media export/transcode**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-05 «Media export/transcode» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: asset reading/writing/export sessions, progress/cancellation, temp storage, HDR/codec compatibility и disk pressure.
