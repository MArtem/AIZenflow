...
id: OP-IOS-27-01
type: deep-playbook
source_skill: IOS-27-01
title: Code ownership — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-01 — Code ownership

## Mission
определить module/feature ownership, review paths, incident responsibility and avoid bottlenecks

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-01_CODE_OWNERSHIP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Code ownership».
...
- For **Code ownership**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-01 «Code ownership» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: определить module/feature ownership, review paths, incident responsibility and avoid bottlenecks.
