...
id: OP-IOS-25-03
type: deep-playbook
source_skill: IOS-25-03
title: Composable Architecture evaluation — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-03 — Composable Architecture evaluation

## Mission
оценить reducer/effect/state discipline против complexity/team fit, not adopt by fashion

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-03_TCA_EVALUATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Composable Architecture evaluation».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-03 «Composable Architecture evaluation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оценить reducer/effect/state discipline против complexity/team fit, not adopt by fashion.
