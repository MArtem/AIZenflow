...
id: OP-IOS-10-08
type: deep-playbook
source_skill: IOS-10-08
title: Snapshot tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-08 — Snapshot tests

## Mission
использовать избирательно; фиксировать locale/dynamic type/device traits и tolerances

Этот playbook — operational-версия `10_TESTING/IOS-10-08_SNAPSHOT_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Snapshot tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-08 «Snapshot tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: использовать избирательно; фиксировать locale/dynamic type/device traits и tolerances.
