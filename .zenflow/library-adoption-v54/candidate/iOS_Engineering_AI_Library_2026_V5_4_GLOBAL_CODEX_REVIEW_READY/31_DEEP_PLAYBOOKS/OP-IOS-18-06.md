...
id: OP-IOS-18-06
type: deep-playbook
source_skill: IOS-18-06
title: Race diagnosis — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-06 — Race diagnosis

## Mission
TSAN/strict concurrency/compiler diagnostics/log sequencing и isolation redesign

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-06_RACE_DEBUG.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Race diagnosis».
...
- For **Race diagnosis**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-06 «Race diagnosis» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: TSAN/strict concurrency/compiler diagnostics/log sequencing и isolation redesign.
