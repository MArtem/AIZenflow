...
id: OP-IOS-20-02
type: deep-playbook
source_skill: IOS-20-02
title: UIKit→SwiftUI migration — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-02 — UIKit→SwiftUI migration

## Mission
выбирать feature seams, shared model boundaries, hosting, testing и rollback

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-02_SWIFTUI_MIGRATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UIKit→SwiftUI migration».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-02 «UIKit→SwiftUI migration» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выбирать feature seams, shared model boundaries, hosting, testing и rollback.
