...
id: OP-IOS-27-04
type: deep-playbook
source_skill: IOS-27-04
title: Breaking change review — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-04 — Breaking change review

## Mission
blast radius, source/data compatibility, rollout coordination, versioning and consumer migration

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-04_BREAKING_CHANGE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Breaking change review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-04 «Breaking change review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: blast radius, source/data compatibility, rollout coordination, versioning and consumer migration.
