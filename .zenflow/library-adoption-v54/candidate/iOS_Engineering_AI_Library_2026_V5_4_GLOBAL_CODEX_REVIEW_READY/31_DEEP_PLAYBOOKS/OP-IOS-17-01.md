...
id: OP-IOS-17-01
type: deep-playbook
source_skill: IOS-17-01
title: CI pipeline — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-01 — CI pipeline

## Mission
быстрые gates, build matrix, tests, lint, artifacts, caching, reproducibility и secrets isolation

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-01_CI_PIPELINE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CI pipeline».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-01 «CI pipeline» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: быстрые gates, build matrix, tests, lint, artifacts, caching, reproducibility и secrets isolation.
