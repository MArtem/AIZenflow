...
id: OP-IOS-02-11
type: deep-playbook
source_skill: IOS-02-11
title: Foundation formatting — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-11 — Foundation formatting

## Mission
locale-safe Date/Number/FormatStyle/Calendar/TimeZone обработка

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-11_FOUNDATION_FORMATTING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Foundation formatting».
...
- For **Foundation formatting**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-11 «Foundation formatting» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: locale-safe Date/Number/FormatStyle/Calendar/TimeZone обработка.
