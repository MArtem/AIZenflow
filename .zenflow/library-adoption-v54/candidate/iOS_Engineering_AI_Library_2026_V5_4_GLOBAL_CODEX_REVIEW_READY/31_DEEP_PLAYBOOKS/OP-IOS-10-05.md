...
id: OP-IOS-10-05
type: deep-playbook
source_skill: IOS-10-05
title: Async/concurrency tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-05 — Async/concurrency tests

## Mission
контролировать clock, cancellation, task completion, actor boundaries без sleeps

Этот playbook — operational-версия `10_TESTING/IOS-10-05_ASYNC_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Async/concurrency tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-05 «Async/concurrency tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: контролировать clock, cancellation, task completion, actor boundaries без sleeps.
