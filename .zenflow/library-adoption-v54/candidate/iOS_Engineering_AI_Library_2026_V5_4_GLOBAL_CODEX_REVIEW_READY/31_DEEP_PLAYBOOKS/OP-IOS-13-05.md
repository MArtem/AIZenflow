...
id: OP-IOS-13-05
type: deep-playbook
source_skill: IOS-13-05
title: Localization architecture — Operational Deep Playbook
section: 13_ACCESSIBILITY_LOCALIZATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-13-05 — Localization architecture

## Mission
String Catalog/localized resources, pluralization, grammatical variation и translator context

Этот playbook — operational-версия `13_ACCESSIBILITY_LOCALIZATION/IOS-13-05_LOCALIZATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Localization architecture».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-13-05 «Localization architecture» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: String Catalog/localized resources, pluralization, grammatical variation и translator context.
