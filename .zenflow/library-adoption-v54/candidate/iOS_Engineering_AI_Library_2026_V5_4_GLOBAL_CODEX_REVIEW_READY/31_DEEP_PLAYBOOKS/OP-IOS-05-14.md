...
id: OP-IOS-05-14
type: deep-playbook
source_skill: IOS-05-14
title: Search experience — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-14 — Search experience

## Mission
поиск с debounce/cancellation, server/local filtering, focus, empty states и accessibility

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-14_SEARCH.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Search experience».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-14 «Search experience» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: поиск с debounce/cancellation, server/local filtering, focus, empty states и accessibility.
