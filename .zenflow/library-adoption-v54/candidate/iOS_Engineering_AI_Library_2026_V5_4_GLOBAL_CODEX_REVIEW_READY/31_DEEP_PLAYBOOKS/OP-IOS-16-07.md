...
id: OP-IOS-16-07
type: deep-playbook
source_skill: IOS-16-07
title: Third-party dependency audit — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-07 — Third-party dependency audit

## Mission
necessity, maintenance, platform support, Swift 6 readiness, privacy, binary size, license, removal cost

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-07_DEPENDENCY_AUDIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Third-party dependency audit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-07 «Third-party dependency audit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: necessity, maintenance, platform support, Swift 6 readiness, privacy, binary size, license, removal cost.
