...
id: OP-IOS-25-10
type: deep-playbook
source_skill: IOS-25-10
title: Third-party ecosystem review — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-10 — Third-party ecosystem review

## Mission
necessity, maintenance, security/privacy, concurrency readiness, build/binary cost and exit strategy

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-10_ECOSYSTEM_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Third-party ecosystem review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-10 «Third-party ecosystem review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: necessity, maintenance, security/privacy, concurrency readiness, build/binary cost and exit strategy.
