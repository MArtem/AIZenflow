...
id: OP-IOS-03-06
type: deep-playbook
source_skill: IOS-03-06
title: Task lifetime & ownership — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-06 — Task lifetime & ownership

## Mission
связать task с владельцем feature/view/model, избежать orphan tasks и capture cycles

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-06_TASK_LIFETIME.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Task lifetime & ownership».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-06 «Task lifetime & ownership» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: связать task с владельцем feature/view/model, избежать orphan tasks и capture cycles.
