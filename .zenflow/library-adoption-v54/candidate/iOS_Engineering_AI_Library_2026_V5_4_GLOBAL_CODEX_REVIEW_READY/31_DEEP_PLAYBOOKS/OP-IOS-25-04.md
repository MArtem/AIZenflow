...
id: OP-IOS-25-04
type: deep-playbook
source_skill: IOS-25-04
title: Networking library evaluation — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-04 — Networking library evaluation

## Mission
сравнить с URLSession по middleware/auth/retry/metrics/testability/privacy/dependency cost

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-04_ALAMOFIRE_EVALUATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Networking library evaluation».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-04 «Networking library evaluation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сравнить с URLSession по middleware/auth/retry/metrics/testability/privacy/dependency cost.
