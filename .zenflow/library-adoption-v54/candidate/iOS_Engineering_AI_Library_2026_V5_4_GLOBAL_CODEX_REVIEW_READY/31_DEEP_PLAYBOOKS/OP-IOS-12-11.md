...
id: OP-IOS-12-11
type: deep-playbook
source_skill: IOS-12-11
title: Dependency supply-chain — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-11 — Dependency supply-chain

## Mission
maintainer/updates/license/signature/privacy/transitive deps/CVEs и removal plan

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-11_DEPENDENCY_SECURITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Dependency supply-chain».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-11 «Dependency supply-chain» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: maintainer/updates/license/signature/privacy/transitive deps/CVEs и removal plan.
