...
id: OP-IOS-15-05
type: deep-playbook
source_skill: IOS-15-05
title: AI tool/function calling — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-05 — AI tool/function calling

## Mission
typed schemas, authorization per tool, idempotency, confirmation boundaries и audit logging

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-05_AI_TOOL_CALLING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AI tool/function calling».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-05 «AI tool/function calling» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: typed schemas, authorization per tool, idempotency, confirmation boundaries и audit logging.
