...
id: OP-IOS-02-06
type: deep-playbook
source_skill: IOS-02-06
title: Typed error model — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-06 — Typed error model

## Mission
спроектировать throws/errors mapping, recoverability, user-facing mapping, logging и retry policy

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-06_ERROR_MODEL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Typed error model».
...
- Verify idempotency, retry budget, jitter, Retry-After, cancellation and duplicate-side-effect prevention.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-06 «Typed error model» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: спроектировать throws/errors mapping, recoverability, user-facing mapping, logging и retry policy.
