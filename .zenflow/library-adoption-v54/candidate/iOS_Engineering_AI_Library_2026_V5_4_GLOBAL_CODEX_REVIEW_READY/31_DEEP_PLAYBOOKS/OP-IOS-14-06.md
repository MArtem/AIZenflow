...
id: OP-IOS-14-06
type: deep-playbook
source_skill: IOS-14-06
title: Core Location — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-06 — Core Location

## Mission
authorization precision, background modes, energy, geofencing limits и privacy UX

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-06_LOCATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Location».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-06 «Core Location» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: authorization precision, background modes, energy, geofencing limits и privacy UX.
