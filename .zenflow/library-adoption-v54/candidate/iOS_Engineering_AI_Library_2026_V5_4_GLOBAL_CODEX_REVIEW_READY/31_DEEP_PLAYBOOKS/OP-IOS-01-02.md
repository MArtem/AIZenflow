...
id: OP-IOS-01-02
type: deep-playbook
source_skill: IOS-01-02
title: Технический spike перед реализацией — Operational Deep Playbook
section: 01_DISCOVERY_PRODUCT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-01-02 — Технический spike перед реализацией

## Mission
сравнить 2–4 варианта по API availability, complexity, migration cost, performance, testability, security/privacy и risk

Этот playbook — operational-версия `01_DISCOVERY_PRODUCT/IOS-01-02_TECH_SPIKE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Технический spike перед реализацией».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-01-02 «Технический spike перед реализацией» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сравнить 2–4 варианта по API availability, complexity, migration cost, performance, testability, security/privacy и risk.
