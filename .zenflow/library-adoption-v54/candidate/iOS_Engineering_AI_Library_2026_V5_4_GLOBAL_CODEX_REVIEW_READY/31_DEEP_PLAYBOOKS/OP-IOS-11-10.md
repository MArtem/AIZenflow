...
id: OP-IOS-11-10
type: deep-playbook
source_skill: IOS-11-10
title: Signposts — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-10 — Signposts

## Mission
расставить meaningful intervals/events и privacy-safe metadata для Instruments/MetricKit

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-10_SIGNPOSTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Signposts».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-10 «Signposts» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: расставить meaningful intervals/events и privacy-safe metadata для Instruments/MetricKit.
