...
id: OP-IOS-05-04
type: deep-playbook
source_skill: IOS-05-04
title: SwiftUI navigation — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-04 — SwiftUI navigation

## Mission
типобезопасно моделировать NavigationStack/path, deep links, restoration и modal flows

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-04_NAVIGATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «SwiftUI navigation».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-04 «SwiftUI navigation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: типобезопасно моделировать NavigationStack/path, deep links, restoration и modal flows.
