...
id: OP-IOS-15-04
type: deep-playbook
source_skill: IOS-15-04
title: In-app prompt design — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-04 — In-app prompt design

## Mission
system/user/tool boundaries, structured outputs, grounding, refusal/fallback UX и prompt injection awareness

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-04_PROMPT_DESIGN_APP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «In-app prompt design».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-04 «In-app prompt design» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: system/user/tool boundaries, structured outputs, grounding, refusal/fallback UX и prompt injection awareness.
