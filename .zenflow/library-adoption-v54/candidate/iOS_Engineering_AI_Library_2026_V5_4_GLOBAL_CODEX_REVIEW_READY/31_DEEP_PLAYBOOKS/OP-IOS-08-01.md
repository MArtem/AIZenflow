...
id: OP-IOS-08-01
type: deep-playbook
source_skill: IOS-08-01
title: Typed HTTP client — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-01 — Typed HTTP client

## Mission
URLSession async/await, typed endpoints, request building, decoding, cancellation и observability

Этот playbook — operational-версия `08_NETWORKING/IOS-08-01_HTTP_CLIENT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Typed HTTP client».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-01 «Typed HTTP client» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: URLSession async/await, typed endpoints, request building, decoding, cancellation и observability.
