...
id: OP-IOS-05-15
type: deep-playbook
source_skill: IOS-05-15
title: Forms/input — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-15 — Forms/input

## Mission
validation, focus, keyboard, submit flow, formatting, secure fields и accessibility

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-15_FORMS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Forms/input».
...
- For **Forms/input**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-15 «Forms/input» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: validation, focus, keyboard, submit flow, formatting, secure fields и accessibility.
