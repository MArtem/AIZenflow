...
id: OP-IOS-06-03
type: deep-playbook
source_skill: IOS-06-03
title: Auto Layout — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-03 — Auto Layout

## Mission
создавать недвусмысленные constraints, Dynamic Type/adaptive layouts и диагностировать ambiguity/conflicts

Этот playbook — operational-версия `06_UIKIT/IOS-06-03_AUTO_LAYOUT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Auto Layout».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-03 «Auto Layout» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: создавать недвусмысленные constraints, Dynamic Type/adaptive layouts и диагностировать ambiguity/conflicts.
