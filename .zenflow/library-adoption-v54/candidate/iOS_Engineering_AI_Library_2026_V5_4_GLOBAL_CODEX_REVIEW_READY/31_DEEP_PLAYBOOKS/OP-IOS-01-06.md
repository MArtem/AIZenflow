...
id: OP-IOS-01-06
type: deep-playbook
source_skill: IOS-01-06
title: Architecture Decision Record — Operational Deep Playbook
section: 01_DISCOVERY_PRODUCT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-01-06 — Architecture Decision Record

## Mission
зафиксировать контекст, decision, alternatives, consequences, rollback/migration и критерии пересмотра

Этот playbook — operational-версия `01_DISCOVERY_PRODUCT/IOS-01-06_ADR.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Architecture Decision Record».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-01-06 «Architecture Decision Record» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: зафиксировать контекст, decision, alternatives, consequences, rollback/migration и критерии пересмотра.
