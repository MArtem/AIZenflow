...
id: OP-IOS-02-08
type: deep-playbook
source_skill: IOS-02-08
title: Swift macros — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-08 — Swift macros

## Mission
оценить macro только при измеримой пользе, с диагностикой, тестированием expansion и контролем build complexity

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-08_MACROS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Swift macros».
...
- For **Swift macros**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-08 «Swift macros» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оценить macro только при измеримой пользе, с диагностикой, тестированием expansion и контролем build complexity.
