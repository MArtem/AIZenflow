...
id: OP-IOS-17-09
type: deep-playbook
source_skill: IOS-17-09
title: Release gate — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-09 — Release gate

## Mission
tests, migrations, privacy, permissions, analytics, crash/perf, accessibility, localization и store compliance

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-09_RELEASE_CHECKLIST.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Release gate».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-09 «Release gate» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: tests, migrations, privacy, permissions, analytics, crash/perf, accessibility, localization и store compliance.
