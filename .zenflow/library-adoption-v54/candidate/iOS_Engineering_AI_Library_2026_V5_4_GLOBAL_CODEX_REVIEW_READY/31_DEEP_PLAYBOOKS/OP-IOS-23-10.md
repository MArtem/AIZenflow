...
id: OP-IOS-23-10
type: deep-playbook
source_skill: IOS-23-10
title: ML/Vision/AR review — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-10 — ML/Vision/AR review

## Mission
quality metrics, availability, sensor/camera lifecycle, privacy, memory/thermal and fallback

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-10_ML_AR_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «ML/Vision/AR review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-10 «ML/Vision/AR review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: quality metrics, availability, sensor/camera lifecycle, privacy, memory/thermal and fallback.
