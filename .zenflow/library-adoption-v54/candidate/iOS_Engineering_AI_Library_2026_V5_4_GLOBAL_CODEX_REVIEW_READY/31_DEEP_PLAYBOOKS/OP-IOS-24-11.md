...
id: OP-IOS-24-11
type: deep-playbook
source_skill: IOS-24-11
title: Core Haptics — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-11 — Core Haptics

## Mission
engine lifecycle, capability checks, interruption/reset, pattern assets and accessibility alternatives

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-11_CORE_HAPTICS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Haptics».
...
- For **Core Haptics**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-11 «Core Haptics» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: engine lifecycle, capability checks, interruption/reset, pattern assets and accessibility alternatives.
