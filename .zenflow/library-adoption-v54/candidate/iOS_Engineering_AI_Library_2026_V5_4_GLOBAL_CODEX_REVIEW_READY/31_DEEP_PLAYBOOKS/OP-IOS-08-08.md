...
id: OP-IOS-08-08
type: deep-playbook
source_skill: IOS-08-08
title: Connectivity/offline — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-08 — Connectivity/offline

## Mission
не использовать reachability как гарантию; проектировать optimistic requests и recovery

Этот playbook — operational-версия `08_NETWORKING/IOS-08-08_NETWORK_REACHABILITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Connectivity/offline».
...
- For **Connectivity/offline**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-08 «Connectivity/offline» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: не использовать reachability как гарантию; проектировать optimistic requests и recovery.
