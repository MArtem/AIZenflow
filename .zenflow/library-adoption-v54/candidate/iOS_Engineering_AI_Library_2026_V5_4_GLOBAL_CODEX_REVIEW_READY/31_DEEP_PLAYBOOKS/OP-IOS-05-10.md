...
id: OP-IOS-05-10
type: deep-playbook
source_skill: IOS-05-10
title: Environment/dependencies — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-10 — Environment/dependencies

## Mission
использовать Environment для scoped dependencies, не скрывая mutable global state

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-10_ENVIRONMENT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Environment/dependencies».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-10 «Environment/dependencies» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: использовать Environment для scoped dependencies, не скрывая mutable global state.
