...
id: OP-IOS-11-06
type: deep-playbook
source_skill: IOS-11-06
title: Memory footprint — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-06 — Memory footprint

## Mission
измерить allocations, resident growth, caches, large buffers, autorelease patterns и jetsam risk

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-06_MEMORY_FOOTPRINT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Memory footprint».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-06 «Memory footprint» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: измерить allocations, resident growth, caches, large buffers, autorelease patterns и jetsam risk.
