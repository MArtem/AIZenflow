...
id: OP-IOS-07-03
type: deep-playbook
source_skill: IOS-07-03
title: Deep-link execution — Operational Deep Playbook
section: 07_NAVIGATION_DEEPLINKS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-07-03 — Deep-link execution

## Mission
маршрутизировать через state restoration/auth/loading без гонок и duplicate navigation

Этот playbook — operational-версия `07_NAVIGATION_DEEPLINKS/IOS-07-03_DEEPLINK_EXECUTION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Deep-link execution».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-07-03 «Deep-link execution» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: маршрутизировать через state restoration/auth/loading без гонок и duplicate navigation.
