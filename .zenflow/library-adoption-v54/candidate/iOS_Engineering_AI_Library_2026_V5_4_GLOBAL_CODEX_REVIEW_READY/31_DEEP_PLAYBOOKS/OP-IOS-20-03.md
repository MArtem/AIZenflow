...
id: OP-IOS-20-03
type: deep-playbook
source_skill: IOS-20-03
title: ObservableObject→Observation — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-03 — ObservableObject→Observation

## Mission
сохранить ownership/update semantics и измерить invalidation/performance

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-03_OBSERVATION_MIGRATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «ObservableObject→Observation».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-03 «ObservableObject→Observation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сохранить ownership/update semantics и измерить invalidation/performance.
