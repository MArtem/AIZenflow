...
id: OP-IOS-20-05
type: deep-playbook
source_skill: IOS-20-05
title: Callbacks/Combine networking→async — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-05 — Callbacks/Combine networking→async

## Mission
сохранить cancellation/retry/auth semantics и migrate layer by layer

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-05_NETWORK_MIGRATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Callbacks/Combine networking→async».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-05 «Callbacks/Combine networking→async» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сохранить cancellation/retry/auth semantics и migrate layer by layer.
