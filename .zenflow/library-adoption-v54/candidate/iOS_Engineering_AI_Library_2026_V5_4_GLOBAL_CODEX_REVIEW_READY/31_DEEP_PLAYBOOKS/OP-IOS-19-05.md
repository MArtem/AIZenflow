...
id: OP-IOS-19-05
type: deep-playbook
source_skill: IOS-19-05
title: Protocol simplification — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-05 — Protocol simplification

## Mission
удалять meaningless abstractions, сохраняя real seams и testability

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-05_PROTOCOL_EXPLOSION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Protocol simplification».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-05 «Protocol simplification» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: удалять meaningless abstractions, сохраняя real seams и testability.
