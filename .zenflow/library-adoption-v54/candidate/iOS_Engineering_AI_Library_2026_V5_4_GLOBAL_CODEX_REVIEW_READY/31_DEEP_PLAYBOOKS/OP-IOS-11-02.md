...
id: OP-IOS-11-02
type: deep-playbook
source_skill: IOS-11-02
title: App launch — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-02 — App launch

## Mission
измерить pre-main/post-main, synchronous initialization, dependency setup, I/O и first-frame work

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-02_LAUNCH_TIME.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «App launch».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-02 «App launch» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: измерить pre-main/post-main, synchronous initialization, dependency setup, I/O и first-frame work.
