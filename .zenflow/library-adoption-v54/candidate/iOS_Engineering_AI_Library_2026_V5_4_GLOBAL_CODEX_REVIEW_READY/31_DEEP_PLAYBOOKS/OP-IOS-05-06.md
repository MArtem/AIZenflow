...
id: OP-IOS-05-06
type: deep-playbook
source_skill: IOS-05-06
title: Lists/scroll performance — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-06 — Lists/scroll performance

## Mission
оптимизировать identity, lazy containers, prefetch, image loading, expensive body work и hitching

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-06_LIST_PERFORMANCE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Lists/scroll performance».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-06 «Lists/scroll performance» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оптимизировать identity, lazy containers, prefetch, image loading, expensive body work и hitching.
