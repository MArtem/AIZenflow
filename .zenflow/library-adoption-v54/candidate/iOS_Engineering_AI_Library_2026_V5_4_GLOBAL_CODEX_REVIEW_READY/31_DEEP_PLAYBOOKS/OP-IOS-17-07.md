...
id: OP-IOS-17-07
type: deep-playbook
source_skill: IOS-17-07
title: Release notes — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-07 — Release notes

## Mission
user-facing vs internal change log, risk areas, migrations, experiments и support notes

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-07_RELEASE_NOTES.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Release notes».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-07 «Release notes» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: user-facing vs internal change log, risk areas, migrations, experiments и support notes.
