...
id: OP-IOS-15-02
type: deep-playbook
source_skill: IOS-15-02
title: Core AI/on-device models — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-02 — Core AI/on-device models

## Mission
model packaging, memory budget, device specialization, stateful inference, latency и fallback

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-02_CORE_AI.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core AI/on-device models».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-02 «Core AI/on-device models» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: model packaging, memory budget, device specialization, stateful inference, latency и fallback.
