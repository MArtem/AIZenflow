...
id: OP-IOS-19-09
type: deep-playbook
source_skill: IOS-19-09
title: Performance refactor — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-09 — Performance refactor

## Mission
изменять только измеренный bottleneck, добавляя regression metric/test

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-09_PERF_REFACTOR.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Performance refactor».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-09 «Performance refactor» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: изменять только измеренный bottleneck, добавляя regression metric/test.
