...
id: OP-IOS-09-08
type: deep-playbook
source_skill: IOS-09-08
title: File storage — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-08 — File storage

## Mission
atomic writes, coordination, temp/cache/documents directories, protection classes и disk pressure

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-08_FILES.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «File storage».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-08 «File storage» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: atomic writes, coordination, temp/cache/documents directories, protection classes и disk pressure.
