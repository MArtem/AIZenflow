...
id: OP-IOS-09-01
type: deep-playbook
source_skill: IOS-09-01
title: SwiftData modeling — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-01 — SwiftData modeling

## Mission
@Model relationships, uniqueness, indexing strategy, fetch shape, migrations и availability

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-01_SWIFTDATA_MODEL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «SwiftData modeling».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-01 «SwiftData modeling» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: @Model relationships, uniqueness, indexing strategy, fetch shape, migrations и availability.
