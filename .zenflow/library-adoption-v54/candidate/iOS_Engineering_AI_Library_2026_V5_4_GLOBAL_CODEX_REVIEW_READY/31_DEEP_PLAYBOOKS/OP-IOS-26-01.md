...
id: OP-IOS-26-01
type: deep-playbook
source_skill: IOS-26-01
title: Design tokens — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-01 — Design tokens

## Mission
типизировать color/spacing/type/radius/motion tokens, support dark/high-contrast and avoid magic values

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-01_DESIGN_TOKENS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Design tokens».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-01 «Design tokens» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: типизировать color/spacing/type/radius/motion tokens, support dark/high-contrast and avoid magic values.
