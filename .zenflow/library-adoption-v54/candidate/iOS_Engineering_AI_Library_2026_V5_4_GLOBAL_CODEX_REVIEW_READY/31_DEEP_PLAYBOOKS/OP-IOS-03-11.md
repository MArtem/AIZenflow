...
id: OP-IOS-03-11
type: deep-playbook
source_skill: IOS-03-11
title: Task groups/parallel work — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-11 — Task groups/parallel work

## Mission
распараллеливать независимую работу с ограничением fan-out, memory и priority

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-11_PARALLELISM.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Task groups/parallel work».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-11 «Task groups/parallel work» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: распараллеливать независимую работу с ограничением fan-out, memory и priority.
