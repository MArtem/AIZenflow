...
id: OP-IOS-16-03
type: deep-playbook
source_skill: IOS-16-03
title: Build performance — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-03 — Build performance

## Mission
измерить type-checking/modules/scripts/generated code/dependency graph, улучшать без хаков

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-03_BUILD_PERFORMANCE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Build performance».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-03 «Build performance» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: измерить type-checking/modules/scripts/generated code/dependency graph, улучшать без хаков.
