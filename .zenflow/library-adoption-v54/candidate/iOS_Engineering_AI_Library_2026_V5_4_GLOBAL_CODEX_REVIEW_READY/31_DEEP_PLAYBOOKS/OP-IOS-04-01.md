...
id: OP-IOS-04-01
type: deep-playbook
source_skill: IOS-04-01
title: Feature boundaries — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-01 — Feature boundaries

## Mission
разделить presentation/domain/data/infrastructure ровно настолько, насколько требует coupling/testability/team ownership

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-01_FEATURE_BOUNDARIES.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Feature boundaries».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-01 «Feature boundaries» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: разделить presentation/domain/data/infrastructure ровно настолько, насколько требует coupling/testability/team ownership.
