...
id: OP-IOS-05-09
type: deep-playbook
source_skill: IOS-05-09
title: Sheets/alerts/popovers — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-09 — Sheets/alerts/popovers

## Mission
привязать presentation к state без boolean explosion и competing presentations

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-09_PRESENTATIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Sheets/alerts/popovers».
...
- For **Sheets/alerts/popovers**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-09 «Sheets/alerts/popovers» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: привязать presentation к state без boolean explosion и competing presentations.
