...
id: OP-IOS-04-12
type: deep-playbook
source_skill: IOS-04-12
title: Architecture review — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-12 — Architecture review

## Mission
оценивать change amplification, dependency direction, test seams, performance, migration и operational complexity

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-12_ARCH_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Architecture review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-12 «Architecture review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оценивать change amplification, dependency direction, test seams, performance, migration и operational complexity.
