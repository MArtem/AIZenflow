...
id: OP-IOS-12-12
type: deep-playbook
source_skill: IOS-12-12
title: Security review — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-12 — Security review

## Mission
threat-driven audit auth/storage/network/webviews/deeplinks/logging/privacy/permissions

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-12_SECURITY_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Security review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-12 «Security review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: threat-driven audit auth/storage/network/webviews/deeplinks/logging/privacy/permissions.
