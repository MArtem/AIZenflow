...
id: OP-IOS-05-12
type: deep-playbook
source_skill: IOS-05-12
title: SwiftUI↔UIKit bridge — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-12 — SwiftUI↔UIKit bridge

## Mission
корректно управлять coordinator, lifecycle, updates, identity, sizing и memory

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-12_BRIDGE_UIKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «SwiftUI↔UIKit bridge».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-12 «SwiftUI↔UIKit bridge» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: корректно управлять coordinator, lifecycle, updates, identity, sizing и memory.
