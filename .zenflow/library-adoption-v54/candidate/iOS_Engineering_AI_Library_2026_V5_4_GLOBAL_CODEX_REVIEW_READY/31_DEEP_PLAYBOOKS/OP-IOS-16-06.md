...
id: OP-IOS-16-06
type: deep-playbook
source_skill: IOS-16-06
title: Lint/format — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-06 — Lint/format

## Mission
автоматизировать consistent style без конфликтов с compiler/readability и без noisy churn

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-06_LINT_FORMAT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Lint/format».
...
- For **Lint/format**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-06 «Lint/format» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: автоматизировать consistent style без конфликтов с compiler/readability и без noisy churn.
