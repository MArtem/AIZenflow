...
id: OP-IOS-04-11
type: deep-playbook
source_skill: IOS-04-11
title: Cross-cutting concerns — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-11 — Cross-cutting concerns

## Mission
логирование, analytics, auth, feature flags, clocks/UUID и configuration вводить через прозрачные границы

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-11_CROSS_CUTTING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Cross-cutting concerns».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-11 «Cross-cutting concerns» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: логирование, analytics, auth, feature flags, clocks/UUID и configuration вводить через прозрачные границы.
