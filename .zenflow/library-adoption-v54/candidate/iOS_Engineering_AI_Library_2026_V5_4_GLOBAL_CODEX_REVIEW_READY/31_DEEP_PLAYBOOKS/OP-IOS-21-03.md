...
id: OP-IOS-21-03
type: deep-playbook
source_skill: IOS-21-03
title: Deep review workflow — Operational Deep Playbook
section: 21_AGENT_WORKFLOWS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-21-03 — Deep review workflow

## Mission
inspect diff + surrounding code + tests + architecture; produce severity-ranked findings with fixes

Этот playbook — operational-версия `21_AGENT_WORKFLOWS/IOS-21-03_REVIEW_WORKFLOW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Deep review workflow».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-21-03 «Deep review workflow» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: inspect diff + surrounding code + tests + architecture; produce severity-ranked findings with fixes.
