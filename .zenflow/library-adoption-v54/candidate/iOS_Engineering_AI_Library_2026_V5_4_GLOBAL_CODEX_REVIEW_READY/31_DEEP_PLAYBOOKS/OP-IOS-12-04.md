...
id: OP-IOS-12-04
type: deep-playbook
source_skill: IOS-12-04
title: App Attest/DeviceCheck — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-04 — App Attest/DeviceCheck

## Mission
server challenge, key lifecycle, assertions, failure/fallback policy и anti-abuse limitations

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-04_APP_ATTEST.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «App Attest/DeviceCheck».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-04 «App Attest/DeviceCheck» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: server challenge, key lifecycle, assertions, failure/fallback policy и anti-abuse limitations.
