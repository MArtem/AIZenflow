...
id: OP-IOS-06-02
type: deep-playbook
source_skill: IOS-06-02
title: Child containment — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-02 — Child containment

## Mission
соблюдать add/remove child contract, appearance, safe areas и ownership

Этот playbook — operational-версия `06_UIKIT/IOS-06-02_CONTAINMENT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Child containment».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-02 «Child containment» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: соблюдать add/remove child contract, appearance, safe areas и ownership.
