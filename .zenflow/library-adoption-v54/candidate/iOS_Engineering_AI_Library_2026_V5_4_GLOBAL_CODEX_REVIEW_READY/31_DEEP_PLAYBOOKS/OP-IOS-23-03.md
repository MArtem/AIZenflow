...
id: OP-IOS-23-03
type: deep-playbook
source_skill: IOS-23-03
title: Core ML inference — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-03 — Core ML inference

## Mission
model loading, compute units, input preprocessing, prediction scheduling, memory/thermal и versioning

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-03_COREML.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core ML inference».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-03 «Core ML inference» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: model loading, compute units, input preprocessing, prediction scheduling, memory/thermal и versioning.
