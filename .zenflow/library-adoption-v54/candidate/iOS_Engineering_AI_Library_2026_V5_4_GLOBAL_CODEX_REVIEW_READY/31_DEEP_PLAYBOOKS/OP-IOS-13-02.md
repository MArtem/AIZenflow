...
id: OP-IOS-13-02
type: deep-playbook
source_skill: IOS-13-02
title: Dynamic Type — Operational Deep Playbook
section: 13_ACCESSIBILITY_LOCALIZATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-13-02 — Dynamic Type

## Mission
layout reflow, truncation resistance, scalable metrics, content size extremes и scroll fallback

Этот playbook — operational-версия `13_ACCESSIBILITY_LOCALIZATION/IOS-13-02_DYNAMIC_TYPE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Dynamic Type».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-13-02 «Dynamic Type» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: layout reflow, truncation resistance, scalable metrics, content size extremes и scroll fallback.
