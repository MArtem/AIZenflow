...
id: OP-IOS-22-06
type: deep-playbook
source_skill: IOS-22-06
title: Core Image pipeline — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-06 — Core Image pipeline

## Mission
строить filter/render pipeline, CIContext reuse, color spaces, GPU/CPU choice и image orientation

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-06_CORE_IMAGE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Image pipeline».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-06 «Core Image pipeline» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: строить filter/render pipeline, CIContext reuse, color spaces, GPU/CPU choice и image orientation.
