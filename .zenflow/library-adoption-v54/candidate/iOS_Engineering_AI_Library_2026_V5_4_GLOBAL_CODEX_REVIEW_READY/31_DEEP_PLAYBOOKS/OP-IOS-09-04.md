...
id: OP-IOS-09-04
type: deep-playbook
source_skill: IOS-09-04
title: Core Data concurrency — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-04 — Core Data concurrency

## Mission
context confinement, object IDs, background transactions и merge policies

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-04_COREDATA_CONCURRENCY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Data concurrency».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-04 «Core Data concurrency» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: context confinement, object IDs, background transactions и merge policies.
