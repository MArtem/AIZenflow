...
id: OP-IOS-25-07
type: deep-playbook
source_skill: IOS-25-07
title: Remote config — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-07 — Remote config

## Mission
typed keys/defaults, cache/TTL, failure semantics, experiment ownership, kill switches and cleanup

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-07_REMOTE_CONFIG.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Remote config».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-07 «Remote config» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: typed keys/defaults, cache/TTL, failure semantics, experiment ownership, kill switches and cleanup.
