...
id: OP-IOS-27-02
type: deep-playbook
source_skill: IOS-27-02
title: Technical debt management — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-02 — Technical debt management

## Mission
оценить debt по risk/change frequency/impact, связать с measurable outcome and staged payoff

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-02_TECH_DEBT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Technical debt management».
...
- For **Technical debt management**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-02 «Technical debt management» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оценить debt по risk/change frequency/impact, связать с measurable outcome and staged payoff.
