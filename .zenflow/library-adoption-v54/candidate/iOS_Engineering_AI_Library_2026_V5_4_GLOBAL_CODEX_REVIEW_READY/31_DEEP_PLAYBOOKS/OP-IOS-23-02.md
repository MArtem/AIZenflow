...
id: OP-IOS-23-02
type: deep-playbook
source_skill: IOS-23-02
title: OCR/text recognition — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-02 — OCR/text recognition

## Mission
настроить recognition level/languages/ROI, preprocess, confidence, pagination и privacy

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-02_VISION_TEXT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «OCR/text recognition».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-02 «OCR/text recognition» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: настроить recognition level/languages/ROI, preprocess, confidence, pagination и privacy.
