...
id: OP-IOS-26-06
type: deep-playbook
source_skill: IOS-26-06
title: Validation UX — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-06 — Validation UX

## Mission
field vs form validation, async validation cancellation, error focus/announcement and localization

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-06_FORM_VALIDATION_UX.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Validation UX».
...
- For **Validation UX**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-06 «Validation UX» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: field vs form validation, async validation cancellation, error focus/announcement and localization.
