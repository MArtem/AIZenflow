...
id: OP-IOS-14-12
type: deep-playbook
source_skill: IOS-14-12
title: CloudKit/iCloud — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-12 — CloudKit/iCloud

## Mission
identity/account changes, sync conflicts, quotas, offline behavior и schema migration

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-12_ICLOUD.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CloudKit/iCloud».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-12 «CloudKit/iCloud» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: identity/account changes, sync conflicts, quotas, offline behavior и schema migration.
