...
id: OP-IOS-26-02
type: deep-playbook
source_skill: IOS-26-02
title: Component library — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-02 — Component library

## Mission
строить composable components with clear states, accessibility, previews, docs and visual regression strategy

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-02_COMPONENT_LIBRARY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Component library».
...
- For **Component library**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-02 «Component library» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: строить composable components with clear states, accessibility, previews, docs and visual regression strategy.
