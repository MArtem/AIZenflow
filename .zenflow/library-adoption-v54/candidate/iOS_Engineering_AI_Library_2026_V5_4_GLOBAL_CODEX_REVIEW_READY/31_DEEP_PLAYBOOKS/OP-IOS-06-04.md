...
id: OP-IOS-06-04
type: deep-playbook
source_skill: IOS-06-04
title: UICollectionView modern stack — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-04 — UICollectionView modern stack

## Mission
diffable data source, compositional layout, cell registration, prefetch и state updates

Этот playbook — operational-версия `06_UIKIT/IOS-06-04_COLLECTION_VIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UICollectionView modern stack».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-04 «UICollectionView modern stack» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: diffable data source, compositional layout, cell registration, prefetch и state updates.
