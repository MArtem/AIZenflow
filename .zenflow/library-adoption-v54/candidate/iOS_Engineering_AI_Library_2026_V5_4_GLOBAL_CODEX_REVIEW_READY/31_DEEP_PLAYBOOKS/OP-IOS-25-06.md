...
id: OP-IOS-25-06
type: deep-playbook
source_skill: IOS-25-06
title: Analytics SDK — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-06 — Analytics SDK

## Mission
event schema, PII prohibition, consent, batching, retry, identity reset and test/debug mode

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-06_ANALYTICS_SDK.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Analytics SDK».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-06 «Analytics SDK» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: event schema, PII prohibition, consent, batching, retry, identity reset and test/debug mode.
