...
id: OP-IOS-11-07
type: deep-playbook
source_skill: IOS-11-07
title: CPU/energy — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-07 — CPU/energy

## Mission
устранить busy loops, polling, excessive timers, background work и radio wakeups

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-07_CPU_ENERGY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CPU/energy».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-07 «CPU/energy» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: устранить busy loops, polling, excessive timers, background work и radio wakeups.
