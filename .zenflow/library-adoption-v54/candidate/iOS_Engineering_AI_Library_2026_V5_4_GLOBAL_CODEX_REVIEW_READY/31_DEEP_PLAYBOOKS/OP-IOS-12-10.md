...
id: OP-IOS-12-10
type: deep-playbook
source_skill: IOS-12-10
title: Deep-link security — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-10 — Deep-link security

## Mission
validate scheme/host/path/params, authz after routing, replay/parameter abuse и open redirect

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-10_DEEPLINK_SECURITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Deep-link security».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-10 «Deep-link security» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: validate scheme/host/path/params, authz after routing, replay/parameter abuse и open redirect.
