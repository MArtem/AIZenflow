...
id: OP-IOS-03-13
type: deep-playbook
source_skill: IOS-03-13
title: GCD/OperationQueue migration — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-13 — GCD/OperationQueue migration

## Mission
постепенно bridge legacy queues к structured concurrency без двойной синхронизации

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-13_LEGACY_GCD.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «GCD/OperationQueue migration».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-13 «GCD/OperationQueue migration» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: постепенно bridge legacy queues к structured concurrency без двойной синхронизации.
