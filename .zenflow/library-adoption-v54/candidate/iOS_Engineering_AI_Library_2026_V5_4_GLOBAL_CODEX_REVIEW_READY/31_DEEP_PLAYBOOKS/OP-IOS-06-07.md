...
id: OP-IOS-06-07
type: deep-playbook
source_skill: IOS-06-07
title: UIKit + concurrency — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-07 — UIKit + concurrency

## Mission
MainActor boundaries, task ownership, cancellation on reuse/disappear и stale result protection

Этот playbook — operational-версия `06_UIKIT/IOS-06-07_UIKIT_CONCURRENCY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UIKit + concurrency».
...
- Identify who creates, cancels and awaits each task; ensure task does not retain a dismissed view/model indefinitely.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-07 «UIKit + concurrency» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: MainActor boundaries, task ownership, cancellation on reuse/disappear и stale result protection.
