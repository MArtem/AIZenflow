...
id: OP-IOS-16-08
type: deep-playbook
source_skill: IOS-16-08
title: Binary size — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-08 — Binary size

## Mission
измерить symbols/resources/architectures/dependencies, optimize without degrading modularity blindly

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-08_BINARY_SIZE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Binary size».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-08 «Binary size» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: измерить symbols/resources/architectures/dependencies, optimize without degrading modularity blindly.
