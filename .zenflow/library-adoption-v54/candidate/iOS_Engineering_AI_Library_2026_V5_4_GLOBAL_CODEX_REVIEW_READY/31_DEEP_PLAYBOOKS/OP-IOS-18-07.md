...
id: OP-IOS-18-07
type: deep-playbook
source_skill: IOS-18-07
title: Network incident — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-07 — Network incident

## Mission
request IDs, HTTP status/timing, auth refresh, retries, CDN/cache, decoding и privacy-safe capture

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-07_NETWORK_DEBUG.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Network incident».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-07 «Network incident» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: request IDs, HTTP status/timing, auth refresh, retries, CDN/cache, decoding и privacy-safe capture.
