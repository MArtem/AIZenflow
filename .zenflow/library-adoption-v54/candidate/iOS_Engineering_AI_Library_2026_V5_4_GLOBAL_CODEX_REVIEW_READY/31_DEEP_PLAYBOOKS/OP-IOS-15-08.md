...
id: OP-IOS-15-08
type: deep-playbook
source_skill: IOS-15-08
title: Mobile retrieval/grounding — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-08 — Mobile retrieval/grounding

## Mission
index boundaries, freshness, citations/provenance, offline storage и privacy

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-08_RAG_MOBILE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Mobile retrieval/grounding».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-08 «Mobile retrieval/grounding» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: index boundaries, freshness, citations/provenance, offline storage и privacy.
