...
id: OP-IOS-27-08
type: deep-playbook
source_skill: IOS-27-08
title: Team quality system — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-08 — Team quality system

## Mission
связать CI gates, code review, observability, incident feedback, dependency updates and release checklist

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-08_TEAM_QUALITY_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Team quality system».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-08 «Team quality system» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: связать CI gates, code review, observability, incident feedback, dependency updates and release checklist.
