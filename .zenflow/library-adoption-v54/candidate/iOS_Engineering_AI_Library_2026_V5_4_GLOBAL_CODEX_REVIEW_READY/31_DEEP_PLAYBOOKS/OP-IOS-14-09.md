...
id: OP-IOS-14-09
type: deep-playbook
source_skill: IOS-14-09
title: Photos/Camera — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-09 — Photos/Camera

## Mission
limited library, permission flow, capture session lifecycle, orientation, interruptions и storage

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-09_PHOTOS_CAMERA.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Photos/Camera».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-09 «Photos/Camera» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: limited library, permission flow, capture session lifecycle, orientation, interruptions и storage.
