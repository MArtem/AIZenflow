...
id: OP-IOS-14-05
type: deep-playbook
source_skill: IOS-14-05
title: Background tasks — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-05 — Background tasks

## Mission
BGTaskScheduler budgets, expiration, idempotency, persistence и no guaranteed timing

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-05_BACKGROUND_TASKS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Background tasks».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-05 «Background tasks» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: BGTaskScheduler budgets, expiration, idempotency, persistence и no guaranteed timing.
