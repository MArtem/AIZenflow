...
id: OP-IOS-02-10
type: deep-playbook
source_skill: IOS-02-10
title: Collections и algorithms — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-10 — Collections и algorithms

## Mission
выбрать структуры данных и алгоритмы с учётом complexity, allocation, copying и readability

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-10_COLLECTIONS_ALGORITHMS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Collections и algorithms».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-10 «Collections и algorithms» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выбрать структуры данных и алгоритмы с учётом complexity, allocation, copying и readability.
