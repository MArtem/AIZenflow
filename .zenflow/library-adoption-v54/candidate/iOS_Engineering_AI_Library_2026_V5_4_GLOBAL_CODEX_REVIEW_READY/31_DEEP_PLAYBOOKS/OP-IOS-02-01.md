...
id: OP-IOS-02-01
type: deep-playbook
source_skill: IOS-02-01
title: Swift API design — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-01 — Swift API design

## Mission
сделать API выразительным, source-compatible где нужно, с ясной ownership/error semantics и без stringly-typed контрактов

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-01_API_DESIGN.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Swift API design».
...
- For **Swift API design**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-01 «Swift API design» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сделать API выразительным, source-compatible где нужно, с ясной ownership/error semantics и без stringly-typed контрактов.
