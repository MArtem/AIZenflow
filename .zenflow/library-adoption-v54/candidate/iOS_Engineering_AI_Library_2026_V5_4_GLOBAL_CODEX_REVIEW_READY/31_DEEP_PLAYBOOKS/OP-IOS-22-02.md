...
id: OP-IOS-22-02
type: deep-playbook
source_skill: IOS-22-02
title: AVAudioSession — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-02 — AVAudioSession

## Mission
корректно выбрать category/mode/options, route changes, interruptions, background audio и coexistence с другими apps

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-02_AUDIO_SESSION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AVAudioSession».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-02 «AVAudioSession» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: корректно выбрать category/mode/options, route changes, interruptions, background audio и coexistence с другими apps.
