...
id: OP-IOS-05-08
type: deep-playbook
source_skill: IOS-05-08
title: Animations — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-08 — Animations

## Mission
делать state-driven animations, transaction control, Reduce Motion и performance-safe effects

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-08_ANIMATIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Animations».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-08 «Animations» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: делать state-driven animations, transaction control, Reduce Motion и performance-safe effects.
