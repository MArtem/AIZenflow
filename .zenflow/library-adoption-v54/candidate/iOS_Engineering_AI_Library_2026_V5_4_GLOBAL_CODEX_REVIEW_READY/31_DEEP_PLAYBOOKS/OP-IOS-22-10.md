...
id: OP-IOS-22-10
type: deep-playbook
source_skill: IOS-22-10
title: PDFKit — Operational Deep Playbook
...
Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-10_PDFKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «PDFKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-10 «PDFKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: document loading, page rendering, annotations, search, large-file memory и security of untrusted PDFs.
