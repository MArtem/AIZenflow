...
id: OP-IOS-25-05
type: deep-playbook
source_skill: IOS-25-05
title: Firebase-style SDK integration — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-05 — Firebase-style SDK integration

## Mission
изолировать analytics/crash/remote-config/messaging SDK, consent/privacy, initialization and vendor lock-in

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-05_FIREBASE_INTEGRATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Firebase-style SDK integration».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-05 «Firebase-style SDK integration» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: изолировать analytics/crash/remote-config/messaging SDK, consent/privacy, initialization and vendor lock-in.
