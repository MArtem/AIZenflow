...
id: OP-IOS-17-10
type: deep-playbook
source_skill: IOS-17-10
title: CI/CD review — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-10 — CI/CD review

## Mission
flakiness, missing gates, secret exposure, caching correctness, environment drift и release observability

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-10_CI_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CI/CD review».
...
- For **CI/CD review**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-10 «CI/CD review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: flakiness, missing gates, secret exposure, caching correctness, environment drift и release observability.
