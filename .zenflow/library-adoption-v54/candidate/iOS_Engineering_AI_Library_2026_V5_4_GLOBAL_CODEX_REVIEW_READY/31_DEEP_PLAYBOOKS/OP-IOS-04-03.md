...
id: OP-IOS-04-03
type: deep-playbook
source_skill: IOS-04-03
title: Pragmatic MVVM — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-03 — Pragmatic MVVM

## Mission
не превращать ViewModel в god object; отделить UI state, commands, dependencies и async lifetime

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-03_MVVM.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Pragmatic MVVM».
...
- For **Pragmatic MVVM**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-03 «Pragmatic MVVM» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: не превращать ViewModel в god object; отделить UI state, commands, dependencies и async lifetime.
