...
id: OP-IOS-10-01
type: deep-playbook
source_skill: IOS-10-01
title: Test strategy — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-01 — Test strategy

## Mission
построить pyramid по рискам: unit/integration/UI/performance/snapshot только там, где оправдано

Этот playbook — operational-версия `10_TESTING/IOS-10-01_TEST_STRATEGY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Test strategy».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-01 «Test strategy» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: построить pyramid по рискам: unit/integration/UI/performance/snapshot только там, где оправдано.
