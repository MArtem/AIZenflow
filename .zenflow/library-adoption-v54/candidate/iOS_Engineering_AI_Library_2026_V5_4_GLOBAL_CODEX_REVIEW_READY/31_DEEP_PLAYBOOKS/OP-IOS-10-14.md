...
id: OP-IOS-10-14
type: deep-playbook
source_skill: IOS-10-14
title: Test code review — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-14 — Test code review

## Mission
проверить signal, determinism, coverage of failure paths, readability и maintenance cost

Этот playbook — operational-версия `10_TESTING/IOS-10-14_TEST_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Test code review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-14 «Test code review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проверить signal, determinism, coverage of failure paths, readability и maintenance cost.
