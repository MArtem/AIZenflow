...
id: OP-IOS-11-08
type: deep-playbook
source_skill: IOS-11-08
title: Database performance — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-08 — Database performance

## Mission
fetch limits, predicates/indexes, faults, batch operations, N+1 и main-thread fetches

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-08_DATABASE_PERF.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Database performance».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-08 «Database performance» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: fetch limits, predicates/indexes, faults, batch operations, N+1 и main-thread fetches.
