...
id: OP-IOS-04-09
type: deep-playbook
source_skill: IOS-04-09
title: Domain modeling — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-09 — Domain modeling

## Mission
отделить transport/persistence DTO от domain model там, где это защищает инварианты и уменьшает churn

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-09_DOMAIN_MODEL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Domain modeling».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-09 «Domain modeling» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: отделить transport/persistence DTO от domain model там, где это защищает инварианты и уменьшает churn.
