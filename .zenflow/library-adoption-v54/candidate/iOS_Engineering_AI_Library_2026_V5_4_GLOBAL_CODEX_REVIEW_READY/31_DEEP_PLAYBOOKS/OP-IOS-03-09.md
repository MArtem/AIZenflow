...
id: OP-IOS-03-09
type: deep-playbook
source_skill: IOS-03-09
title: Continuations — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-09 — Continuations

## Mission
безопасно bridge callback API, гарантируя ровно один resume и корректную cancellation story

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-09_CONTINUATIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Continuations».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-09 «Continuations» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: безопасно bridge callback API, гарантируя ровно один resume и корректную cancellation story.
