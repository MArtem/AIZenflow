...
id: OP-IOS-18-02
type: deep-playbook
source_skill: IOS-18-02
title: MetricKit — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-02 — MetricKit

## Mission
production performance/crash signals, custom metrics/signposts, aggregation и privacy-aware telemetry

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-02_METRICKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «MetricKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-02 «MetricKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: production performance/crash signals, custom metrics/signposts, aggregation и privacy-aware telemetry.
