...
id: OP-IOS-27-06
type: deep-playbook
source_skill: IOS-27-06
title: Living engineering docs — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-06 — Living engineering docs

## Mission
document invariants/decisions/runbooks, tie updates to code/release triggers and avoid stale tutorials

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-06_ENGINEERING_DOCS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Living engineering docs».
...
- For **Living engineering docs**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-06 «Living engineering docs» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: document invariants/decisions/runbooks, tie updates to code/release triggers and avoid stale tutorials.
