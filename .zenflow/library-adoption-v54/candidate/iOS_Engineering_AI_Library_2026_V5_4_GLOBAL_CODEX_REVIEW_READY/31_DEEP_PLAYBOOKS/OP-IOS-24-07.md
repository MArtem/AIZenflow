...
id: OP-IOS-24-07
type: deep-playbook
source_skill: IOS-24-07
title: WatchConnectivity — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-07 — WatchConnectivity

## Mission
reachable vs background transfers, queues, deduplication, ordering, app state and version skew

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-07_WATCH_CONNECTIVITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «WatchConnectivity».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-07 «WatchConnectivity» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: reachable vs background transfers, queues, deduplication, ordering, app state and version skew.
