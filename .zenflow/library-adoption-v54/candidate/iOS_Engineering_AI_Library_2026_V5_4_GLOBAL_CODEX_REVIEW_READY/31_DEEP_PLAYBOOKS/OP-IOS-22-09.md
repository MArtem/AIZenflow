...
id: OP-IOS-22-09
type: deep-playbook
source_skill: IOS-22-09
title: Metal rendering/compute — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-09 — Metal rendering/compute

## Mission
command queues/buffers, resource lifetime, synchronization, pipeline caching, memory heaps и GPU capture

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-09_METAL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Metal rendering/compute».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-09 «Metal rendering/compute» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: command queues/buffers, resource lifetime, synchronization, pipeline caching, memory heaps и GPU capture.
