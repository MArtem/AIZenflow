...
id: OP-IOS-10-04
type: deep-playbook
source_skill: IOS-10-04
title: XCUITest — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-04 — XCUITest

## Mission
критические user journeys, stable accessibility identifiers, launch state и deterministic fixtures

Этот playbook — operational-версия `10_TESTING/IOS-10-04_XCUI.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «XCUITest».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-04 «XCUITest» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: критические user journeys, stable accessibility identifiers, launch state и deterministic fixtures.
