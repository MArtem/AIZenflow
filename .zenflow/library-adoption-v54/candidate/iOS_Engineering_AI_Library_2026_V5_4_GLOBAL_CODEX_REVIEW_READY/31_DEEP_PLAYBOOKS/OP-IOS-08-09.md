...
id: OP-IOS-08-09
type: deep-playbook
source_skill: IOS-08-09
title: Transport security — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-09 — Transport security

## Mission
ATS, trust decisions, pinning trade-offs, rotation, logging redaction и no bypass

Этот playbook — operational-версия `08_NETWORKING/IOS-08-09_TLS_SECURITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Transport security».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-09 «Transport security» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: ATS, trust decisions, pinning trade-offs, rotation, logging redaction и no bypass.
