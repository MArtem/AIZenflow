...
id: OP-IOS-17-05
type: deep-playbook
source_skill: IOS-17-05
title: TestFlight rollout — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-05 — TestFlight rollout

## Mission
groups, staged validation, feedback/crash metrics, feature flags и rollback

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-05_TESTFLIGHT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «TestFlight rollout».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-05 «TestFlight rollout» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: groups, staged validation, feedback/crash metrics, feature flags и rollback.
