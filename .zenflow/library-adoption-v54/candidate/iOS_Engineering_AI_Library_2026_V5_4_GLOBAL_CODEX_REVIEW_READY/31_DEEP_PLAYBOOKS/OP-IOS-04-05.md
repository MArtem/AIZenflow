...
id: OP-IOS-04-05
type: deep-playbook
source_skill: IOS-04-05
title: Clean-like boundaries — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-05 — Clean-like boundaries

## Mission
применять dependency inversion на действительно изменчивых границах без protocol explosion

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-05_CLEAN_BOUNDARIES.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Clean-like boundaries».
...
- For **Clean-like boundaries**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-05 «Clean-like boundaries» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: применять dependency inversion на действительно изменчивых границах без protocol explosion.
