...
id: OP-IOS-25-01
type: deep-playbook
source_skill: IOS-25-01
title: Combine pipelines — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-01 — Combine pipelines

## Mission
ownership/cancellation/backpressure/scheduler semantics, bridge to async carefully and avoid duplicate state

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-01_COMBINE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Combine pipelines».
...
- For **Combine pipelines**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-01 «Combine pipelines» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: ownership/cancellation/backpressure/scheduler semantics, bridge to async carefully and avoid duplicate state.
