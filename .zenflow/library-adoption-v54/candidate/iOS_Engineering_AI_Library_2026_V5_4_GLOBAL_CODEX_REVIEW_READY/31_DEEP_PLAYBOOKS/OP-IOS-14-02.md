...
id: OP-IOS-14-02
type: deep-playbook
source_skill: IOS-14-02
title: WidgetKit — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-02 — WidgetKit

## Mission
timeline strategy, App Intent configuration, shared data, relevance, refresh budgets и placeholders

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-02_WIDGETKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «WidgetKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-02 «WidgetKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: timeline strategy, App Intent configuration, shared data, relevance, refresh budgets и placeholders.
