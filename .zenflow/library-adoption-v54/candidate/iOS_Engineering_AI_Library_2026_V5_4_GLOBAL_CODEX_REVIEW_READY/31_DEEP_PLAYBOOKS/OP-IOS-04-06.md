...
id: OP-IOS-04-06
type: deep-playbook
source_skill: IOS-04-06
title: Coordinator/navigation architecture — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-06 — Coordinator/navigation architecture

## Mission
изолировать navigation decisions, deep links и ownership, не превращая coordinator в service locator

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-06_COORDINATOR.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Coordinator/navigation architecture».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-06 «Coordinator/navigation architecture» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: изолировать navigation decisions, deep links и ownership, не превращая coordinator в service locator.
