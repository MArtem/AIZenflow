...
id: OP-IOS-11-05
type: deep-playbook
source_skill: IOS-11-05
title: Leak diagnosis — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-05 — Leak diagnosis

## Mission
retain path, closures/tasks/delegates/timers/observers, lifecycle и deterministic reproduction

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-05_MEMORY_LEAK.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Leak diagnosis».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-05 «Leak diagnosis» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: retain path, closures/tasks/delegates/timers/observers, lifecycle и deterministic reproduction.
