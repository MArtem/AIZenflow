...
id: OP-IOS-24-02
type: deep-playbook
source_skill: IOS-24-02
title: App Clips — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-02 — App Clips

## Mission
малый binary, invocation URLs, ephemeral authorization, handoff to full app и data boundaries

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-02_APP_CLIPS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «App Clips».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-02 «App Clips» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: малый binary, invocation URLs, ephemeral authorization, handoff to full app и data boundaries.
