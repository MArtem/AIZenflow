...
id: OP-IOS-16-10
type: deep-playbook
source_skill: IOS-16-10
title: Tooling review — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-10 — Tooling review

## Mission
проверить build determinism, scripts, cache assumptions, developer ergonomics и CI parity

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-10_TOOLING_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Tooling review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-10 «Tooling review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проверить build determinism, scripts, cache assumptions, developer ergonomics и CI parity.
