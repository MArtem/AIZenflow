...
id: OP-IOS-04-04
type: deep-playbook
source_skill: IOS-04-04
title: Unidirectional data flow — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-04 — Unidirectional data flow

## Mission
использовать actions/reducer/effects для сложного state, сохраняя traceability и testability

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-04_UNIDIRECTIONAL_FLOW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Unidirectional data flow».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-04 «Unidirectional data flow» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: использовать actions/reducer/effects для сложного state, сохраняя traceability и testability.
