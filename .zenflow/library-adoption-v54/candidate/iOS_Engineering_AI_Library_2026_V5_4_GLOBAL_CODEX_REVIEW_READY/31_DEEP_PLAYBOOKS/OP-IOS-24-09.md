...
id: OP-IOS-24-09
type: deep-playbook
source_skill: IOS-24-09
title: Nearby Interaction — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-09 — Nearby Interaction

## Mission
capability/session lifecycle, discovery token exchange, precision availability and privacy

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-09_NEARBY_INTERACTION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Nearby Interaction».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-09 «Nearby Interaction» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: capability/session lifecycle, discovery token exchange, precision availability and privacy.
