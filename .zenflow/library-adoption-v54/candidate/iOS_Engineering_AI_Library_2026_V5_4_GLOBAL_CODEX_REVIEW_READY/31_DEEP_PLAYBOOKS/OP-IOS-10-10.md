...
id: OP-IOS-10-10
type: deep-playbook
source_skill: IOS-10-10
title: Performance regression tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-10 — Performance regression tests

## Mission
метрики, warmup, baseline, variance и CI signal без flaky thresholds

Этот playbook — operational-версия `10_TESTING/IOS-10-10_PERFORMANCE_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Performance regression tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-10 «Performance regression tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: метрики, warmup, baseline, variance и CI signal без flaky thresholds.
