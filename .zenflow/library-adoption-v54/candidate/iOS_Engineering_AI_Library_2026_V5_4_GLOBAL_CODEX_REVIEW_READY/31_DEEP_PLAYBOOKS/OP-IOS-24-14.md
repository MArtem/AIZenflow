...
id: OP-IOS-24-14
type: deep-playbook
source_skill: IOS-24-14
title: System integration review — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-14 — System integration review

## Mission
entitlements, scene/background lifecycle, delivery guarantees, version skew, privacy and recovery

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-14_SYSTEM_INTEGRATION_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «System integration review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-14 «System integration review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: entitlements, scene/background lifecycle, delivery guarantees, version skew, privacy and recovery.
