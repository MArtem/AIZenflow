...
id: OP-IOS-14-03
type: deep-playbook
source_skill: IOS-14-03
title: Live Activities — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-03 — Live Activities

## Mission
ActivityKit state/content design, push updates, stale/end lifecycle, privacy и battery

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-03_LIVE_ACTIVITIES.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Live Activities».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-03 «Live Activities» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: ActivityKit state/content design, push updates, stale/end lifecycle, privacy и battery.
