...
id: OP-IOS-18-01
type: deep-playbook
source_skill: IOS-18-01
title: OSLog strategy — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-01 — OSLog strategy

## Mission
subsystem/category, levels, privacy, stable event names, correlation и no sensitive payload

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-01_LOGGING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «OSLog strategy».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-01 «OSLog strategy» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: subsystem/category, levels, privacy, stable event names, correlation и no sensitive payload.
