...
id: OP-IOS-14-11
type: deep-playbook
source_skill: IOS-14-11
title: StoreKit 2 — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-11 — StoreKit 2

## Mission
products, purchase verification, currentEntitlements, updates listener, restore, subscription states и testing

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-11_STOREKIT2.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «StoreKit 2».
...
- Verify transaction verification, entitlement source of truth, restore/revocation/refund, pending state and server sync if used.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-11 «StoreKit 2» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: products, purchase verification, currentEntitlements, updates listener, restore, subscription states и testing.
