...
id: OP-IOS-02-12
type: deep-playbook
source_skill: IOS-02-12
title: Unsafe/memory safety audit — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-12 — Unsafe/memory safety audit

## Mission
минимизировать unsafe pointers/C interop, документировать lifetime/alignment/bounds и boundary tests

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-12_MEMORY_SAFETY_UNSAFE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Unsafe/memory safety audit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-12 «Unsafe/memory safety audit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: минимизировать unsafe pointers/C interop, документировать lifetime/alignment/bounds и boundary tests.
