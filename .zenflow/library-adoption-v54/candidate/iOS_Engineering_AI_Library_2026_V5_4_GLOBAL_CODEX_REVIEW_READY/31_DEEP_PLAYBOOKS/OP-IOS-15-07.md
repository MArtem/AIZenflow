...
id: OP-IOS-15-07
type: deep-playbook
source_skill: IOS-15-07
title: Streaming AI UI — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-07 — Streaming AI UI

## Mission
partial state, cancellation, reconnect, token/segment rendering, accessibility и error recovery

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-07_AI_STREAMING_UI.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Streaming AI UI».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-07 «Streaming AI UI» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: partial state, cancellation, reconnect, token/segment rendering, accessibility и error recovery.
