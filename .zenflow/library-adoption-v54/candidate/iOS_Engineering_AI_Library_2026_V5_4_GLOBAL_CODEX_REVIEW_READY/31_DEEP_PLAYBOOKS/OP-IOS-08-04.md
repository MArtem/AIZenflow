...
id: OP-IOS-08-04
type: deep-playbook
source_skill: IOS-08-04
title: Pagination — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-04 — Pagination

## Mission
cursor/page semantics, duplicate handling, cancellation, refresh, error recovery и stable UI identity

Этот playbook — operational-версия `08_NETWORKING/IOS-08-04_PAGINATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Pagination».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-04 «Pagination» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: cursor/page semantics, duplicate handling, cancellation, refresh, error recovery и stable UI identity.
