...
id: OP-IOS-12-08
type: deep-playbook
source_skill: IOS-12-08
title: Privacy-safe logging — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-08 — Privacy-safe logging

## Mission
OSLog privacy, redaction, no tokens/PII, correlation identifiers и retention policy

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-08_LOGGING_PRIVACY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Privacy-safe logging».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-08 «Privacy-safe logging» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: OSLog privacy, redaction, no tokens/PII, correlation identifiers и retention policy.
