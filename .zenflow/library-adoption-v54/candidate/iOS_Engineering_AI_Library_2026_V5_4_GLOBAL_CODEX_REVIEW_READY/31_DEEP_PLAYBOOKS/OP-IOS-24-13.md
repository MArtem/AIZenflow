...
id: OP-IOS-24-13
type: deep-playbook
source_skill: IOS-24-13
title: CarPlay — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-13 — CarPlay

## Mission
template constraints, scene lifecycle, entitlements, driver distraction rules and shared navigation state

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-13_CARPLAY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CarPlay».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-13 «CarPlay» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: template constraints, scene lifecycle, entitlements, driver distraction rules and shared navigation state.
