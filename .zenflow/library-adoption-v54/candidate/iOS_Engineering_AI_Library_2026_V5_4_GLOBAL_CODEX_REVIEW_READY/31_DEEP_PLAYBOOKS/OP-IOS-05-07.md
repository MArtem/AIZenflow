...
id: OP-IOS-05-07
type: deep-playbook
source_skill: IOS-05-07
title: Layout & adaptive UI — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-07 — Layout & adaptive UI

## Mission
использовать layout system, size classes/container sizing, Dynamic Type и iPad multiwindow/resizing

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-07_LAYOUT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Layout & adaptive UI».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-07 «Layout & adaptive UI» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: использовать layout system, size classes/container sizing, Dynamic Type и iPad multiwindow/resizing.
