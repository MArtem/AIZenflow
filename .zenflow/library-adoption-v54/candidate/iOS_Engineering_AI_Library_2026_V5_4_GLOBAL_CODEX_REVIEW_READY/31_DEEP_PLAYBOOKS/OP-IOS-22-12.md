...
id: OP-IOS-22-12
type: deep-playbook
source_skill: IOS-22-12
title: Media/graphics review — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-12 — Media/graphics review

## Mission
проверить realtime/lifecycle/permissions/memory/thermal/color-orientation/interruption риски

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-12_MEDIA_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Media/graphics review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-12 «Media/graphics review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проверить realtime/lifecycle/permissions/memory/thermal/color-orientation/interruption риски.
