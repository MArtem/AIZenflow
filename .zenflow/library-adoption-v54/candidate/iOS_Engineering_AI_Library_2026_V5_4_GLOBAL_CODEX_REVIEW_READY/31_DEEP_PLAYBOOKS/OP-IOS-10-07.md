...
id: OP-IOS-10-07
type: deep-playbook
source_skill: IOS-10-07
title: Persistence tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-07 — Persistence tests

## Mission
isolated stores, migrations, conflict handling, transactions и corrupted data cases

Этот playbook — operational-версия `10_TESTING/IOS-10-07_PERSISTENCE_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Persistence tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-07 «Persistence tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: isolated stores, migrations, conflict handling, transactions и corrupted data cases.
