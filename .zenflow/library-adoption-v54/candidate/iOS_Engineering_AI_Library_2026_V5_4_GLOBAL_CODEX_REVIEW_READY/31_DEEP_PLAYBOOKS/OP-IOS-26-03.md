...
id: OP-IOS-26-03
type: deep-playbook
source_skill: IOS-26-03
title: Theming — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-03 — Theming

## Mission
semantic theme values, environment/scoping, dark mode, high contrast and brand variants without global mutation

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-03_THEMING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Theming».
...
- For **Theming**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-03 «Theming» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: semantic theme values, environment/scoping, dark mode, high contrast and brand variants without global mutation.
