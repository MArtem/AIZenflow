...
id: OP-IOS-14-07
type: deep-playbook
source_skill: IOS-14-07
title: MapKit — Operational Deep Playbook
...
## Mission
annotations, camera state, clustering, search, routing, privacy и performance

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-07_MAPKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «MapKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-07 «MapKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: annotations, camera state, clustering, search, routing, privacy и performance.
