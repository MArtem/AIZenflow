...
id: OP-IOS-24-01
type: deep-playbook
source_skill: IOS-24-01
title: WKWebView integration — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-01 — WKWebView integration

## Mission
process/navigation lifecycle, async JS bridge, content worlds, downloads, cookies, auth and safe URL policy

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-01_WEBKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «WKWebView integration».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-01 «WKWebView integration» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: process/navigation lifecycle, async JS bridge, content worlds, downloads, cookies, auth and safe URL policy.
