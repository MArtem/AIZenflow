...
id: OP-IOS-05-03
type: deep-playbook
source_skill: IOS-05-03
title: View identity — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-03 — View identity

## Mission
устранить bugs от неверной identity, conditional trees, ForEach ids и state resets

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-03_VIEW_IDENTITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «View identity».
...
- For **View identity**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-03 «View identity» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: устранить bugs от неверной identity, conditional trees, ForEach ids и state resets.
