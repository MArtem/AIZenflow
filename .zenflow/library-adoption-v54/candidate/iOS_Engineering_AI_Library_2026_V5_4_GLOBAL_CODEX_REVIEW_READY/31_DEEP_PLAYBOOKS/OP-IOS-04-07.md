...
id: OP-IOS-04-07
type: deep-playbook
source_skill: IOS-04-07
title: Dependency injection — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-07 — Dependency injection

## Mission
явно передавать dependencies, scopes и test doubles без глобального container abuse

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-07_DEPENDENCY_INJECTION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Dependency injection».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-07 «Dependency injection» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: явно передавать dependencies, scopes и test doubles без глобального container abuse.
