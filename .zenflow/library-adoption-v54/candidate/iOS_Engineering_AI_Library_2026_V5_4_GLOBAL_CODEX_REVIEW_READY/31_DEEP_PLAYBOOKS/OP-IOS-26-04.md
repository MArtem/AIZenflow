...
id: OP-IOS-26-04
type: deep-playbook
source_skill: IOS-26-04
title: Typography system — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-04 — Typography system

## Mission
Dynamic Type-first typography, variable fonts where appropriate, truncation/wrapping and localization expansion

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-04_TYPOGRAPHY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Typography system».
...
- For **Typography system**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-04 «Typography system» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: Dynamic Type-first typography, variable fonts where appropriate, truncation/wrapping and localization expansion.
