...
id: OP-IOS-09-03
type: deep-playbook
source_skill: IOS-09-03
title: Core Data modeling — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-03 — Core Data modeling

## Mission
entities/relationships/faulting/fetches, constraints, contexts и migration-aware design

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-03_COREDATA_MODEL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Data modeling».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-03 «Core Data modeling» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: entities/relationships/faulting/fetches, constraints, contexts и migration-aware design.
