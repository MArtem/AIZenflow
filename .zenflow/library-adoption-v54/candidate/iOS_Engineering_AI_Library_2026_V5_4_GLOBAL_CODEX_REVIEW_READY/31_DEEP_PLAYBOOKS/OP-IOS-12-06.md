...
id: OP-IOS-12-06
type: deep-playbook
source_skill: IOS-12-06
title: Privacy manifest — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-06 — Privacy manifest

## Mission
аудит collected data, tracking domains, Required Reason APIs и third-party SDK manifests

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-06_PRIVACY_MANIFEST.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Privacy manifest».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-06 «Privacy manifest» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: аудит collected data, tracking domains, Required Reason APIs и third-party SDK manifests.
