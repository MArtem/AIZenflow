...
id: OP-IOS-02-09
type: deep-playbook
source_skill: IOS-02-09
title: Property wrappers — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-09 — Property wrappers

## Mission
применять wrapper для повторяемой property semantics без скрытого lifecycle/side effects

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-09_PROPERTY_WRAPPERS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Property wrappers».
...
- For **Property wrappers**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-09 «Property wrappers» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: применять wrapper для повторяемой property semantics без скрытого lifecycle/side effects.
