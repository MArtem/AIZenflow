...
id: OP-IOS-19-03
type: deep-playbook
source_skill: IOS-19-03
title: Safe refactor — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-03 — Safe refactor

## Mission
зафиксировать behavior tests, сделать incremental changes, сохранить public contract и measure regression

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-03_SAFE_REFACTOR.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Safe refactor».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-03 «Safe refactor» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: зафиксировать behavior tests, сделать incremental changes, сохранить public contract и measure regression.
