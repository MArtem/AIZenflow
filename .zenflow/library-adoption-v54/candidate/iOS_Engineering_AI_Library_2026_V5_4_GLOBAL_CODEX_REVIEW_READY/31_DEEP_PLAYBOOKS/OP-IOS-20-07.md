...
id: OP-IOS-20-07
type: deep-playbook
source_skill: IOS-20-07
title: Minimum iOS bump — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-07 — Minimum iOS bump

## Mission
inventory availability shims, usage analytics, CI/device matrix, code deletion и release communication

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-07_MIN_IOS_BUMP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Minimum iOS bump».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-07 «Minimum iOS bump» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: inventory availability shims, usage analytics, CI/device matrix, code deletion и release communication.
