...
id: OP-IOS-07-06
type: deep-playbook
source_skill: IOS-07-06
title: Multiwindow/scenes — Operational Deep Playbook
section: 07_NAVIGATION_DEEPLINKS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-07-06 — Multiwindow/scenes

## Mission
разделить scene-specific state, routing, document/session ownership и lifecycle

Этот playbook — operational-версия `07_NAVIGATION_DEEPLINKS/IOS-07-06_MULTIWINDOW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Multiwindow/scenes».
...
- For **Multiwindow/scenes**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-07-06 «Multiwindow/scenes» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: разделить scene-specific state, routing, document/session ownership и lifecycle.
