...
id: OP-IOS-13-04
type: deep-playbook
source_skill: IOS-13-04
title: Accessible custom control — Operational Deep Playbook
section: 13_ACCESSIBILITY_LOCALIZATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-13-04 — Accessible custom control

## Mission
traits/actions/hit target/focus/state announcement и keyboard/switch control considerations

Этот playbook — operational-версия `13_ACCESSIBILITY_LOCALIZATION/IOS-13-04_ACCESSIBLE_COMPONENT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Accessible custom control».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-13-04 «Accessible custom control» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: traits/actions/hit target/focus/state announcement и keyboard/switch control considerations.
