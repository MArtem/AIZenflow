...
id: OP-IOS-22-11
type: deep-playbook
source_skill: IOS-22-11
title: PhotoKit — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-11 — PhotoKit

## Mission
limited library, fetch/change observers, authorization changes, asset requests, iCloud-backed assets и cancellation

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-11_PHOTOKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «PhotoKit».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-11 «PhotoKit» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: limited library, fetch/change observers, authorization changes, asset requests, iCloud-backed assets и cancellation.
