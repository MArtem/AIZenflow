...
id: OP-IOS-24-06
type: deep-playbook
source_skill: IOS-24-06
title: Core NFC — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-06 — Core NFC

## Mission
session lifetime, entitlements, polling/read/write flows, user prompts, errors and device support

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-06_NFC.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core NFC».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-06 «Core NFC» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: session lifetime, entitlements, polling/read/write flows, user prompts, errors and device support.
