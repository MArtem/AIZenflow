...
id: OP-IOS-11-12
type: deep-playbook
source_skill: IOS-11-12
title: Performance code review — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-12 — Performance code review

## Mission
искать O(n²), repeated allocations, main-thread sync I/O, excessive copying и unbounded caches

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-12_PERF_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Performance code review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-12 «Performance code review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: искать O(n²), repeated allocations, main-thread sync I/O, excessive copying и unbounded caches.
