...
id: OP-IOS-16-01
type: deep-playbook
source_skill: IOS-16-01
title: Swift Package design — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-01 — Swift Package design

## Mission
targets/products/resources/plugins, dependency graph, visibility и test structure

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-01_SPM_PACKAGE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Swift Package design».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-01 «Swift Package design» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: targets/products/resources/plugins, dependency graph, visibility и test structure.
