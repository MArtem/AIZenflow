...
id: OP-IOS-10-09
type: deep-playbook
source_skill: IOS-10-09
title: Property/fuzz tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-09 — Property/fuzz tests

## Mission
генерировать edge inputs для parsers/state machines/serialization и сохранять reproducibility

Этот playbook — operational-версия `10_TESTING/IOS-10-09_PROPERTY_BASED.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Property/fuzz tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-09 «Property/fuzz tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: генерировать edge inputs для parsers/state machines/serialization и сохранять reproducibility.
