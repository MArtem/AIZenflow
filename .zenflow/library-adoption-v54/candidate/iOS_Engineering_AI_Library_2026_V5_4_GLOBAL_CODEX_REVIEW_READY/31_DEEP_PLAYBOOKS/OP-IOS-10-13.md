...
id: OP-IOS-10-13
type: deep-playbook
source_skill: IOS-10-13
title: Flaky test diagnosis — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-13 — Flaky test diagnosis

## Mission
классифицировать race/time/network/shared-state/order issues, не лечить retries

Этот playbook — operational-версия `10_TESTING/IOS-10-13_FLAKY_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Flaky test diagnosis».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-13 «Flaky test diagnosis» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: классифицировать race/time/network/shared-state/order issues, не лечить retries.
