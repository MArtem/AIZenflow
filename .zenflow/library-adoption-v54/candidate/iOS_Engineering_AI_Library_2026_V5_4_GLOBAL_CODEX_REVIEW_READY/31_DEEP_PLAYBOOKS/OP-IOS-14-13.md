...
id: OP-IOS-14-13
type: deep-playbook
source_skill: IOS-14-13
title: Extensions/share — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-13 — Extensions/share

## Mission
memory/time budgets, app group boundaries, data handoff и extension-safe APIs

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-13_SHARE_EXTENSIONS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Extensions/share».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-13 «Extensions/share» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: memory/time budgets, app group boundaries, data handoff и extension-safe APIs.
