...
id: OP-IOS-06-01
type: deep-playbook
source_skill: IOS-06-01
title: UIViewController lifecycle — Operational Deep Playbook
section: 06_UIKIT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-06-01 — UIViewController lifecycle

## Mission
правильно распределить setup, binding, loading, appearance и teardown по lifecycle

Этот playbook — operational-версия `06_UIKIT/IOS-06-01_VC_LIFECYCLE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UIViewController lifecycle».
...
- For **UIViewController lifecycle**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-06-01 «UIViewController lifecycle» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: правильно распределить setup, binding, loading, appearance и teardown по lifecycle.
