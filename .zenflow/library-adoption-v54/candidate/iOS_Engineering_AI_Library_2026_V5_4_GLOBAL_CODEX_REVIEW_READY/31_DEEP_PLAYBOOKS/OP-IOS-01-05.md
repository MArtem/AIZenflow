...
id: OP-IOS-01-05
type: deep-playbook
source_skill: IOS-01-05
title: Технический risk register — Operational Deep Playbook
section: 01_DISCOVERY_PRODUCT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-01-05 — Технический risk register

## Mission
собрать concurrency, data loss, privacy, auth, migration, compatibility, performance и release risks с mitigation/verification

Этот playbook — operational-версия `01_DISCOVERY_PRODUCT/IOS-01-05_RISK_REGISTER.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Технический risk register».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-01-05 «Технический risk register» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: собрать concurrency, data loss, privacy, auth, migration, compatibility, performance и release risks с mitigation/verification.
