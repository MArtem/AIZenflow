...
id: OP-IOS-24-08
type: deep-playbook
source_skill: IOS-24-08
title: MultipeerConnectivity — Operational Deep Playbook
section: 27_SYSTEM_INTEGRATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-24-08 — MultipeerConnectivity

## Mission
peer discovery, session state, security/encryption assumptions, transfer backpressure and lifecycle

Этот playbook — operational-версия `27_SYSTEM_INTEGRATION/IOS-24-08_MULTIPEER.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «MultipeerConnectivity».
...
- Model disconnect/reconnect/version skew/repeated delivery and test on hardware for transport-specific behavior.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-24-08 «MultipeerConnectivity» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: peer discovery, session state, security/encryption assumptions, transfer backpressure and lifecycle.
