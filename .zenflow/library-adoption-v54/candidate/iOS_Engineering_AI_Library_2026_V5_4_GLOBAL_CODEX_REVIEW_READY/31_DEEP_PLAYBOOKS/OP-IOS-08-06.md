...
id: OP-IOS-08-06
type: deep-playbook
source_skill: IOS-08-06
title: WebSocket/streaming — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-06 — WebSocket/streaming

## Mission
connection state machine, heartbeat, reconnect, backoff, ordering, deduplication и lifecycle

Этот playbook — operational-версия `08_NETWORKING/IOS-08-06_WEBSOCKET_STREAM.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «WebSocket/streaming».
...
- Verify connection state machine, heartbeat, reconnect backoff, ordering, duplicate events and background transitions.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-06 «WebSocket/streaming» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: connection state machine, heartbeat, reconnect, backoff, ordering, deduplication и lifecycle.
