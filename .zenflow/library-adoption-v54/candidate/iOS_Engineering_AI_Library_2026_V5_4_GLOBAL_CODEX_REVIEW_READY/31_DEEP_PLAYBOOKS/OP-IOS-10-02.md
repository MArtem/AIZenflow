...
id: OP-IOS-10-02
type: deep-playbook
source_skill: IOS-10-02
title: Swift Testing — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-02 — Swift Testing

## Mission
@Test/#expect/#require, parameterized tests, tags, async tests и parallel-safety

Этот playbook — operational-версия `10_TESTING/IOS-10-02_SWIFT_TESTING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Swift Testing».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-02 «Swift Testing» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: @Test/#expect/#require, parameterized tests, tags, async tests и parallel-safety.
