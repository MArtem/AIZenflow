...
id: OP-IOS-16-04
type: deep-playbook
source_skill: IOS-16-04
title: Build settings — Operational Deep Playbook
section: 16_BUILD_MODULARITY_TOOLING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-16-04 — Build settings

## Mission
конфигурации, xcconfig, flags, warnings, Swift mode и environment separation

Этот playbook — operational-версия `16_BUILD_MODULARITY_TOOLING/IOS-16-04_BUILD_SETTINGS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Build settings».
...
- For **Build settings**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-16-04 «Build settings» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: конфигурации, xcconfig, flags, warnings, Swift mode и environment separation.
