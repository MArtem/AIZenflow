...
id: OP-IOS-13-07
type: deep-playbook
source_skill: IOS-13-07
title: Locale formatting — Operational Deep Playbook
section: 13_ACCESSIBILITY_LOCALIZATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-13-07 — Locale formatting

## Mission
FormatStyle/Calendar/TimeZone, user locale, currency/measurement и parsing boundaries

Этот playbook — operational-версия `13_ACCESSIBILITY_LOCALIZATION/IOS-13-07_DATES_NUMBERS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Locale formatting».
...
- For **Locale formatting**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-13-07 «Locale formatting» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: FormatStyle/Calendar/TimeZone, user locale, currency/measurement и parsing boundaries.
