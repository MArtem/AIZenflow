...
id: OP-IOS-15-06
type: deep-playbook
source_skill: IOS-15-06
title: AI privacy — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-06 — AI privacy

## Mission
data minimization, on-device preference, consent, retention, server provider boundaries и redaction

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-06_AI_PRIVACY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AI privacy».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-06 «AI privacy» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: data minimization, on-device preference, consent, retention, server provider boundaries и redaction.
