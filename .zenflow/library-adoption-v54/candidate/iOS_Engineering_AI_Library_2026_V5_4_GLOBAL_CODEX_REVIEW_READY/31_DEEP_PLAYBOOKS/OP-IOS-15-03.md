...
id: OP-IOS-15-03
type: deep-playbook
source_skill: IOS-15-03
title: AI feature evaluation — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-03 — AI feature evaluation

## Mission
golden datasets, task metrics, safety/privacy, latency/cost, regression suites и human review

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-03_AI_EVALUATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AI feature evaluation».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-03 «AI feature evaluation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: golden datasets, task metrics, safety/privacy, latency/cost, regression suites и human review.
