...
id: OP-IOS-03-04
type: deep-playbook
source_skill: IOS-03-04
title: MainActor discipline — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-04 — MainActor discipline

## Mission
оставить на MainActor только UI-bound state/work и вынести тяжёлую работу без лишних hops

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-04_MAIN_ACTOR.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «MainActor discipline».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-04 «MainActor discipline» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оставить на MainActor только UI-bound state/work и вынести тяжёлую работу без лишних hops.
