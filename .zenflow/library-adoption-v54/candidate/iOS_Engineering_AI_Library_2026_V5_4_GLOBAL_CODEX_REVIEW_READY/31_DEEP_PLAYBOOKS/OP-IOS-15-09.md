...
id: OP-IOS-15-09
type: deep-playbook
source_skill: IOS-15-09
title: AI abuse/safety review — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-09 — AI abuse/safety review

## Mission
prompt injection, data exfiltration, tool misuse, unsafe actions, rate limits и user confirmation

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-09_AI_ABUSE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AI abuse/safety review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-09 «AI abuse/safety review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: prompt injection, data exfiltration, tool misuse, unsafe actions, rate limits и user confirmation.
