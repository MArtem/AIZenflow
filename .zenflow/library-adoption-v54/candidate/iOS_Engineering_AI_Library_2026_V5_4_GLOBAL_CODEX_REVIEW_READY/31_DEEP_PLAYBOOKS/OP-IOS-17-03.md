...
id: OP-IOS-17-03
type: deep-playbook
source_skill: IOS-17-03
title: Code signing — Operational Deep Playbook
section: 17_CI_CD_RELEASE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-17-03 — Code signing

## Mission
certificates/profiles/automatic signing strategy, CI key security и rotation

Этот playbook — operational-версия `17_CI_CD_RELEASE/IOS-17-03_CODE_SIGNING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Code signing».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-17-03 «Code signing» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: certificates/profiles/automatic signing strategy, CI key security и rotation.
