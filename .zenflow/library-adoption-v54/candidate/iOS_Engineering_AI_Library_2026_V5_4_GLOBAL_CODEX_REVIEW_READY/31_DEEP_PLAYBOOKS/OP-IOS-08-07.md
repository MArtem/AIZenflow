...
id: OP-IOS-08-07
type: deep-playbook
source_skill: IOS-08-07
title: HTTP caching — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-07 — HTTP caching

## Mission
Cache-Control/ETag/Last-Modified, URLCache, invalidation и offline semantics

Этот playbook — operational-версия `08_NETWORKING/IOS-08-07_CACHE_HTTP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «HTTP caching».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-07 «HTTP caching» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: Cache-Control/ETag/Last-Modified, URLCache, invalidation и offline semantics.
