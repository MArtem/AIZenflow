...
id: OP-IOS-23-07
type: deep-playbook
source_skill: IOS-23-07
title: Spatial/adaptive experience — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-07 — Spatial/adaptive experience

## Mission
проектировать input/window/space-aware UX и shared domain logic без iPhone assumptions

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-07_SPATIAL_COMPUTING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Spatial/adaptive experience».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-07 «Spatial/adaptive experience» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проектировать input/window/space-aware UX и shared domain logic без iPhone assumptions.
