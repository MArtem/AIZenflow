...
id: OP-IOS-12-09
type: deep-playbook
source_skill: IOS-12-09
title: WKWebView security — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-09 — WKWebView security

## Mission
navigation policy, JS bridge surface, content worlds, untrusted URLs, file access и cookie/session boundaries

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-09_WEBVIEW_SECURITY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «WKWebView security».
...
- Validate navigation policy, JS bridge input, content-world isolation, cookie/auth handling, downloads and untrusted content.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-09 «WKWebView security» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: navigation policy, JS bridge surface, content worlds, untrusted URLs, file access и cookie/session boundaries.
