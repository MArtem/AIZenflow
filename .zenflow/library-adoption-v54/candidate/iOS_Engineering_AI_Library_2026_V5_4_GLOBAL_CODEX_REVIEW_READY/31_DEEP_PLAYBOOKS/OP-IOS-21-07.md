...
id: OP-IOS-21-07
type: deep-playbook
source_skill: IOS-21-07
title: Security audit workflow — Operational Deep Playbook
section: 21_AGENT_WORKFLOWS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-21-07 — Security audit workflow

## Mission
threat model → trust boundaries → inspect secrets/auth/network/webviews/deeplinks/logging → mitigations

Этот playbook — operational-версия `21_AGENT_WORKFLOWS/IOS-21-07_SECURITY_WORKFLOW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Security audit workflow».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-21-07 «Security audit workflow» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: threat model → trust boundaries → inspect secrets/auth/network/webviews/deeplinks/logging → mitigations.
