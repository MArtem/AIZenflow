...
id: OP-IOS-07-02
type: deep-playbook
source_skill: IOS-07-02
title: Deep-link parsing — Operational Deep Playbook
section: 07_NAVIGATION_DEEPLINKS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-07-02 — Deep-link parsing

## Mission
валидировать URL, versioning, auth gates, feature availability и malformed inputs

Этот playbook — operational-версия `07_NAVIGATION_DEEPLINKS/IOS-07-02_DEEPLINK_PARSER.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Deep-link parsing».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-07-02 «Deep-link parsing» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: валидировать URL, versioning, auth gates, feature availability и malformed inputs.
