...
id: OP-IOS-09-10
type: deep-playbook
source_skill: IOS-09-10
title: Persistence review — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-10 — Persistence review

## Mission
integrity, migrations, concurrency, fetch performance, data loss, privacy и backup semantics

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-10_DATA_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Persistence review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-10 «Persistence review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: integrity, migrations, concurrency, fetch performance, data loss, privacy и backup semantics.
