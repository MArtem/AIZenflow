...
id: OP-IOS-14-10
type: deep-playbook
source_skill: IOS-14-10
title: CoreBluetooth — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-10 — CoreBluetooth

## Mission
state machine, restoration, permissions, reconnect, background constraints и protocol robustness

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-10_BLUETOOTH.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CoreBluetooth».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-10 «CoreBluetooth» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: state machine, restoration, permissions, reconnect, background constraints и protocol robustness.
