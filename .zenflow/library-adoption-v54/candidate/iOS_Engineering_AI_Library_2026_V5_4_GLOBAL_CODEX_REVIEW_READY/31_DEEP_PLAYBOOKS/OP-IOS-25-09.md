...
id: OP-IOS-25-09
type: deep-playbook
source_skill: IOS-25-09
title: Third-party SDK wrapper — Operational Deep Playbook
section: 28_ECOSYSTEM_INTEROP
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-25-09 — Third-party SDK wrapper

## Mission
создать узкую anti-corruption boundary, lifecycle/consent/configuration and replacement seam

Этот playbook — operational-версия `28_ECOSYSTEM_INTEROP/IOS-25-09_SDK_WRAPPER.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Third-party SDK wrapper».
...
- For **Third-party SDK wrapper**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-25-09 «Third-party SDK wrapper» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: создать узкую anti-corruption boundary, lifecycle/consent/configuration and replacement seam.
