...
id: OP-IOS-26-05
type: deep-playbook
source_skill: IOS-26-05
title: Icons/SF Symbols — Operational Deep Playbook
section: 29_DESIGN_SYSTEM
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-26-05 — Icons/SF Symbols

## Mission
semantic symbols, rendering modes, localization/RTL, accessibility labels and fallback assets

Этот playbook — operational-версия `29_DESIGN_SYSTEM/IOS-26-05_ICONOGRAPHY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Icons/SF Symbols».
...
- For **Icons/SF Symbols**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-26-05 «Icons/SF Symbols» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: semantic symbols, rendering modes, localization/RTL, accessibility labels and fallback assets.
