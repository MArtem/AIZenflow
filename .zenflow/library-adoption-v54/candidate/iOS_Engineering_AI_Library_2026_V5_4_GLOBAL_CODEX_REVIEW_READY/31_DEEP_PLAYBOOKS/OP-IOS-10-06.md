...
id: OP-IOS-10-06
type: deep-playbook
source_skill: IOS-10-06
title: Networking tests — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-06 — Networking tests

## Mission
URLProtocol/fakes, request assertions, error mapping, retry/cancellation и decoding fixtures

Этот playbook — operational-версия `10_TESTING/IOS-10-06_NETWORK_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Networking tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-06 «Networking tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: URLProtocol/fakes, request assertions, error mapping, retry/cancellation и decoding fixtures.
