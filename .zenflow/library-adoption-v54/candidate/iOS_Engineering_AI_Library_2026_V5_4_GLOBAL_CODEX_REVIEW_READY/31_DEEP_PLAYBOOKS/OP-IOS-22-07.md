...
id: OP-IOS-22-07
type: deep-playbook
source_skill: IOS-22-07
title: Core Graphics drawing — Operational Deep Playbook
section: 25_MEDIA_GRAPHICS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-22-07 — Core Graphics drawing

## Mission
правильно управлять scale/coordinate systems/color spaces/path drawing и offscreen rendering

Этот playbook — operational-версия `25_MEDIA_GRAPHICS/IOS-22-07_CORE_GRAPHICS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Core Graphics drawing».
...
- For **Core Graphics drawing**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-22-07 «Core Graphics drawing» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: правильно управлять scale/coordinate systems/color spaces/path drawing и offscreen rendering.
