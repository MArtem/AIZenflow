...
id: OP-IOS-18-04
type: deep-playbook
source_skill: IOS-18-04
title: Hang/main-thread stall — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-04 — Hang/main-thread stall

## Mission
thread stacks, main actor sync work, locks, I/O, layout и signpost evidence

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-04_HANG_TRIAGE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Hang/main-thread stall».
...
- Separate UI isolation from expensive work; avoid serializing parsing/I/O on the main actor merely to silence diagnostics.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-04 «Hang/main-thread stall» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: thread stacks, main actor sync work, locks, I/O, layout и signpost evidence.
