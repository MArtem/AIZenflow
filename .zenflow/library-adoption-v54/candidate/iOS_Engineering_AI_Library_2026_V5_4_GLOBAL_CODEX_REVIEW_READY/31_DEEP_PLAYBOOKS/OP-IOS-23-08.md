...
id: OP-IOS-23-08
type: deep-playbook
source_skill: IOS-23-08
title: ML/Vision tests — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-08 — ML/Vision tests

## Mission
golden fixtures, tolerance metrics, device/model variance, regression dataset и deterministic preprocessing

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-08_ML_PIPELINE_TESTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «ML/Vision tests».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-08 «ML/Vision tests» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: golden fixtures, tolerance metrics, device/model variance, regression dataset и deterministic preprocessing.
