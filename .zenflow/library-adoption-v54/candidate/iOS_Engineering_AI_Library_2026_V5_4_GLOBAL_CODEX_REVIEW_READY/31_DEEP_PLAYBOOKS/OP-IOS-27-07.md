...
id: OP-IOS-27-07
type: deep-playbook
source_skill: IOS-27-07
title: Senior mentoring review — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-07 — Senior mentoring review

## Mission
объяснять trade-offs and teach review heuristics, not rewrite everything to reviewer preference

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-07_MENTOR_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Senior mentoring review».
...
- For **Senior mentoring review**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-07 «Senior mentoring review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: объяснять trade-offs and teach review heuristics, not rewrite everything to reviewer preference.
