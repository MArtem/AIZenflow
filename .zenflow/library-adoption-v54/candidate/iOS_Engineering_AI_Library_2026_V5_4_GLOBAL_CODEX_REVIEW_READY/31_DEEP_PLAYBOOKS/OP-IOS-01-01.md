...
id: OP-IOS-01-01
type: deep-playbook
source_skill: IOS-01-01
title: Декомпозиция feature из product требований — Operational Deep Playbook
section: 01_DISCOVERY_PRODUCT
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-01-01 — Декомпозиция feature из product требований

## Mission
выявить user journeys, acceptance criteria, non-goals, edge cases, analytics, permissions, offline/error states и технические ограничения

Этот playbook — operational-версия `01_DISCOVERY_PRODUCT/IOS-01-01_FEATURE_REQUIREMENTS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Декомпозиция feature из product требований».
...
- For **Декомпозиция feature из product требований**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-01-01 «Декомпозиция feature из product требований» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выявить user journeys, acceptance criteria, non-goals, edge cases, analytics, permissions, offline/error states и технические ограничения.
