...
id: OP-IOS-02-02
type: deep-playbook
source_skill: IOS-02-02
title: Value vs reference semantics — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-02 — Value vs reference semantics

## Mission
выбрать struct/class/enum по identity, mutation, sharing, performance и concurrency semantics

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-02_VALUE_REFERENCE_SEMANTICS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Value vs reference semantics».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-02 «Value vs reference semantics» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выбрать struct/class/enum по identity, mutation, sharing, performance и concurrency semantics.
