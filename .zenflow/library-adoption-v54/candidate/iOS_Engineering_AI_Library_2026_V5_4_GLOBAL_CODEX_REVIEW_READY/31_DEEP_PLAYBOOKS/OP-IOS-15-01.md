...
id: OP-IOS-15-01
type: deep-playbook
source_skill: IOS-15-01
title: Foundation Models — Operational Deep Playbook
section: 15_AI_INTELLIGENCE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-15-01 — Foundation Models

## Mission
capability/availability gating, structured prompting, tool use, privacy, latency, fallback и evaluation

Этот playbook — operational-версия `15_AI_INTELLIGENCE/IOS-15-01_FOUNDATION_MODELS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Foundation Models».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-15-01 «Foundation Models» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: capability/availability gating, structured prompting, tool use, privacy, latency, fallback и evaluation.
