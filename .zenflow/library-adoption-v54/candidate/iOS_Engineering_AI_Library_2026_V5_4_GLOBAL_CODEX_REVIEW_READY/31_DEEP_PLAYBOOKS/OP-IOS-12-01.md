...
id: OP-IOS-12-01
type: deep-playbook
source_skill: IOS-12-01
title: Mobile threat model — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-01 — Mobile threat model

## Mission
assets, attackers, trust boundaries, abuse cases, mitigations и residual risk

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-01_THREAT_MODEL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Mobile threat model».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-01 «Mobile threat model» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: assets, attackers, trust boundaries, abuse cases, mitigations и residual risk.
