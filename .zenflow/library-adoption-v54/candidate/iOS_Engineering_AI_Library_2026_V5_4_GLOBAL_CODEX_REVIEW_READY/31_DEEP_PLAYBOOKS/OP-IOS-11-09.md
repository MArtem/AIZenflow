...
id: OP-IOS-11-09
type: deep-playbook
source_skill: IOS-11-09
title: Network performance — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-09 — Network performance

## Mission
payload size, compression, caching, connection reuse, serialization и perceived latency

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-09_NETWORK_PERF.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Network performance».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-09 «Network performance» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: payload size, compression, caching, connection reuse, serialization и perceived latency.
