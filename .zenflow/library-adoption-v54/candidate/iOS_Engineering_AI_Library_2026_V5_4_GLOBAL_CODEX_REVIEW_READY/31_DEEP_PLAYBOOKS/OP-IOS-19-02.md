...
id: OP-IOS-19-02
type: deep-playbook
source_skill: IOS-19-02
title: Risk-based PR review — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-02 — Risk-based PR review

## Mission
ранжировать findings по severity/likelihood/blast radius и отличать blocker от style preference

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-02_PR_REVIEW_RISK.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Risk-based PR review».
...
- For **Risk-based PR review**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-02 «Risk-based PR review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: ранжировать findings по severity/likelihood/blast radius и отличать blocker от style preference.
