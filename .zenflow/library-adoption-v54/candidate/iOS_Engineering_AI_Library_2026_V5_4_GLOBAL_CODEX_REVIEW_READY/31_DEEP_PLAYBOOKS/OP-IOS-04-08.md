...
id: OP-IOS-04-08
type: deep-playbook
source_skill: IOS-04-08
title: Repository/service boundaries — Operational Deep Playbook
section: 04_ARCHITECTURE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-04-08 — Repository/service boundaries

## Mission
разделить remote/local/cache orchestration по контракту данных и business semantics

Этот playbook — operational-версия `04_ARCHITECTURE/IOS-04-08_REPOSITORY_SERVICE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Repository/service boundaries».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-04-08 «Repository/service boundaries» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: разделить remote/local/cache orchestration по контракту данных и business semantics.
