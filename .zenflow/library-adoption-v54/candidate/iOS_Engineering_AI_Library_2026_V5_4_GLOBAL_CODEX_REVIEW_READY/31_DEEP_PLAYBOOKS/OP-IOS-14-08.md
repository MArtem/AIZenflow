...
id: OP-IOS-14-08
type: deep-playbook
source_skill: IOS-14-08
title: HealthKit integration — Operational Deep Playbook
section: 14_PLATFORM_SERVICES
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-14-08 — HealthKit integration

## Mission
authorization granularity, queries, background delivery, data minimization и sensitive logging rules

Этот playbook — operational-версия `14_PLATFORM_SERVICES/IOS-14-08_HEALTHKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «HealthKit integration».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-14-08 «HealthKit integration» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: authorization granularity, queries, background delivery, data minimization и sensitive logging rules.
