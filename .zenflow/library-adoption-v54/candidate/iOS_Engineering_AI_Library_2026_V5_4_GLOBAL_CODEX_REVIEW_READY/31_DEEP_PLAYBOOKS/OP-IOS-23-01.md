...
id: OP-IOS-23-01
type: deep-playbook
source_skill: IOS-23-01
title: Vision framework — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-01 — Vision framework

## Mission
выбрать request pipeline, image orientation, ROI, revision/availability, batching и latency

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-01_VISION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Vision framework».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-01 «Vision framework» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выбрать request pipeline, image orientation, ROI, revision/availability, batching и latency.
