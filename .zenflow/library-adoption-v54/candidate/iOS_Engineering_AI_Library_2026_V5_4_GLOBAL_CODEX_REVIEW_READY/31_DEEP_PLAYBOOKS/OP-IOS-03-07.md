...
id: OP-IOS-03-07
type: deep-playbook
source_skill: IOS-03-07
title: Cancellation — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-07 — Cancellation

## Mission
сделать cooperative cancellation сквозной: network, parsing, loops, child tasks и UI state

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-07_CANCELLATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Cancellation».
...
- For **Cancellation**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-07 «Cancellation» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: сделать cooperative cancellation сквозной: network, parsing, loops, child tasks и UI state.
