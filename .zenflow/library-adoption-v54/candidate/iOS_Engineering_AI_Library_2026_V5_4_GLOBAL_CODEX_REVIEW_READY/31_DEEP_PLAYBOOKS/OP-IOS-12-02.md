...
id: OP-IOS-12-02
type: deep-playbook
source_skill: IOS-12-02
title: Keychain secrets — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-02 — Keychain secrets

## Mission
accessibility class, access groups, migration, deletion, biometric/user-presence semantics и error handling

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-02_KEYCHAIN.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Keychain secrets».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-02 «Keychain secrets» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: accessibility class, access groups, migration, deletion, biometric/user-presence semantics и error handling.
