...
id: OP-IOS-11-03
type: deep-playbook
source_skill: IOS-11-03
title: Scrolling/hitching — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-03 — Scrolling/hitching

## Mission
найти main-thread stalls, layout churn, image decode, diff size и over-invalidation

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-03_SCROLLING.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Scrolling/hitching».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-03 «Scrolling/hitching» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: найти main-thread stalls, layout churn, image decode, diff size и over-invalidation.
