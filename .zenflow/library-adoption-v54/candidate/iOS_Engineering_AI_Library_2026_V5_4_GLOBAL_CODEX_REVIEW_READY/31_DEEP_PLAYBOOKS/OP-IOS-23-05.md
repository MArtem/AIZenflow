...
id: OP-IOS-23-05
type: deep-playbook
source_skill: IOS-23-05
title: ARKit session — Operational Deep Playbook
section: 26_ML_VISION_AR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-23-05 — ARKit session

## Mission
session configuration, tracking states, interruptions, permissions, world mapping и device support

Этот playbook — operational-версия `26_ML_VISION_AR/IOS-23-05_ARKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «ARKit session».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-23-05 «ARKit session» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: session configuration, tracking states, interruptions, permissions, world mapping и device support.
