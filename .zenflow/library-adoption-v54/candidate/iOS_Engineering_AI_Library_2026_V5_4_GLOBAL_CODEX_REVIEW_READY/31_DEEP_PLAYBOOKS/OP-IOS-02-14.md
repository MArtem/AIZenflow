...
id: OP-IOS-02-14
type: deep-playbook
source_skill: IOS-02-14
title: Public package API — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-14 — Public package API

## Mission
проектировать semver-friendly API, SPI, @inlinable exposure и compatibility tests

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-14_PUBLIC_PACKAGE_API.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Public package API».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-14 «Public package API» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проектировать semver-friendly API, SPI, @inlinable exposure и compatibility tests.
