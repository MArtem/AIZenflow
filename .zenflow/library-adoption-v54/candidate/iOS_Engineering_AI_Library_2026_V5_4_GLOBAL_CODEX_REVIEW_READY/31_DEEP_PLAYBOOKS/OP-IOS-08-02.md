...
id: OP-IOS-08-02
type: deep-playbook
source_skill: IOS-08-02
title: Auth/token refresh — Operational Deep Playbook
section: 08_NETWORKING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-08-02 — Auth/token refresh

## Mission
single-flight refresh, replay safety, expiry skew, cancellation, logout race и secure storage

Этот playbook — operational-версия `08_NETWORKING/IOS-08-02_AUTH_REFRESH.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Auth/token refresh».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-08-02 «Auth/token refresh» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: single-flight refresh, replay safety, expiry skew, cancellation, logout race и secure storage.
