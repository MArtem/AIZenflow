...
id: OP-IOS-02-04
type: deep-playbook
source_skill: IOS-02-04
title: Ownership и noncopyable types — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-04 — Ownership и noncopyable types

## Mission
оценить borrowing/consuming/noncopyable подходы для performance/ресурсных типов без преждевременной сложности

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-04_NONCOPYABLE_OWNERSHIP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Ownership и noncopyable types».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-04 «Ownership и noncopyable types» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: оценить borrowing/consuming/noncopyable подходы для performance/ресурсных типов без преждевременной сложности.
