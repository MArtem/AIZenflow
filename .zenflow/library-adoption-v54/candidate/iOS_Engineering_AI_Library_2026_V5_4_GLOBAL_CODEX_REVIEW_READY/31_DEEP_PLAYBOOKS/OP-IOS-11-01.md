...
id: OP-IOS-11-01
type: deep-playbook
source_skill: IOS-11-01
title: Performance investigation plan — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-01 — Performance investigation plan

## Mission
выбрать Time Profiler, Allocations, Leaks, Memory Graph, Network, SwiftUI/Animation instruments по симптому

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-01_INSTRUMENTS_PLAN.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Performance investigation plan».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-01 «Performance investigation plan» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выбрать Time Profiler, Allocations, Leaks, Memory Graph, Network, SwiftUI/Animation instruments по симптому.
