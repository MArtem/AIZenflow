...
id: OP-IOS-18-08
type: deep-playbook
source_skill: IOS-18-08
title: Data corruption — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-08 — Data corruption

## Mission
stop writes, preserve evidence, schema/migration validation, recovery path и user data safety

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-08_DATA_CORRUPTION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Data corruption».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-08 «Data corruption» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: stop writes, preserve evidence, schema/migration validation, recovery path и user data safety.
