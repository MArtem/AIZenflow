...
id: OP-IOS-05-01
type: deep-playbook
source_skill: IOS-05-01
title: Observation/@Observable — Operational Deep Playbook
section: 05_SWIFTUI
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-05-01 — Observation/@Observable

## Mission
выстроить современный data flow, корректное владение model/state и минимальную invalidation

Этот playbook — operational-версия `05_SWIFTUI/IOS-05-01_OBSERVATION.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Observation/@Observable».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-05-01 «Observation/@Observable» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: выстроить современный data flow, корректное владение model/state и минимальную invalidation.
