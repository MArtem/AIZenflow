...
id: OP-IOS-03-08
type: deep-playbook
source_skill: IOS-03-08
title: AsyncSequence streams — Operational Deep Playbook
section: 03_CONCURRENCY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-03-08 — AsyncSequence streams

## Mission
моделировать длительные события, cancellation, buffering, backpressure и termination

Этот playbook — operational-версия `03_CONCURRENCY/IOS-03-08_ASYNC_SEQUENCE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «AsyncSequence streams».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-03-08 «AsyncSequence streams» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: моделировать длительные события, cancellation, buffering, backpressure и termination.
