...
id: OP-IOS-21-10
type: deep-playbook
source_skill: IOS-21-10
title: Technical documentation workflow — Operational Deep Playbook
section: 21_AGENT_WORKFLOWS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-21-10 — Technical documentation workflow

## Mission
derive docs from code/contracts, state invariants/decisions/examples/failure modes and keep update triggers

Этот playbook — operational-версия `21_AGENT_WORKFLOWS/IOS-21-10_DOCS_WORKFLOW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Technical documentation workflow».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-21-10 «Technical documentation workflow» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: derive docs from code/contracts, state invariants/decisions/examples/failure modes and keep update triggers.
