...
id: OP-IOS-09-02
type: deep-playbook
source_skill: IOS-09-02
title: SwiftData concurrency — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-02 — SwiftData concurrency

## Mission
ModelActor/context isolation, IDs across actors, transactions и background work

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-02_SWIFTDATA_CONCURRENCY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «SwiftData concurrency».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-02 «SwiftData concurrency» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: ModelActor/context isolation, IDs across actors, transactions и background work.
