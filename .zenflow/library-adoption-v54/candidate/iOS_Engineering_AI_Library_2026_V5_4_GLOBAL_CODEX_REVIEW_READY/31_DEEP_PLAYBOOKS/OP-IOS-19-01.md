...
id: OP-IOS-19-01
type: deep-playbook
source_skill: IOS-19-01
title: General code review — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-01 — General code review

## Mission
correctness, architecture fit, concurrency, ownership, errors, tests, security, privacy, a11y, performance и diff hygiene

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-01_CODE_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «General code review».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-01 «General code review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: correctness, architecture fit, concurrency, ownership, errors, tests, security, privacy, a11y, performance и diff hygiene.
