...
id: OP-IOS-13-08
type: deep-playbook
source_skill: IOS-13-08
title: Accessibility/localization review — Operational Deep Playbook
section: 13_ACCESSIBILITY_LOCALIZATION
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-13-08 — Accessibility/localization review

## Mission
проверить VoiceOver, Dynamic Type, RTL, localization length, locale formatting и motion

Этот playbook — operational-версия `13_ACCESSIBILITY_LOCALIZATION/IOS-13-08_A11Y_L10N_REVIEW.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Accessibility/localization review».
...
- For **Accessibility/localization review**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-13-08 «Accessibility/localization review» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проверить VoiceOver, Dynamic Type, RTL, localization length, locale formatting и motion.
