...
id: OP-IOS-11-04
type: deep-playbook
source_skill: IOS-11-04
title: Image pipeline — Operational Deep Playbook
section: 11_PERFORMANCE_MEMORY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-11-04 — Image pipeline

## Mission
downsampling, decoding off-main, cache budgets, request deduplication, cancellation и memory pressure

Этот playbook — operational-версия `11_PERFORMANCE_MEMORY/IOS-11-04_IMAGE_PIPELINE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Image pipeline».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-11-04 «Image pipeline» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: downsampling, decoding off-main, cache budgets, request deduplication, cancellation и memory pressure.
