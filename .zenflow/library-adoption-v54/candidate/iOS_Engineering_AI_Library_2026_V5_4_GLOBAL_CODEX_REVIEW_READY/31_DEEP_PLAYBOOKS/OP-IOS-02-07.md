...
id: OP-IOS-02-07
type: deep-playbook
source_skill: IOS-02-07
title: Codable/serialization — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-07 — Codable/serialization

## Mission
устойчиво декодировать versioned JSON, dates, lossy fields, polymorphism и schema drift

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-07_CODABLE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Codable/serialization».
...
- For **Codable/serialization**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-07 «Codable/serialization» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: устойчиво декодировать versioned JSON, dates, lossy fields, polymorphism и schema drift.
