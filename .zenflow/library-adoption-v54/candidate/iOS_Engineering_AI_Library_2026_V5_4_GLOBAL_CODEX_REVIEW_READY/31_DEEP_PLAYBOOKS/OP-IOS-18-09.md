...
id: OP-IOS-18-09
type: deep-playbook
source_skill: IOS-18-09
title: Feature observability — Operational Deep Playbook
section: 18_OBSERVABILITY_DEBUGGING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-18-09 — Feature observability

## Mission
success/failure/latency/cancellation funnels, SLOs, dimensions without PII и alert thresholds

Этот playbook — operational-версия `18_OBSERVABILITY_DEBUGGING/IOS-18-09_PRODUCTION_METRICS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Feature observability».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-18-09 «Feature observability» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: success/failure/latency/cancellation funnels, SLOs, dimensions without PII и alert thresholds.
