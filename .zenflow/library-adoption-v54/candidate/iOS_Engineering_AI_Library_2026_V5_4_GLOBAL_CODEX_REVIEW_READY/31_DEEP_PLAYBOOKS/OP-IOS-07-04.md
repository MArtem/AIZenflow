...
id: OP-IOS-07-04
type: deep-playbook
source_skill: IOS-07-04
title: Universal Links — Operational Deep Playbook
section: 07_NAVIGATION_DEEPLINKS
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-07-04 — Universal Links

## Mission
проектировать associated domains flow, fallback, analytics и security considerations

Этот playbook — operational-версия `07_NAVIGATION_DEEPLINKS/IOS-07-04_UNIVERSAL_LINKS.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Universal Links».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-07-04 «Universal Links» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: проектировать associated domains flow, fallback, analytics и security considerations.
