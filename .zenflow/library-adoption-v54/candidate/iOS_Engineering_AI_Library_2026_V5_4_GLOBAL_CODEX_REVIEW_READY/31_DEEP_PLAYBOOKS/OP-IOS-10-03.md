...
id: OP-IOS-10-03
type: deep-playbook
source_skill: IOS-10-03
title: XCTest maintenance — Operational Deep Playbook
section: 10_TESTING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-10-03 — XCTest maintenance

## Mission
стабилизировать существующие XCTest suites и мигрировать постепенно

Этот playbook — operational-версия `10_TESTING/IOS-10-03_XCTEST_LEGACY.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «XCTest maintenance».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-10-03 «XCTest maintenance» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: стабилизировать существующие XCTest suites и мигрировать постепенно.
