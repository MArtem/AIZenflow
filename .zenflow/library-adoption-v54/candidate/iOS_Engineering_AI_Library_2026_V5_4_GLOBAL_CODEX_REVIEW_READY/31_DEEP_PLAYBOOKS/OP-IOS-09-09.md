...
id: OP-IOS-09-09
type: deep-playbook
source_skill: IOS-09-09
title: UserDefaults/config — Operational Deep Playbook
section: 09_PERSISTENCE_DATA
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-09-09 — UserDefaults/config

## Mission
только non-sensitive preferences, typed keys, migration, defaults и app-group boundaries

Этот playbook — operational-версия `09_PERSISTENCE_DATA/IOS-09-09_KEYVALUE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «UserDefaults/config».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-09-09 «UserDefaults/config» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: только non-sensitive preferences, typed keys, migration, defaults и app-group boundaries.
