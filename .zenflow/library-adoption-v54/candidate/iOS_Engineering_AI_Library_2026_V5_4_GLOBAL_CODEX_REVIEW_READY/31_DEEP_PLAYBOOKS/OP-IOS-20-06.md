...
id: OP-IOS-20-06
type: deep-playbook
source_skill: IOS-20-06
title: Remove legacy dependency — Operational Deep Playbook
section: 20_MIGRATION_LEGACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-20-06 — Remove legacy dependency

## Mission
найти API surface, replace incrementally, compare behavior/performance и clean transitive deps

Этот playbook — operational-версия `20_MIGRATION_LEGACY/IOS-20-06_DEPENDENCY_REMOVAL.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Remove legacy dependency».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-20-06 «Remove legacy dependency» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: найти API surface, replace incrementally, compare behavior/performance и clean transitive deps.
