...
id: OP-IOS-27-05
type: deep-playbook
source_skill: IOS-27-05
title: Incident postmortem — Operational Deep Playbook
section: 30_TEAM_ENGINEERING
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-27-05 — Incident postmortem

## Mission
blameless timeline/root cause/contributors/detection gaps/action items with owners and verification

Этот playbook — operational-версия `30_TEAM_ENGINEERING/IOS-27-05_INCIDENT_POSTMORTEM.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Incident postmortem».
...
- For **Incident postmortem**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-27-05 «Incident postmortem» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: blameless timeline/root cause/contributors/detection gaps/action items with owners and verification.
