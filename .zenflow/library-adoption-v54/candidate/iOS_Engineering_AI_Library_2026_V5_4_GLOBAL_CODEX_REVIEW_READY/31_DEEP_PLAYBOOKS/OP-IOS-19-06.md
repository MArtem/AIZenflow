...
id: OP-IOS-19-06
type: deep-playbook
source_skill: IOS-19-06
title: Dead code cleanup — Operational Deep Playbook
section: 19_CODE_REVIEW_REFACTOR
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-19-06 — Dead code cleanup

## Mission
доказать unreachable/unused paths, учесть reflection/selectors/deeplinks/feature flags и remove safely

Этот playbook — operational-версия `19_CODE_REVIEW_REFACTOR/IOS-19-06_DEAD_CODE.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «Dead code cleanup».
...
- For **Dead code cleanup**, derive at least one concrete repository/task failure scenario from the source skill, actual owners/callers/tests and acceptance criteria; record the invariant that would falsify the proposed change.
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-19-06 «Dead code cleanup» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: доказать unreachable/unused paths, учесть reflection/selectors/deeplinks/feature flags и remove safely.
