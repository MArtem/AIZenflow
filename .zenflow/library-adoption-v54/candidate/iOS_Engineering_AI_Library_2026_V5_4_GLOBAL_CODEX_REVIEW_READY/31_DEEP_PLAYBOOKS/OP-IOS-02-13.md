...
id: OP-IOS-02-13
type: deep-playbook
source_skill: IOS-02-13
title: C/Objective-C interoperability — Operational Deep Playbook
section: 02_SWIFT_LANGUAGE
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-02-13 — C/Objective-C interoperability

## Mission
безопасно проектировать bridging, nullability, ownership, generated interfaces и migration path

Этот playbook — operational-версия `02_SWIFT_LANGUAGE/IOS-02-13_C_INTEROP.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «C/Objective-C interoperability».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-02-13 «C/Objective-C interoperability» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: безопасно проектировать bridging, nullability, ownership, generated interfaces и migration path.
