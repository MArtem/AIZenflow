...
id: OP-IOS-12-05
type: deep-playbook
source_skill: IOS-12-05
title: CryptoKit usage — Operational Deep Playbook
section: 12_SECURITY_PRIVACY
baseline: project-aware / Swift 6 safety target / 2026
---

# OP-IOS-12-05 — CryptoKit usage

## Mission
использовать стандартные primitives/protocols, key management, nonce/randomness и avoid custom crypto

Этот playbook — operational-версия `12_SECURITY_PRIVACY/IOS-12-05_CRYPTOKIT.md`. Используй его, когда задача требует реального изменения/ревью/диагностики/миграции, а не только справочного ответа.
...
- Конкретные call sites/owners/tests, затронутые именно задачей «CryptoKit usage».
...
```text
Работай как Staff/Principal iOS engineer. Применяй OP-IOS-12-05 «CryptoKit usage» и V2_EXECUTION_PROTOCOL.
...
Основной фокус: использовать стандартные primitives/protocols, key management, nonce/randomness и avoid custom crypto.
