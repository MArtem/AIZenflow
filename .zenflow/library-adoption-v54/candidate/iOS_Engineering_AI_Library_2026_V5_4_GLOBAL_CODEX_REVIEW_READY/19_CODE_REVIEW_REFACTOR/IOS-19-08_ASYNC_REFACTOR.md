...
id: IOS-19-08
type: skill
title: Callback/Combine→async refactor
domain: Code Review & Refactoring
priority: production
baseline: Swift 6 / modern iOS
---

# Callback/Combine→async refactor
...
2. Зафиксируй инварианты и failure modes именно для задачи: **сохранить cancellation/backpressure/threading semantics и incremental interoperability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-08: «Callback/Combine→async refactor».
...
Особый фокус: сохранить cancellation/backpressure/threading semantics и incremental interoperability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
