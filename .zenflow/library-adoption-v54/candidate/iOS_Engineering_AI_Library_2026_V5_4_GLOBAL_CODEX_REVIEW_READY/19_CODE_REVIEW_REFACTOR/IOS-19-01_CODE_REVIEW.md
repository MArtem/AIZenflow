...
2. Зафиксируй инварианты и failure modes именно для задачи: **correctness, architecture fit, concurrency, ownership, errors, tests, security, privacy, a11y, performance и diff hygiene**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-01: «General code review».
...
Особый фокус: correctness, architecture fit, concurrency, ownership, errors, tests, security, privacy, a11y, performance и diff hygiene.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
