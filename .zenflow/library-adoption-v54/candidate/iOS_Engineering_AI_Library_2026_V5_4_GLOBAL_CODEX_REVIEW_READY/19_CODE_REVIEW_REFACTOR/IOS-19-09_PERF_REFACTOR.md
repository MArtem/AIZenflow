...
2. Зафиксируй инварианты и failure modes именно для задачи: **изменять только измеренный bottleneck, добавляя regression metric/test**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-09: «Performance refactor».
...
Особый фокус: изменять только измеренный bottleneck, добавляя regression metric/test.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
