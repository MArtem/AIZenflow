...
2. Зафиксируй инварианты и failure modes именно для задачи: **ранжировать findings по severity/likelihood/blast radius и отличать blocker от style preference**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-02: «Risk-based PR review».
...
Особый фокус: ранжировать findings по severity/likelihood/blast radius и отличать blocker от style preference.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
