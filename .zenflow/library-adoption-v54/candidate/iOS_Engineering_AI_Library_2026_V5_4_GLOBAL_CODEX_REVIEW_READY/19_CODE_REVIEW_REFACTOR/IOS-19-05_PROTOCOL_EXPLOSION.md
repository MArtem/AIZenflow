...
2. Зафиксируй инварианты и failure modes именно для задачи: **удалять meaningless abstractions, сохраняя real seams и testability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-05: «Protocol simplification».
...
Особый фокус: удалять meaningless abstractions, сохраняя real seams и testability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
