...
2. Зафиксируй инварианты и failure modes именно для задачи: **зафиксировать behavior tests, сделать incremental changes, сохранить public contract и measure regression**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-03: «Safe refactor».
...
Особый фокус: зафиксировать behavior tests, сделать incremental changes, сохранить public contract и measure regression.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
