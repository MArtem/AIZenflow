...
2. Зафиксируй инварианты и failure modes именно для задачи: **behavior parity, API compatibility, test adequacy, migration, performance и readability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-10: «Refactor review».
...
Особый фокус: behavior parity, API compatibility, test adequacy, migration, performance и readability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
