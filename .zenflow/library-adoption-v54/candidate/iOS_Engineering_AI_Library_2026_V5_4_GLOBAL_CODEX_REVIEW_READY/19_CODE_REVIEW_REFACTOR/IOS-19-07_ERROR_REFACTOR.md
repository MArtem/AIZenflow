...
2. Зафиксируй инварианты и failure modes именно для задачи: **убрать swallowed errors, normalize mapping, recoverability, logging и user messaging**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-07: «Error handling refactor».
...
Особый фокус: убрать swallowed errors, normalize mapping, recoverability, logging и user messaging.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
