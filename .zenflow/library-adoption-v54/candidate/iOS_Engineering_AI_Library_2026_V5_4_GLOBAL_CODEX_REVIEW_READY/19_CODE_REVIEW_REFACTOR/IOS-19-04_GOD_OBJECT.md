...
2. Зафиксируй инварианты и failure modes именно для задачи: **разделять по responsibilities/state ownership/dependencies без искусственных layers**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-04: «God object split».
...
Особый фокус: разделять по responsibilities/state ownership/dependencies без искусственных layers.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
