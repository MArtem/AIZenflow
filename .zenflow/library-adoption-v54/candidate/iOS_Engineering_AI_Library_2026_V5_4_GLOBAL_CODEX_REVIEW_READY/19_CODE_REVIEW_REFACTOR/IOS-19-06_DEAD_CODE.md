...
2. Зафиксируй инварианты и failure modes именно для задачи: **доказать unreachable/unused paths, учесть reflection/selectors/deeplinks/feature flags и remove safely**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-19-06: «Dead code cleanup».
...
Особый фокус: доказать unreachable/unused paths, учесть reflection/selectors/deeplinks/feature flags и remove safely.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-19-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
