...
id: IOS-25-10
type: skill
title: Third-party ecosystem review
domain: Ecosystem & Interop
priority: production
baseline: Swift 6 / modern iOS
---

# Third-party ecosystem review

## Назначение
Necessity, maintenance, security/privacy, concurrency readiness, build/binary cost and exit strategy.
...
5. Проверь: maintenance, privacy, license, supply chain, Swift 6, removal cost.
...
## Готовый prompt
```text
Примени skill IOS-25-10: «Third-party ecosystem review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: necessity, maintenance, security/privacy, concurrency readiness, build/binary cost and exit strategy.
Проверь: maintenance, privacy, license, supply chain, Swift 6, removal cost.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
