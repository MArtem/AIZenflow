...
id: IOS-25-04
type: skill
title: Networking library evaluation
domain: Ecosystem & Interop
priority: production
baseline: Swift 6 / modern iOS
---

# Networking library evaluation
...
5. Проверь: necessity, concurrency readiness, retry semantics, metrics, binary/build cost, privacy.
...
## Готовый prompt
```text
Примени skill IOS-25-04: «Networking library evaluation» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: сравнить с URLSession по middleware/auth/retry/metrics/testability/privacy/dependency cost.
Проверь: necessity, concurrency readiness, retry semantics, metrics, binary/build cost, privacy.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
