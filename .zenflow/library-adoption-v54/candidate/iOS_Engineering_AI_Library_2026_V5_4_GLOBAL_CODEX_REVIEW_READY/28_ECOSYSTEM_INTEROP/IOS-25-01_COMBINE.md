...
5. Проверь: subscription lifetime, scheduler, demand, error type, bridge semantics, tests.
...
## Готовый prompt
```text
Примени skill IOS-25-01: «Combine pipelines» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: ownership/cancellation/backpressure/scheduler semantics, bridge to async carefully and avoid duplicate state.
Проверь: subscription lifetime, scheduler, demand, error type, bridge semantics, tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
