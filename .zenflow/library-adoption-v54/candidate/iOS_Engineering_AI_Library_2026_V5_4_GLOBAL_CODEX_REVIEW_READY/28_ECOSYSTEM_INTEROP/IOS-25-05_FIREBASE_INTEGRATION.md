...
id: IOS-25-05
type: skill
title: Firebase-style SDK integration
domain: Ecosystem & Interop
priority: production
baseline: Swift 6 / modern iOS
---

# Firebase-style SDK integration

## Назначение
Изолировать analytics/crash/remote-config/messaging SDK, consent/privacy, initialization and vendor lock-in.
...
5. Проверь: startup cost, privacy consent, identifiers, offline, SDK updates, removal seam.
...
## Готовый prompt
```text
Примени skill IOS-25-05: «Firebase-style SDK integration» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: изолировать analytics/crash/remote-config/messaging SDK, consent/privacy, initialization and vendor lock-in.
Проверь: startup cost, privacy consent, identifiers, offline, SDK updates, removal seam.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
