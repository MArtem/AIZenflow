...
id: IOS-25-03
type: skill
title: Composable Architecture evaluation
...
## Назначение
Оценить reducer/effect/state discipline против complexity/team fit, not adopt by fashion.
...
5. Проверь: state size, effect cancellation, dependency scope, test ergonomics, migration cost, team fit.
...
## Готовый prompt
```text
Примени skill IOS-25-03: «Composable Architecture evaluation» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: оценить reducer/effect/state discipline против complexity/team fit, not adopt by fashion.
Проверь: state size, effect cancellation, dependency scope, test ergonomics, migration cost, team fit.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
