...
5. Проверь: PII, symbol files, breadcrumbs, startup, offline upload, retention.
...
## Готовый prompt
```text
Примени skill IOS-25-08: «Crash reporting SDK» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: symbolication, user identifiers policy, breadcrumbs redaction, release/version mapping and startup cost.
Проверь: PII, symbol files, breadcrumbs, startup, offline upload, retention.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
