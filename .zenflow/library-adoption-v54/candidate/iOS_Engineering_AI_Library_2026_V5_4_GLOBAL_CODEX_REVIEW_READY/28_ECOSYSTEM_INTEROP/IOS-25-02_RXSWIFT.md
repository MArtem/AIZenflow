...
id: IOS-25-02
type: skill
title: RxSwift maintenance/migration
domain: Ecosystem & Interop
priority: production
baseline: Swift 6 / modern iOS
---

# RxSwift maintenance/migration
...
5. Проверь: dispose lifetime, scheduler, backpressure assumptions, async bridge, test scheduler, migration.
...
## Готовый prompt
```text
Примени skill IOS-25-02: «RxSwift maintenance/migration» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: preserve scheduler/disposal/error semantics, reduce new Rx surface and migrate incrementally where valuable.
Проверь: dispose lifetime, scheduler, backpressure assumptions, async bridge, test scheduler, migration.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
