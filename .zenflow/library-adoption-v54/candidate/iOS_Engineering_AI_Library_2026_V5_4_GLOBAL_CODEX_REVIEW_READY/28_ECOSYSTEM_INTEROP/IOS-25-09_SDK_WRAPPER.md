...
5. Проверь: public surface, lifecycle, privacy, test seam, vendor lock-in, error mapping.
...
## Готовый prompt
```text
Примени skill IOS-25-09: «Third-party SDK wrapper» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: создать узкую anti-corruption boundary, lifecycle/consent/configuration and replacement seam.
Проверь: public surface, lifecycle, privacy, test seam, vendor lock-in, error mapping.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-25-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
