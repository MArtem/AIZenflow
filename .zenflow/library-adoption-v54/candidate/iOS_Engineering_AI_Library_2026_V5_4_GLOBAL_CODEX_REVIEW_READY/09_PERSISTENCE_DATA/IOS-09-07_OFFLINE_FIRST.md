...
2. Зафиксируй инварианты и failure modes именно для задачи: **operation log/sync state/conflicts/retries/idempotency и user-visible consistency**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-07: «Offline-first data».
...
Особый фокус: operation log/sync state/conflicts/retries/idempotency и user-visible consistency.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
