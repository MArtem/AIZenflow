...
2. Зафиксируй инварианты и failure modes именно для задачи: **entities/relationships/faulting/fetches, constraints, contexts и migration-aware design**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-03: «Core Data modeling».
...
Особый фокус: entities/relationships/faulting/fetches, constraints, contexts и migration-aware design.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
