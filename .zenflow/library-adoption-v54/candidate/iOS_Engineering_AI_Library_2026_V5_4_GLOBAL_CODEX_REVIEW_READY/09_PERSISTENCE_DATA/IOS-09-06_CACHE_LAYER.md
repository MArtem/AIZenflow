...
2. Зафиксируй инварианты и failure modes именно для задачи: **TTL/ETag/versioning, stale-while-revalidate, eviction, disk budget и source-of-truth semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-06: «Local cache».
...
Особый фокус: TTL/ETag/versioning, stale-while-revalidate, eviction, disk budget и source-of-truth semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
