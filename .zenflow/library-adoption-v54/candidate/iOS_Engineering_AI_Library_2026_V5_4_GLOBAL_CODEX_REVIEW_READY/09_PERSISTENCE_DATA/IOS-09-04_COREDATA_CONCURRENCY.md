...
2. Зафиксируй инварианты и failure modes именно для задачи: **context confinement, object IDs, background transactions и merge policies**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-04: «Core Data concurrency».
...
Особый фокус: context confinement, object IDs, background transactions и merge policies.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
