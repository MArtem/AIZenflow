...
2. Зафиксируй инварианты и failure modes именно для задачи: **только non-sensitive preferences, typed keys, migration, defaults и app-group boundaries**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-09: «UserDefaults/config».
...
Особый фокус: только non-sensitive preferences, typed keys, migration, defaults и app-group boundaries.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
