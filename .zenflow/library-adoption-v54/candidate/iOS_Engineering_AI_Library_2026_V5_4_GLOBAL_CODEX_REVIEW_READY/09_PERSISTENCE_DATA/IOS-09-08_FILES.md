...
2. Зафиксируй инварианты и failure modes именно для задачи: **atomic writes, coordination, temp/cache/documents directories, protection classes и disk pressure**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-08: «File storage».
...
Особый фокус: atomic writes, coordination, temp/cache/documents directories, protection classes и disk pressure.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
