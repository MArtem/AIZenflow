...
2. Зафиксируй инварианты и failure modes именно для задачи: **ModelActor/context isolation, IDs across actors, transactions и background work**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-02: «SwiftData concurrency».
...
Особый фокус: ModelActor/context isolation, IDs across actors, transactions и background work.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
