...
2. Зафиксируй инварианты и failure modes именно для задачи: **integrity, migrations, concurrency, fetch performance, data loss, privacy и backup semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-10: «Persistence review».
...
Особый фокус: integrity, migrations, concurrency, fetch performance, data loss, privacy и backup semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
