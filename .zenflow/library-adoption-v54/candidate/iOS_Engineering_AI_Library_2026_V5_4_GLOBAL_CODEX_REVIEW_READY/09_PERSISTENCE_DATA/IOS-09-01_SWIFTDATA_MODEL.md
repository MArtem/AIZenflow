...
2. Зафиксируй инварианты и failure modes именно для задачи: **@Model relationships, uniqueness, indexing strategy, fetch shape, migrations и availability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-09-01: «SwiftData modeling».
...
Особый фокус: @Model relationships, uniqueness, indexing strategy, fetch shape, migrations и availability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-09-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
