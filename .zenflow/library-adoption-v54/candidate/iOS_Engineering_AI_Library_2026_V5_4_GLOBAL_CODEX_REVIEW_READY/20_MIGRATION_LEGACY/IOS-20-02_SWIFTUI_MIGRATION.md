...
2. Зафиксируй инварианты и failure modes именно для задачи: **выбирать feature seams, shared model boundaries, hosting, testing и rollback**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-02: «UIKit→SwiftUI migration».
...
Особый фокус: выбирать feature seams, shared model boundaries, hosting, testing и rollback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
