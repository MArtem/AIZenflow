...
2. Зафиксируй инварианты и failure modes именно для задачи: **inventory availability shims, usage analytics, CI/device matrix, code deletion и release communication**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-07: «Minimum iOS bump».
...
Особый фокус: inventory availability shims, usage analytics, CI/device matrix, code deletion и release communication.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
