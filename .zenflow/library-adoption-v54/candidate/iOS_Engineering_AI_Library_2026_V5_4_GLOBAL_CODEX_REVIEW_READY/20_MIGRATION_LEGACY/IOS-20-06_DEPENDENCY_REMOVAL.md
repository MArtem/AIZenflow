...
id: IOS-20-06
type: skill
title: Remove legacy dependency
...
2. Зафиксируй инварианты и failure modes именно для задачи: **найти API surface, replace incrementally, compare behavior/performance и clean transitive deps**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-06: «Remove legacy dependency».
...
Особый фокус: найти API surface, replace incrementally, compare behavior/performance и clean transitive deps.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
