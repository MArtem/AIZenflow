...
id: IOS-20-04
type: skill
title: Core Data→SwiftData assessment
domain: Migration & Legacy
priority: production
baseline: Swift 6 / modern iOS
---

# Core Data→SwiftData assessment
...
2. Зафиксируй инварианты и failure modes именно для задачи: **сначала доказать бизнес-ценность, migration feasibility, store compatibility и feature parity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-04: «Core Data→SwiftData assessment».
...
Особый фокус: сначала доказать бизнес-ценность, migration feasibility, store compatibility и feature parity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
