...
id: IOS-20-05
type: skill
title: Callbacks/Combine networking→async
domain: Migration & Legacy
priority: production
baseline: Swift 6 / modern iOS
---

# Callbacks/Combine networking→async
...
2. Зафиксируй инварианты и failure modes именно для задачи: **сохранить cancellation/retry/auth semantics и migrate layer by layer**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-05: «Callbacks/Combine networking→async».
...
Особый фокус: сохранить cancellation/retry/auth semantics и migrate layer by layer.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
