...
id: IOS-20-01
type: skill
title: Swift 6 migration program
domain: Migration & Legacy
priority: production
baseline: Swift 6 / modern iOS
---

# Swift 6 migration program
...
2. Зафиксируй инварианты и failure modes именно для задачи: **по-модульно включать strict concurrency, классифицировать diagnostics и избегать unchecked escape hatches**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-01: «Swift 6 migration program».
...
Особый фокус: по-модульно включать strict concurrency, классифицировать diagnostics и избегать unchecked escape hatches.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
