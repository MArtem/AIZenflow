...
id: IOS-20-03
type: skill
title: ObservableObject→Observation
...
2. Зафиксируй инварианты и failure modes именно для задачи: **сохранить ownership/update semantics и измерить invalidation/performance**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-20-03: «ObservableObject→Observation».
...
Особый фокус: сохранить ownership/update semantics и измерить invalidation/performance.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-20-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
