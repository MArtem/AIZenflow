...
id: IOS-21-05
type: skill
title: Concurrency remediation workflow
domain: AI Coding Agent Workflows
priority: production
baseline: Swift 6 / modern iOS
---

# Concurrency remediation workflow
...
2. Зафиксируй инварианты и failure modes именно для задачи: **diagnostics inventory → classify isolation/Sendable/lifetime → fix roots → stress tests**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-21-05: «Concurrency remediation workflow».
...
Особый фокус: diagnostics inventory → classify isolation/Sendable/lifetime → fix roots → stress tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-21-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
