...
2. Зафиксируй инварианты и failure modes именно для задачи: **stabilize → evidence → scope → minimal mitigation → verification → permanent fix/postmortem**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-21-09: «Production incident workflow».
...
Особый фокус: stabilize → evidence → scope → minimal mitigation → verification → permanent fix/postmortem.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-21-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
