...
2. Зафиксируй инварианты и failure modes именно для задачи: **зафиксировать контекст, decision, alternatives, consequences, rollback/migration и критерии пересмотра**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-01-06: «Architecture Decision Record».
...
Особый фокус: зафиксировать контекст, decision, alternatives, consequences, rollback/migration и критерии пересмотра.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-01-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
