...
id: IOS-01-01
type: skill
title: Декомпозиция feature из product требований
domain: Discovery & Product
priority: production
baseline: Swift 6 / modern iOS
---

# Декомпозиция feature из product требований
...
2. Зафиксируй инварианты и failure modes именно для задачи: **выявить user journeys, acceptance criteria, non-goals, edge cases, analytics, permissions, offline/error states и технические ограничения**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-01-01: «Декомпозиция feature из product требований».
...
Особый фокус: выявить user journeys, acceptance criteria, non-goals, edge cases, analytics, permissions, offline/error states и технические ограничения.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-01-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
