...
id: IOS-01-02
type: skill
title: Технический spike перед реализацией
...
2. Зафиксируй инварианты и failure modes именно для задачи: **сравнить 2–4 варианта по API availability, complexity, migration cost, performance, testability, security/privacy и risk**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-01-02: «Технический spike перед реализацией».
...
Особый фокус: сравнить 2–4 варианта по API availability, complexity, migration cost, performance, testability, security/privacy и risk.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-01-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
