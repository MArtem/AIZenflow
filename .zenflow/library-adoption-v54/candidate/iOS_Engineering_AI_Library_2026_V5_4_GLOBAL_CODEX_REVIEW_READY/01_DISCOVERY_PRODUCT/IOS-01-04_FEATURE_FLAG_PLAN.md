...
id: IOS-01-04
type: skill
title: Feature flags и staged rollout
...
2. Зафиксируй инварианты и failure modes именно для задачи: **спроектировать flag ownership, default states, kill switch, analytics, cleanup date, remote/local failure semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-01-04: «Feature flags и staged rollout».
...
Особый фокус: спроектировать flag ownership, default states, kill switch, analytics, cleanup date, remote/local failure semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-01-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
