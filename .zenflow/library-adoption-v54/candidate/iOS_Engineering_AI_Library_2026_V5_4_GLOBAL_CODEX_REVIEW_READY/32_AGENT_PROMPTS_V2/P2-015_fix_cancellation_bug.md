...
id: P2-015
type: prompt-v2
title: Fix cancellation bug
mode: DIAGNOSTIC
skills: IOS-03-07, IOS-05-05, IOS-08-01
---

# P2-015 — Fix cancellation bug
...
Задача: Протяни cooperative cancellation через UI→network→parsing→state и не показывай cancellation как обычную ошибку.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-03-07, OP-IOS-05-05, OP-IOS-08-01.
