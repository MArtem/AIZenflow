...
id: P2-076
type: prompt-v2
title: Implement background task
mode: IMPLEMENTATION
skills: IOS-14-05, IOS-24-05, IOS-03-07
---

# P2-076 — Implement background task
...
Задача: Проектируй idempotent resumable work под system scheduling, expiration/cancellation and process death.
...
и playbooks: OP-IOS-14-05, OP-IOS-24-05, OP-IOS-03-07.
