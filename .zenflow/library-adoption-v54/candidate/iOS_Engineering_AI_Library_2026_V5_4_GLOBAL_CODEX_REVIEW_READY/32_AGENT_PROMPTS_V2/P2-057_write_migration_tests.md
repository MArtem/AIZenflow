...
mode: IMPLEMENTATION
skills: IOS-10-07, IOS-09-05, IOS-20-04
---

# P2-057 — Write migration tests
...
Задача: Используй fixtures предыдущих store/schema версий и проверяй semantic data invariants после migration.
...
и playbooks: OP-IOS-10-07, OP-IOS-09-05, OP-IOS-20-04.
