...
id: P2-029
type: prompt-v2
title: Fix stale async UI
mode: DIAGNOSTIC
skills: IOS-05-05, IOS-03-07, IOS-03-06
---

# P2-029 — Fix stale async UI
...
Задача: Предотврати stale result overwrite через task ownership, cancellation/request identity и explicit UI state.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-05-05, OP-IOS-03-07, OP-IOS-03-06.
