...
id: P2-023
type: prompt-v2
title: Evaluate UDF/TCA style
mode: REVIEW
skills: IOS-04-04, IOS-25-03, IOS-04-12
---

# P2-023 — Evaluate UDF/TCA style

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-04-04.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-25-03.md`
...
Задача: Сравни reducer/effect/UDF с текущей сложностью feature/team fit, не принимая архитектуру по моде.
Режим: REVIEW.
...
и playbooks: OP-IOS-04-04, OP-IOS-25-03, OP-IOS-04-12.
