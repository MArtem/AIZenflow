...
mode: DIAGNOSTIC
skills: IOS-18-07, IOS-08-10, IOS-18-01
---

# P2-046 — Network incident

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-18-07.md`
...
Задача: Раздели DNS/connect/TLS/server/auth/cache/decoding причины по metrics/request IDs без утечки payload.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-18-07, OP-IOS-08-10, OP-IOS-18-01.
