...
mode: REVIEW
skills: IOS-12-03, IOS-08-02, IOS-07-05
---

# P2-067 — Audit authentication

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-12-03.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-08-02.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-07-05.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Раздели authentication/authorization, token lifecycle, deep-link gates and logout race.
Режим: REVIEW.
...
и playbooks: OP-IOS-12-03, OP-IOS-08-02, OP-IOS-07-05.
