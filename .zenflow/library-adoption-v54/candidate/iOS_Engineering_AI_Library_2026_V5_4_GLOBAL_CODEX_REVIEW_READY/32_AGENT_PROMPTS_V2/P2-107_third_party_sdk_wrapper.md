...
mode: IMPLEMENTATION
skills: IOS-25-09, IOS-25-10, IOS-12-11
---

# P2-107 — Third-party SDK wrapper

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-25-09.md`
...
Задача: Изолируй vendor API в anti-corruption boundary с consent/lifecycle/config/error mapping and exit seam.
...
и playbooks: OP-IOS-25-09, OP-IOS-25-10, OP-IOS-12-11.
