...
id: P2-004
type: prompt-v2
title: Design typed state machine
mode: IMPLEMENTATION
skills: IOS-02-05, IOS-04-02, IOS-10-02
---

# P2-004 — Design typed state machine
...
Задача: Закодируй допустимые состояния и переходы в типах и тестах, исключая impossible states и boolean explosion.
...
и playbooks: OP-IOS-02-05, OP-IOS-04-02, OP-IOS-10-02.
