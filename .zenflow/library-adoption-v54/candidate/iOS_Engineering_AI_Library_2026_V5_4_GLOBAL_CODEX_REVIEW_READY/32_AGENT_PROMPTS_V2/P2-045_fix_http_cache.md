...
id: P2-045
type: prompt-v2
title: Fix HTTP cache
mode: DIAGNOSTIC
skills: IOS-08-07, IOS-08-08, IOS-11-09
---

# P2-045 — Fix HTTP cache

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-08-07.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-08-08.md`
...
Задача: Проверь validators/cache keys/invalidation/offline semantics вместо ручного TTL по умолчанию.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-08-07, OP-IOS-08-08, OP-IOS-11-09.
