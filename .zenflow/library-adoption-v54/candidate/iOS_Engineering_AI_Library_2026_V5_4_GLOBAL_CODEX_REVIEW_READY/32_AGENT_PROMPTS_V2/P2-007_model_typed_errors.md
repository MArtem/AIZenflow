...
id: P2-007
type: prompt-v2
title: Model typed errors
mode: IMPLEMENTATION
skills: IOS-02-06, IOS-19-07, IOS-08-01
---

# P2-007 — Model typed errors

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-02-06.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-19-07.md`
...
Задача: Раздели transport/domain/user-facing errors, recoverability, logging и retry semantics без swallowed errors.
...
и playbooks: OP-IOS-02-06, OP-IOS-19-07, OP-IOS-08-01.
