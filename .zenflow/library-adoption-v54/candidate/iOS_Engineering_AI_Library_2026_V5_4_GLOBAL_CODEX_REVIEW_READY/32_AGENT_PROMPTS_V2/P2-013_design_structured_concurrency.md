...
id: P2-013
type: prompt-v2
title: Design structured concurrency
mode: IMPLEMENTATION
skills: IOS-03-05, IOS-03-07, IOS-03-11
---

# P2-013 — Design structured concurrency

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-03-05.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-03-07.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-03-11.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Организуй parallel work через async let/task groups с bounded fan-out, error propagation и cancellation.
...
и playbooks: OP-IOS-03-05, OP-IOS-03-07, OP-IOS-03-11.
