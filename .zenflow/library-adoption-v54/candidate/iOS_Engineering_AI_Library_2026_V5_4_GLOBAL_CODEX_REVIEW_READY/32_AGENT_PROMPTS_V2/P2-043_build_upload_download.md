...
id: P2-043
type: prompt-v2
title: Build upload/download
mode: IMPLEMENTATION
skills: IOS-08-05, IOS-24-05, IOS-11-09
---

# P2-043 — Build upload/download

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-08-05.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-24-05.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-11-09.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Спроектируй progress, background/resume, temp-file lifecycle, integrity, cancellation и disk pressure.
...
и playbooks: OP-IOS-08-05, OP-IOS-24-05, OP-IOS-11-09.
