...
id: P2-030
type: prompt-v2
title: Optimize SwiftUI list
mode: DIAGNOSTIC
skills: IOS-05-06, IOS-11-03, IOS-11-04
---

# P2-030 — Optimize SwiftUI list
...
Задача: Измерь hitching/invalidation/image pipeline, затем оптимизируй stable identity, body work и async loading.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-05-06, OP-IOS-11-03, OP-IOS-11-04.
