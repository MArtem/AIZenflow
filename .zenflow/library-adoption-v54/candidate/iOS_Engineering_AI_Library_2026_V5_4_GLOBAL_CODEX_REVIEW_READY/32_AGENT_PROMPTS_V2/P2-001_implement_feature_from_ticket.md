...
id: P2-001
type: prompt-v2
title: Implement feature from ticket
mode: IMPLEMENTATION
skills: IOS-21-01, IOS-01-01, IOS-10-01
---

# P2-001 — Implement feature from ticket

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-21-01.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-01-01.md`
...
Задача: Преврати ticket в проверяемую production feature, сначала исследовав существующий код, state/effect boundaries и acceptance criteria.
...
и playbooks: OP-IOS-21-01, OP-IOS-01-01, OP-IOS-10-01.
