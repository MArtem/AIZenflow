...
id: P2-081
type: prompt-v2
title: AI eval regression
mode: REVIEW
skills: IOS-15-03, IOS-15-04, IOS-15-10
---

# P2-081 — AI eval regression

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-15-03.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-15-04.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-15-10.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Построй representative eval set, metrics/thresholds and regression across OS/model/profile changes.
Режим: REVIEW.
...
и playbooks: OP-IOS-15-03, OP-IOS-15-04, OP-IOS-15-10.
