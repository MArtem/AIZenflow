...
mode: MIGRATION
skills: IOS-19-06, IOS-07-03, IOS-17-09
---

# P2-095 — Remove dead code

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-19-06.md`
...
Задача: Докажи отсутствие dynamic/reflection/deeplink/flag usage перед удалением и проверь all targets.
Режим: MIGRATION.
...
и playbooks: OP-IOS-19-06, OP-IOS-07-03, OP-IOS-17-09.
