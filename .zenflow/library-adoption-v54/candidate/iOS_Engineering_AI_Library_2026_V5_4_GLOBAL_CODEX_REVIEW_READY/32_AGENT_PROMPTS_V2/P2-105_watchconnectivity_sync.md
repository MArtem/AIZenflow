...
id: P2-105
type: prompt-v2
title: WatchConnectivity sync
mode: IMPLEMENTATION
skills: IOS-24-07, IOS-02-05, IOS-09-07
---

# P2-105 — WatchConnectivity sync

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-24-07.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-02-05.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-09-07.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Раздели reachable-message и queued transfers, dedupe/order/version skew/app-state recovery.
...
и playbooks: OP-IOS-24-07, OP-IOS-02-05, OP-IOS-09-07.
