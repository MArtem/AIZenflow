...
id: P2-022
type: prompt-v2
title: Fix god ViewModel
mode: MIGRATION
skills: IOS-04-03, IOS-19-04, IOS-04-02
---

# P2-022 — Fix god ViewModel

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-04-03.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-19-04.md`
...
Задача: Раздели responsibilities по state/effects/dependencies/lifetimes с behavior characterization перед refactor.
Режим: MIGRATION.
...
и playbooks: OP-IOS-04-03, OP-IOS-19-04, OP-IOS-04-02.
