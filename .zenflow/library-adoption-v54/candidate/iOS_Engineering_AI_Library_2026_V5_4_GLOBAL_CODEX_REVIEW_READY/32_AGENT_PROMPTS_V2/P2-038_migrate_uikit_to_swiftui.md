...
id: P2-038
type: prompt-v2
title: Migrate UIKit to SwiftUI
mode: MIGRATION
skills: IOS-20-02, IOS-06-09, IOS-05-12
---

# P2-038 — Migrate UIKit to SwiftUI

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-20-02.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-06-09.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-05-12.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Выбери stable seams и мигрируй vertical slices без big-bang rewrite, дублирования state и потери rollback.
Режим: MIGRATION.
...
и playbooks: OP-IOS-20-02, OP-IOS-06-09, OP-IOS-05-12.
