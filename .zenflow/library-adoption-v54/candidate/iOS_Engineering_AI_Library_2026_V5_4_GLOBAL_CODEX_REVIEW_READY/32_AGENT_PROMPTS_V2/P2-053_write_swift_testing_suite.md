...
id: P2-053
type: prompt-v2
title: Write Swift Testing suite
mode: IMPLEMENTATION
skills: IOS-10-02, IOS-10-05, IOS-10-12
---

# P2-053 — Write Swift Testing suite
...
Задача: Используй parameterization/tags/traits и deterministic clocks/random/network/storage для новых tests.
...
и playbooks: OP-IOS-10-02, OP-IOS-10-05, OP-IOS-10-12.
