...
id: P2-027
type: prompt-v2
title: Fix SwiftUI identity bug
mode: DIAGNOSTIC
skills: IOS-05-03, IOS-05-06, IOS-18-05
---

# P2-027 — Fix SwiftUI identity bug

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-05-03.md`
...
Задача: Найди нестабильные IDs/conditional tree/state reset и исправь semantic identity без `.id()` hacks.
Режим: DIAGNOSTIC.
...
и playbooks: OP-IOS-05-03, OP-IOS-05-06, OP-IOS-18-05.
