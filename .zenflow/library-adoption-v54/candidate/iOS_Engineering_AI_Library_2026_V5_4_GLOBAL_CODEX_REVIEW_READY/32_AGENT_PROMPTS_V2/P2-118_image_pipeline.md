...
mode: IMPLEMENTATION
skills: IOS-11-04, IOS-22-06, IOS-08-07
---

# P2-118 — Image pipeline

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-11-04.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-22-06.md`
...
Задача: Спроектируй request/cache/decode/downsample/cancellation/memory-cost pipeline and measure scrolling impact.
...
и playbooks: OP-IOS-11-04, OP-IOS-22-06, OP-IOS-08-07.
