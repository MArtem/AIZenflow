...
id: P2-119
type: prompt-v2
title: Review unsafe/C interop
mode: REVIEW
skills: IOS-02-12, IOS-02-13, IOS-10-09
---

# P2-119 — Review unsafe/C interop

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-02-12.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-02-13.md`
- `31_DEEP_PLAYBOOKS/OP-IOS-10-09.md`

## Copy-paste prompt
```text
Ты работаешь как Staff/Principal iOS engineer и coding agent.

Задача: Докажи pointer lifetime/alignment/bounds/ownership/nullability and add boundary/fuzz/property tests.
Режим: REVIEW.
...
и playbooks: OP-IOS-02-12, OP-IOS-02-13, OP-IOS-10-09.
