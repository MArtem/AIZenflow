...
id: P2-098
type: prompt-v2
title: AVFoundation capture
mode: IMPLEMENTATION
skills: IOS-22-01, IOS-22-12, IOS-12-07
---

# P2-098 — AVFoundation capture

## Skill chain
- `31_DEEP_PLAYBOOKS/OP-IOS-22-01.md`
...
Задача: Спроектируй capture session state machine, permission, interruption/orientation/device switching, buffer lifecycle.
...
и playbooks: OP-IOS-22-01, OP-IOS-22-12, OP-IOS-12-07.
