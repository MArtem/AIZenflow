...
## Назначение
Entity/component ownership, asset loading, async resources, collision/physics и performance.
...
5. Проверь: entity lifetime, async assets, physics step, GPU/memory, device availability.
...
## Готовый prompt
```text
Примени skill IOS-23-06: «RealityKit» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: entity/component ownership, asset loading, async resources, collision/physics и performance.
Проверь: entity lifetime, async assets, physics step, GPU/memory, device availability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
