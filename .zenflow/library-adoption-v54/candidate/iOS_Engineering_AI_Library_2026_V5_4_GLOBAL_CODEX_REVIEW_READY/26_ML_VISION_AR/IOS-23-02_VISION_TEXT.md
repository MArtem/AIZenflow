...
5. Проверь: languages, confidence, orientation, batching, memory, sensitive text.
...
## Готовый prompt
```text
Примени skill IOS-23-02: «OCR/text recognition» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: настроить recognition level/languages/ROI, preprocess, confidence, pagination и privacy.
Проверь: languages, confidence, orientation, batching, memory, sensitive text.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
