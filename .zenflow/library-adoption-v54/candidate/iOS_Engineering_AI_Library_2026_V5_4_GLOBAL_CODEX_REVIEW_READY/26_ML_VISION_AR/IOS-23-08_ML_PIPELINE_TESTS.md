...
5. Проверь: dataset coverage, tolerance, reproducibility, performance, privacy, drift.
...
## Готовый prompt
```text
Примени skill IOS-23-08: «ML/Vision tests» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: golden fixtures, tolerance metrics, device/model variance, regression dataset и deterministic preprocessing.
Проверь: dataset coverage, tolerance, reproducibility, performance, privacy, drift.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
