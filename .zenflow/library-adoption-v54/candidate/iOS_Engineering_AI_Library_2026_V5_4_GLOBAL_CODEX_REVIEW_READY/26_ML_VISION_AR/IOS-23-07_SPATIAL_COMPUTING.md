...
id: IOS-23-07
type: skill
title: Spatial/adaptive experience
domain: Vision, ML, AR & Spatial
priority: production
baseline: Swift 6 / modern iOS
---

# Spatial/adaptive experience

## Назначение
Проектировать input/window/space-aware UX и shared domain logic без iPhone assumptions.
...
5. Проверь: input modality, resizing, depth/space, accessibility, performance, fallback.
...
## Готовый prompt
```text
Примени skill IOS-23-07: «Spatial/adaptive experience» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: проектировать input/window/space-aware UX и shared domain logic без iPhone assumptions.
Проверь: input modality, resizing, depth/space, accessibility, performance, fallback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
