...
5. Проверь: eval quality, capability gating, lifecycle, privacy, thermal, fallback.
...
## Готовый prompt
```text
Примени skill IOS-23-10: «ML/Vision/AR review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: quality metrics, availability, sensor/camera lifecycle, privacy, memory/thermal and fallback.
Проверь: eval quality, capability gating, lifecycle, privacy, thermal, fallback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
