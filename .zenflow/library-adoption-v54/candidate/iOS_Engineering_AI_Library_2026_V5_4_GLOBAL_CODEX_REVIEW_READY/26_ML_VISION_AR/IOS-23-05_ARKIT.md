...
5. Проверь: tracking state, interruptions, availability, sensor permission, battery/thermal, recovery.
...
## Готовый prompt
```text
Примени skill IOS-23-05: «ARKit session» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: session configuration, tracking states, interruptions, permissions, world mapping и device support.
Проверь: tracking state, interruptions, availability, sensor permission, battery/thermal, recovery.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-23-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
