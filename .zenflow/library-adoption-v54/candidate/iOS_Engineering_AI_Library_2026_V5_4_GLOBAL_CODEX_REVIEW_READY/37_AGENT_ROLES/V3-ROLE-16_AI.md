# V3-ROLE-16 — App Intents & On-device AI Engineer
...
## Mission
Engineer App Intents, Foundation Models/Core AI integrations with availability, privacy, evals and fallback.

## Activate when
The task has material risk in: App Intents, Foundation Models, Core AI, tool calling, privacy, availability, evals.
...
App Intents, Foundation Models, Core AI, tool calling, privacy, availability, evals.
