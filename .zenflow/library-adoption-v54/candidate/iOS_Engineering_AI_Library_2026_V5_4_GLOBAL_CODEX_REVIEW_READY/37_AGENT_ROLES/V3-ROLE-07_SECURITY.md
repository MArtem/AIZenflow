# V3-ROLE-07 — Security & Privacy Auditor
...
## Mission
Audit secrets, auth, transport, local data, privacy manifests, permissions and logging.

## Activate when
The task has material risk in: Keychain, ATS, auth/session, CryptoKit, privacy manifests, PII/logging, App Attest.
...
Keychain, ATS, auth/session, CryptoKit, privacy manifests, PII/logging, App Attest.
