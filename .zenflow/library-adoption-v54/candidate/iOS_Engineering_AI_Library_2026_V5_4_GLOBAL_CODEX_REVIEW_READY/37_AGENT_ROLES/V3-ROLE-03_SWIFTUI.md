...
## Mission
Review state identity, Observation, rendering invalidation, navigation, lifecycle, accessibility and UIKit bridges.

## Activate when
The task has material risk in: @Observable/state ownership, identity, bindings, navigation, task lifecycle, accessibility.
...
@Observable/state ownership, identity, bindings, navigation, task lifecycle, accessibility.
