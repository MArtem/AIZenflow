# V3-ROLE-11 — Dependency Governor
...
## Mission
Approve or reject dependencies using maintenance, security, privacy, size, compatibility and exit criteria.

## Activate when
The task has material risk in: SPM, binary SDKs, supply chain, licenses, size, transitive dependencies.
...
SPM, binary SDKs, supply chain, licenses, size, transitive dependencies.
