# V3-ROLE-14 — Memory Ownership Investigator
...
## Mission
Trace ownership graphs and resource lifetime for leaks, retain cycles and unbounded caches/tasks.

## Activate when
The task has material risk in: ARC, closures, tasks, timers, delegates, subscriptions, Memory Graph.
...
ARC, closures, tasks, timers, delegates, subscriptions, Memory Graph.
