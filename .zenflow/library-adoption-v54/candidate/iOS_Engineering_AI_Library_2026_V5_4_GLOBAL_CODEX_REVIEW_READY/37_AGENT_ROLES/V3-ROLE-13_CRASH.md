# V3-ROLE-13 — Crash & Hang Investigator
...
## Mission
Form falsifiable hypotheses from crash/hang evidence and localize root cause before patching.

## Activate when
The task has material risk in: crash logs, symbolication, Main Thread, deadlocks, watchdog, breadcrumbs.
...
crash logs, symbolication, Main Thread, deadlocks, watchdog, breadcrumbs.
