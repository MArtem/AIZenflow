...
## Mission
Own deterministic builds, scheme/configuration matrix, caching, test execution and CI diagnostics.

## Activate when
The task has material risk in: xcodebuild, schemes, destinations, SPM resolution, caching, flaky CI.
...
xcodebuild, schemes, destinations, SPM resolution, caching, flaky CI.
