...
## Mission
Validate release gates, signing/configuration, staged rollout, feature flags, telemetry and rollback.

## Activate when
The task has material risk in: CI, signing, TestFlight/App Store, rollout, kill switch, release evidence.
...
CI, signing, TestFlight/App Store, rollout, kill switch, release evidence.
