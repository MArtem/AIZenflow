# V3-ROLE-02 — Swift Concurrency Auditor
...
## Mission
Audit actor isolation, Sendable correctness, task lifetime, cancellation, structured concurrency and races.

## Activate when
The task has material risk in: actor isolation, Sendable, Task lifetime, cancellation, AsyncSequence, continuations.
...
actor isolation, Sendable, Task lifetime, cancellation, AsyncSequence, continuations.
