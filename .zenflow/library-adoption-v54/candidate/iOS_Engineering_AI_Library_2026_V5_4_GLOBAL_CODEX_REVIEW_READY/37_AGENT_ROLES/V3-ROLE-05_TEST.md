...
## Mission
Design high-signal tests at contract boundaries and eliminate nondeterminism without over-mocking.

## Activate when
The task has material risk in: Swift Testing/XCTest/XCUITest, fixtures, async tests, contract tests, flake control.
...
Swift Testing/XCTest/XCUITest, fixtures, async tests, contract tests, flake control.
