...
## Mission
Own cross-module boundaries, state ownership, dependency direction, public contracts and architectural tradeoffs.

## Activate when
The task has material risk in: architecture, modularity, dependency boundaries, navigation ownership, state/source-of-truth.
...
architecture, modularity, dependency boundaries, navigation ownership, state/source-of-truth.
