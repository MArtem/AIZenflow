...
2. Зафиксируй инварианты и failure modes именно для задачи: **layout reflow, truncation resistance, scalable metrics, content size extremes и scroll fallback**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-02: «Dynamic Type».
...
Особый фокус: layout reflow, truncation resistance, scalable metrics, content size extremes и scroll fallback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
