...
2. Зафиксируй инварианты и failure modes именно для задачи: **FormatStyle/Calendar/TimeZone, user locale, currency/measurement и parsing boundaries**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-07: «Locale formatting».
...
Особый фокус: FormatStyle/Calendar/TimeZone, user locale, currency/measurement и parsing boundaries.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
