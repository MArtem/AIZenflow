...
id: IOS-13-04
type: skill
title: Accessible custom control
...
2. Зафиксируй инварианты и failure modes именно для задачи: **traits/actions/hit target/focus/state announcement и keyboard/switch control considerations**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-04: «Accessible custom control».
...
Особый фокус: traits/actions/hit target/focus/state announcement и keyboard/switch control considerations.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
