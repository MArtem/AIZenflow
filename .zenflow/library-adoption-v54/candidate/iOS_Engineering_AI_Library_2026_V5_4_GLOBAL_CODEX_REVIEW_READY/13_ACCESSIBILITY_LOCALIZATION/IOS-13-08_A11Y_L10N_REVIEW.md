...
id: IOS-13-08
type: skill
title: Accessibility/localization review
...
2. Зафиксируй инварианты и failure modes именно для задачи: **проверить VoiceOver, Dynamic Type, RTL, localization length, locale formatting и motion**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-08: «Accessibility/localization review».
...
Особый фокус: проверить VoiceOver, Dynamic Type, RTL, localization length, locale formatting и motion.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
