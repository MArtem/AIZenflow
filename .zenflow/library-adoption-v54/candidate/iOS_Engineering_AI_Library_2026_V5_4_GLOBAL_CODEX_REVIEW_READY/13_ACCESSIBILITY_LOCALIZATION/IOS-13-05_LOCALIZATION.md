...
2. Зафиксируй инварианты и failure modes именно для задачи: **String Catalog/localized resources, pluralization, grammatical variation и translator context**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-05: «Localization architecture».
...
Особый фокус: String Catalog/localized resources, pluralization, grammatical variation и translator context.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
