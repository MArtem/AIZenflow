...
2. Зафиксируй инварианты и failure modes именно для задачи: **leading/trailing semantics, mirrored assets, mixed-direction text и layout tests**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-06: «RTL/bidi».
...
Особый фокус: leading/trailing semantics, mirrored assets, mixed-direction text и layout tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
