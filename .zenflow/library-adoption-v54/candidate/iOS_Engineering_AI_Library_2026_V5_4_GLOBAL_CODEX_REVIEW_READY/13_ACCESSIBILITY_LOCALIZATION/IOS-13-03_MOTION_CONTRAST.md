...
2. Зафиксируй инварианты и failure modes именно для задачи: **Reduce Motion, differentiate without color, contrast, transparency и sensory alternatives**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-13-03: «Motion/contrast».
...
Особый фокус: Reduce Motion, differentiate without color, contrast, transparency и sensory alternatives.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-13-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
