...
2. Зафиксируй инварианты и failure modes именно для задачи: **transitioning delegate, interactive transitions, cancellation, accessibility Reduce Motion и rotation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-06: «Custom transitions».
...
Особый фокус: transitioning delegate, interactive transitions, cancellation, accessibility Reduce Motion и rotation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
