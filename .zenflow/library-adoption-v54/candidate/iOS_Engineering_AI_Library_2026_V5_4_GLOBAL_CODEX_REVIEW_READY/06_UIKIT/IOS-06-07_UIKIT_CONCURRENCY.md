...
2. Зафиксируй инварианты и failure modes именно для задачи: **MainActor boundaries, task ownership, cancellation on reuse/disappear и stale result protection**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-07: «UIKit + concurrency».
...
Особый фокус: MainActor boundaries, task ownership, cancellation on reuse/disappear и stale result protection.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
