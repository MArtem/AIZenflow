...
id: IOS-06-04
type: skill
title: UICollectionView modern stack
domain: UIKit
priority: production
baseline: Swift 6 / modern iOS
---

# UICollectionView modern stack

## Назначение
Diffable data source, compositional layout, cell registration, prefetch и state updates.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **diffable data source, compositional layout, cell registration, prefetch и state updates**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-04: «UICollectionView modern stack».
...
Особый фокус: diffable data source, compositional layout, cell registration, prefetch и state updates.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
