...
id: IOS-06-05
type: skill
title: UITableView modernization
domain: UIKit
priority: production
...
## Назначение
Diffable/modern cells, self-sizing, reuse, prefetch и smooth updates.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **diffable/modern cells, self-sizing, reuse, prefetch и smooth updates**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-05: «UITableView modernization».
...
Особый фокус: diffable/modern cells, self-sizing, reuse, prefetch и smooth updates.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
