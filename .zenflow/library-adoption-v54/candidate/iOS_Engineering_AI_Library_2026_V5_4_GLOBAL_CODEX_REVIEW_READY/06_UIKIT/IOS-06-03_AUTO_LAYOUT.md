...
## Назначение
Создавать недвусмысленные constraints, Dynamic Type/adaptive layouts и диагностировать ambiguity/conflicts.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **создавать недвусмысленные constraints, Dynamic Type/adaptive layouts и диагностировать ambiguity/conflicts**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-03: «Auto Layout».
...
Особый фокус: создавать недвусмысленные constraints, Dynamic Type/adaptive layouts и диагностировать ambiguity/conflicts.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
