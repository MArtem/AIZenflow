...
## Назначение
Delegates, closures, timers, observers, display links, child controllers и reusable cell capture cycles.
...
2. Зафиксируй инварианты и failure modes именно для задачи: **delegates, closures, timers, observers, display links, child controllers и reusable cell capture cycles**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-08: «UIKit memory».
...
Особый фокус: delegates, closures, timers, observers, display links, child controllers и reusable cell capture cycles.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
