...
2. Зафиксируй инварианты и failure modes именно для задачи: **правильно распределить setup, binding, loading, appearance и teardown по lifecycle**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-01: «UIViewController lifecycle».
...
Особый фокус: правильно распределить setup, binding, loading, appearance и teardown по lifecycle.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
