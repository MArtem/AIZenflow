...
2. Зафиксируй инварианты и failure modes именно для задачи: **lifecycle, containment, main-thread, layout, reuse, memory, accessibility и appearance edge cases**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-06-10: «UIKit code review».
...
Особый фокус: lifecycle, containment, main-thread, layout, reuse, memory, accessibility и appearance edge cases.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-06-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
