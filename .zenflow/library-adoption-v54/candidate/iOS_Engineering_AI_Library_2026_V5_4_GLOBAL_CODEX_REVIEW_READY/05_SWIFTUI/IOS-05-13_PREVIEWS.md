...
id: IOS-05-13
type: skill
title: Previews/dev fixtures
domain: SwiftUI
priority: production
baseline: Swift 6 / modern iOS
---

# Previews/dev fixtures
...
2. Зафиксируй инварианты и failure modes именно для задачи: **создавать deterministic previews с fixtures, error/loading states, locale, Dynamic Type и dark mode**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-13: «Previews/dev fixtures».
...
Особый фокус: создавать deterministic previews с fixtures, error/loading states, locale, Dynamic Type и dark mode.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-13.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
