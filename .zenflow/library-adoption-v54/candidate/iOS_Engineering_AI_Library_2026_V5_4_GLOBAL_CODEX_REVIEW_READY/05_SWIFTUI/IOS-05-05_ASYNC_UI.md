...
2. Зафиксируй инварианты и failure modes именно для задачи: **loading/content/empty/error/refresh/cancel states без races и stale updates**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-05: «Async UI state».
...
Особый фокус: loading/content/empty/error/refresh/cancel states без races и stale updates.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
