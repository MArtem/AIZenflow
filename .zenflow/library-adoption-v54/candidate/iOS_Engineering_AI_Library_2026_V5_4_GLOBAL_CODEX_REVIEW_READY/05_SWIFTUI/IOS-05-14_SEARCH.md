...
2. Зафиксируй инварианты и failure modes именно для задачи: **поиск с debounce/cancellation, server/local filtering, focus, empty states и accessibility**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-14: «Search experience».
...
Особый фокус: поиск с debounce/cancellation, server/local filtering, focus, empty states и accessibility.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
