...
2. Зафиксируй инварианты и failure modes именно для задачи: **выстроить современный data flow, корректное владение model/state и минимальную invalidation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-01: «Observation/@Observable».
...
Особый фокус: выстроить современный data flow, корректное владение model/state и минимальную invalidation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
