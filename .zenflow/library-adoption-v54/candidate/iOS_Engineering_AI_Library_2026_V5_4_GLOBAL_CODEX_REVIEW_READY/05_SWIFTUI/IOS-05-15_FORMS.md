...
2. Зафиксируй инварианты и failure modes именно для задачи: **validation, focus, keyboard, submit flow, formatting, secure fields и accessibility**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-15: «Forms/input».
...
Особый фокус: validation, focus, keyboard, submit flow, formatting, secure fields и accessibility.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-15.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
