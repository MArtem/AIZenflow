...
id: IOS-05-06
type: skill
title: Lists/scroll performance
domain: SwiftUI
priority: production
...
2. Зафиксируй инварианты и failure modes именно для задачи: **оптимизировать identity, lazy containers, prefetch, image loading, expensive body work и hitching**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-06: «Lists/scroll performance».
...
Особый фокус: оптимизировать identity, lazy containers, prefetch, image loading, expensive body work и hitching.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
