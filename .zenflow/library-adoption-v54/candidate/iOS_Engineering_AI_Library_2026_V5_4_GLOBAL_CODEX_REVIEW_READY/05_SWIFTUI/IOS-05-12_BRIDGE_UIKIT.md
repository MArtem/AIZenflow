...
2. Зафиксируй инварианты и failure modes именно для задачи: **корректно управлять coordinator, lifecycle, updates, identity, sizing и memory**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-12: «SwiftUI↔UIKit bridge».
...
Особый фокус: корректно управлять coordinator, lifecycle, updates, identity, sizing и memory.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
