...
2. Зафиксируй инварианты и failure modes именно для задачи: **привязать presentation к state без boolean explosion и competing presentations**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-09: «Sheets/alerts/popovers».
...
Особый фокус: привязать presentation к state без boolean explosion и competing presentations.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
