...
2. Зафиксируй инварианты и failure modes именно для задачи: **типобезопасно моделировать NavigationStack/path, deep links, restoration и modal flows**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-04: «SwiftUI navigation».
...
Особый фокус: типобезопасно моделировать NavigationStack/path, deep links, restoration и modal flows.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
