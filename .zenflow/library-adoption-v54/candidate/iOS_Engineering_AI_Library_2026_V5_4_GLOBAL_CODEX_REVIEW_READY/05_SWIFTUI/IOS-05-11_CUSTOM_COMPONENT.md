...
2. Зафиксируй инварианты и failure modes именно для задачи: **создавать composable, accessible, preview/testable component с минимальным API surface**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-11: «Reusable component».
...
Особый фокус: создавать composable, accessible, preview/testable component с минимальным API surface.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
