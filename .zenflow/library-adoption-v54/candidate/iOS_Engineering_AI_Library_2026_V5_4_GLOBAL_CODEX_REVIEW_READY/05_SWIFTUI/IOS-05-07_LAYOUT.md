...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать layout system, size classes/container sizing, Dynamic Type и iPad multiwindow/resizing**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-07: «Layout & adaptive UI».
...
Особый фокус: использовать layout system, size classes/container sizing, Dynamic Type и iPad multiwindow/resizing.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
