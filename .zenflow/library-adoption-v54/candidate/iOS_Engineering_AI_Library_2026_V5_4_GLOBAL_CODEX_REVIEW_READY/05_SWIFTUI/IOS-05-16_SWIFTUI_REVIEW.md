...
2. Зафиксируй инварианты и failure modes именно для задачи: **искать duplicated state, invalidation storms, identity hacks, side effects in body, async lifetime и accessibility gaps**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-16: «SwiftUI code review».
...
Особый фокус: искать duplicated state, invalidation storms, identity hacks, side effects in body, async lifetime и accessibility gaps.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-16.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
