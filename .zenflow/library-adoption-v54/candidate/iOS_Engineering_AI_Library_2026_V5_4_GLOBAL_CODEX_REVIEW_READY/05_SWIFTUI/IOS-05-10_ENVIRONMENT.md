...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать Environment для scoped dependencies, не скрывая mutable global state**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-10: «Environment/dependencies».
...
Особый фокус: использовать Environment для scoped dependencies, не скрывая mutable global state.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
