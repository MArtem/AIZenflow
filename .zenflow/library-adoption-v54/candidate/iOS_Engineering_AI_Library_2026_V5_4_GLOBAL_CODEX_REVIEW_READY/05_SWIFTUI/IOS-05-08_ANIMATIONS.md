...
2. Зафиксируй инварианты и failure modes именно для задачи: **делать state-driven animations, transaction control, Reduce Motion и performance-safe effects**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-05-08: «Animations».
...
Особый фокус: делать state-driven animations, transaction control, Reduce Motion и performance-safe effects.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-05-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
