...
5. Проверь: codec/container, cancellation, temp files, memory, thermal, background limits.
...
## Готовый prompt
```text
Примени skill IOS-22-05: «Media export/transcode» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: asset reading/writing/export sessions, progress/cancellation, temp storage, HDR/codec compatibility и disk pressure.
Проверь: codec/container, cancellation, temp files, memory, thermal, background limits.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
