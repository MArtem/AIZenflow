...
id: IOS-22-01
type: skill
title: AVFoundation capture session
domain: Media, Audio & Graphics
priority: production
...
5. Проверь: session lifetime, permissions, interruptions, queueing, orientation, memory/thermal.
...
## Готовый prompt
```text
Примени skill IOS-22-01: «AVFoundation capture session» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: спроектировать camera/mic capture session, authorization, configuration, interruptions, orientation, device switching, buffers и teardown.
Проверь: session lifetime, permissions, interruptions, queueing, orientation, memory/thermal.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
