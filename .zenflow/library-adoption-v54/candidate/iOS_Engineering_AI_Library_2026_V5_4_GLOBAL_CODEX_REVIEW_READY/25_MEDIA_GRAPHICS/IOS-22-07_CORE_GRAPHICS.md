...
5. Проверь: scale, color space, clipping, memory, main-thread, accessibility alternative.
...
## Готовый prompt
```text
Примени skill IOS-22-07: «Core Graphics drawing» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: правильно управлять scale/coordinate systems/color spaces/path drawing и offscreen rendering.
Проверь: scale, color space, clipping, memory, main-thread, accessibility alternative.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
