...
id: IOS-22-12
type: skill
title: Media/graphics review
domain: Media, Audio & Graphics
priority: production
baseline: Swift 6 / modern iOS
---

# Media/graphics review

## Назначение
Проверить realtime/lifecycle/permissions/memory/thermal/color-orientation/interruption риски.
...
5. Проверь: lifecycle, permissions, realtime safety, memory, thermal, color/orientation.
...
## Готовый prompt
```text
Примени skill IOS-22-12: «Media/graphics review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: проверить realtime/lifecycle/permissions/memory/thermal/color-orientation/interruption риски.
Проверь: lifecycle, permissions, realtime safety, memory, thermal, color/orientation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
