...
## Назначение
Document loading, page rendering, annotations, search, large-file memory и security of untrusted PDFs.
...
5. Проверь: streaming/large files, annotations, memory, untrusted input, accessibility/search.
...
## Готовый prompt
```text
Примени skill IOS-22-10: «PDFKit» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: document loading, page rendering, annotations, search, large-file memory и security of untrusted PDFs.
Проверь: streaming/large files, annotations, memory, untrusted input, accessibility/search.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
