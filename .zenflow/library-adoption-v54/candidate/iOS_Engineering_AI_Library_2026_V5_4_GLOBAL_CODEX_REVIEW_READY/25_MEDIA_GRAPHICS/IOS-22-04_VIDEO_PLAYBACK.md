...
5. Проверь: buffering, seek cancellation, observer lifetime, PiP, accessibility captions, background.
...
## Готовый prompt
```text
Примени skill IOS-22-04: «AVPlayer playback» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: state/KVO/async observation, buffering, seeking, PiP, interruptions, captions и lifecycle.
Проверь: buffering, seek cancellation, observer lifetime, PiP, accessibility captions, background.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-22-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
