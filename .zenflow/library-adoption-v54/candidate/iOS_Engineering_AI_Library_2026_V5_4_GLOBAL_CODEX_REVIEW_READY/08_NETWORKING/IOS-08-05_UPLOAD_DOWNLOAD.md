...
2. Зафиксируй инварианты и failure modes именно для задачи: **progress, background/resume, temp files, integrity, cancellation и storage pressure**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-05: «Upload/download».
...
Особый фокус: progress, background/resume, temp files, integrity, cancellation и storage pressure.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
