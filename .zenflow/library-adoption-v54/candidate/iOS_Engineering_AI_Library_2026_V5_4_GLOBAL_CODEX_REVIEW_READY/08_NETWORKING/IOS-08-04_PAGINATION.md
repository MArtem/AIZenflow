...
2. Зафиксируй инварианты и failure modes именно для задачи: **cursor/page semantics, duplicate handling, cancellation, refresh, error recovery и stable UI identity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-04: «Pagination».
...
Особый фокус: cursor/page semantics, duplicate handling, cancellation, refresh, error recovery и stable UI identity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
