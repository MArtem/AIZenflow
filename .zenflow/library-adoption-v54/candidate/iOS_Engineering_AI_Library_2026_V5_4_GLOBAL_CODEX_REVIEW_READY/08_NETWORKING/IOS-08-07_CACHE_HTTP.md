...
2. Зафиксируй инварианты и failure modes именно для задачи: **Cache-Control/ETag/Last-Modified, URLCache, invalidation и offline semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-07: «HTTP caching».
...
Особый фокус: Cache-Control/ETag/Last-Modified, URLCache, invalidation и offline semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
