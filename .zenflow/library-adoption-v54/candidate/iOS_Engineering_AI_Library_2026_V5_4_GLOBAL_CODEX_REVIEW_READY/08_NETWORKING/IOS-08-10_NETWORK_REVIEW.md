...
2. Зафиксируй инварианты и failure modes именно для задачи: **HTTP semantics, cancellation, auth races, retry safety, decoding resilience, observability и privacy**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-10: «Networking code review».
...
Особый фокус: HTTP semantics, cancellation, auth races, retry safety, decoding resilience, observability и privacy.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
