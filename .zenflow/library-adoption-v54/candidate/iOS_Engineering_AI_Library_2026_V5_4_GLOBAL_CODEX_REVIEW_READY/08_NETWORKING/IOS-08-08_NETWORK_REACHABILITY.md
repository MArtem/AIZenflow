...
2. Зафиксируй инварианты и failure modes именно для задачи: **не использовать reachability как гарантию; проектировать optimistic requests и recovery**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-08: «Connectivity/offline».
...
Особый фокус: не использовать reachability как гарантию; проектировать optimistic requests и recovery.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
