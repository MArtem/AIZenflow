...
2. Зафиксируй инварианты и failure modes именно для задачи: **URLSession async/await, typed endpoints, request building, decoding, cancellation и observability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-01: «Typed HTTP client».
...
Особый фокус: URLSession async/await, typed endpoints, request building, decoding, cancellation и observability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
