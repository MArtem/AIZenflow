...
2. Зафиксируй инварианты и failure modes именно для задачи: **ATS, trust decisions, pinning trade-offs, rotation, logging redaction и no bypass**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-08-09: «Transport security».
...
Особый фокус: ATS, trust decisions, pinning trade-offs, rotation, logging redaction и no bypass.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-08-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
