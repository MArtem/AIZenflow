...
5. Проверь: risk, change frequency, incident cost, migration path, tests, owner/date.
...
## Готовый prompt
```text
Примени skill IOS-27-02: «Technical debt management» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: оценить debt по risk/change frequency/impact, связать с measurable outcome and staged payoff.
Проверь: risk, change frequency, incident cost, migration path, tests, owner/date.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
