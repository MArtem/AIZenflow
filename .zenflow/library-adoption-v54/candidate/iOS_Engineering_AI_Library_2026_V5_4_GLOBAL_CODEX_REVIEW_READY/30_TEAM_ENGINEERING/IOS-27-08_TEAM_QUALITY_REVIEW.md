...
## Назначение
Связать CI gates, code review, observability, incident feedback, dependency updates and release checklist.
...
5. Проверь: feedback loops, gate signal, ownership, automation, metrics, developer ergonomics.
...
## Готовый prompt
```text
Примени skill IOS-27-08: «Team quality system» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: связать CI gates, code review, observability, incident feedback, dependency updates and release checklist.
Проверь: feedback loops, gate signal, ownership, automation, metrics, developer ergonomics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
