...
5. Проверь: ownership clarity, bus factor, review SLA, escalation, docs, boundaries.
...
## Готовый prompt
```text
Примени skill IOS-27-01: «Code ownership» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: определить module/feature ownership, review paths, incident responsibility and avoid bottlenecks.
Проверь: ownership clarity, bus factor, review SLA, escalation, docs, boundaries.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
