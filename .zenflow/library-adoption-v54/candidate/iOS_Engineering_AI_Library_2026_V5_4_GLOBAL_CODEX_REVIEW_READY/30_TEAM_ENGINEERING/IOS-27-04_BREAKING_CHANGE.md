...
## Назначение
Blast radius, source/data compatibility, rollout coordination, versioning and consumer migration.
...
5. Проверь: consumer inventory, compatibility, migration, versioning, rollback, communication.
...
## Готовый prompt
```text
Примени skill IOS-27-04: «Breaking change review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: blast radius, source/data compatibility, rollout coordination, versioning and consumer migration.
Проверь: consumer inventory, compatibility, migration, versioning, rollback, communication.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
