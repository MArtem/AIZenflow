...
5. Проверь: correctness vs preference, rationale, learning, scope, follow-up, consistency.
...
## Готовый prompt
```text
Примени skill IOS-27-07: «Senior mentoring review» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: объяснять trade-offs and teach review heuristics, not rewrite everything to reviewer preference.
Проверь: correctness vs preference, rationale, learning, scope, follow-up, consistency.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
