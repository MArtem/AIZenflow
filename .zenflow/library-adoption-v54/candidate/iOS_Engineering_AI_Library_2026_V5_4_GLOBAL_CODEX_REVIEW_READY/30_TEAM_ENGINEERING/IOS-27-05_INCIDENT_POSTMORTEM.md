...
5. Проверь: evidence, root cause, detection, guardrails, owner/date, recurrence prevention.
...
## Готовый prompt
```text
Примени skill IOS-27-05: «Incident postmortem» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: blameless timeline/root cause/contributors/detection gaps/action items with owners and verification.
Проверь: evidence, root cause, detection, guardrails, owner/date, recurrence prevention.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
