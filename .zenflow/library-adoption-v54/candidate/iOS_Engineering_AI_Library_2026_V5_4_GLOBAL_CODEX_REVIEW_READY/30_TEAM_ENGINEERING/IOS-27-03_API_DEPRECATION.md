...
5. Проверь: usage inventory, compatibility, migration docs, warnings, timeline, rollback.
...
## Готовый prompt
```text
Примени skill IOS-27-03: «API deprecation» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: staged deprecation annotations/docs/migration aids/usage tracking and removal version.
Проверь: usage inventory, compatibility, migration docs, warnings, timeline, rollback.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
