...
id: IOS-27-06
type: skill
title: Living engineering docs
domain: Team Engineering & Governance
priority: production
...
5. Проверь: ownership, update trigger, source of truth, examples, decision history, discoverability.
...
## Готовый prompt
```text
Примени skill IOS-27-06: «Living engineering docs» как Staff iOS engineer.
...
Сначала опиши lifecycle/state machine и системные ограничения. Особый фокус: document invariants/decisions/runbooks, tie updates to code/release triggers and avoid stale tutorials.
Проверь: ownership, update trigger, source of truth, examples, decision history, discoverability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-27-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
