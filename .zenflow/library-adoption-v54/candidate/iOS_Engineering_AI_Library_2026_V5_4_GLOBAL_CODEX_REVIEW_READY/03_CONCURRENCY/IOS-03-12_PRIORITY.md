...
2. Зафиксируй инварианты и failure modes именно для задачи: **не злоупотреблять priority; проверять inheritance, UI responsiveness и custom executor necessity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-12: «Priority/executors».
...
Особый фокус: не злоупотреблять priority; проверять inheritance, UI responsiveness и custom executor necessity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
