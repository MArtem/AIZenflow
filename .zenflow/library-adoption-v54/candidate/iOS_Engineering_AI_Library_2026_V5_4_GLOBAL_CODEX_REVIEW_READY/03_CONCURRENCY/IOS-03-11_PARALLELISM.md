...
id: IOS-03-11
type: skill
title: Task groups/parallel work
...
2. Зафиксируй инварианты и failure modes именно для задачи: **распараллеливать независимую работу с ограничением fan-out, memory и priority**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-11: «Task groups/parallel work».
...
Особый фокус: распараллеливать независимую работу с ограничением fan-out, memory и priority.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
