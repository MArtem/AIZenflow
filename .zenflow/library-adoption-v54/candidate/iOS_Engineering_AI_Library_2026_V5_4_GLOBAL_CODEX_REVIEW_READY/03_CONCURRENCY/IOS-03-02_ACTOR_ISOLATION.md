...
2. Зафиксируй инварианты и failure modes именно для задачи: **назначить владельца mutable state, boundaries, reentrancy rules и transfer semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-02: «Actor isolation design».
...
Особый фокус: назначить владельца mutable state, boundaries, reentrancy rules и transfer semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
