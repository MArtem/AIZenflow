...
id: IOS-03-01
type: skill
title: Миграция на Swift 6 strict concurrency
domain: Swift Concurrency
priority: production
baseline: Swift 6 / modern iOS
---

# Миграция на Swift 6 strict concurrency
...
2. Зафиксируй инварианты и failure modes именно для задачи: **исправлять data-race design через isolation/ownership вместо подавления diagnostics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-01: «Миграция на Swift 6 strict concurrency».
...
Особый фокус: исправлять data-race design через isolation/ownership вместо подавления diagnostics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
