...
2. Зафиксируй инварианты и failure modes именно для задачи: **моделировать длительные события, cancellation, buffering, backpressure и termination**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-08: «AsyncSequence streams».
...
Особый фокус: моделировать длительные события, cancellation, buffering, backpressure и termination.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
