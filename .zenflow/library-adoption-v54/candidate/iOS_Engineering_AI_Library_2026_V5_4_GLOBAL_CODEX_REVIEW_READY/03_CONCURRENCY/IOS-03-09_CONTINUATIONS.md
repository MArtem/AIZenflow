...
2. Зафиксируй инварианты и failure modes именно для задачи: **безопасно bridge callback API, гарантируя ровно один resume и корректную cancellation story**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-09: «Continuations».
...
Особый фокус: безопасно bridge callback API, гарантируя ровно один resume и корректную cancellation story.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
