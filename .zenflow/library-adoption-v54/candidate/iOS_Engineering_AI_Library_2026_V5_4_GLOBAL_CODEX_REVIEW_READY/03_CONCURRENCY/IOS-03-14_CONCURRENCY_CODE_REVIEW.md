...
2. Зафиксируй инварианты и failure modes именно для задачи: **искать races, unchecked sendability, actor leaks, cancellation bugs, continuation misuse и hidden main-thread work**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-14: «Concurrency code review».
...
Особый фокус: искать races, unchecked sendability, actor leaks, cancellation bugs, continuation misuse и hidden main-thread work.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
