...
2. Зафиксируй инварианты и failure modes именно для задачи: **оставить на MainActor только UI-bound state/work и вынести тяжёлую работу без лишних hops**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-04: «MainActor discipline».
...
Особый фокус: оставить на MainActor только UI-bound state/work и вынести тяжёлую работу без лишних hops.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
