...
id: IOS-03-13
type: skill
title: GCD/OperationQueue migration
domain: Swift Concurrency
priority: production
baseline: Swift 6 / modern iOS
---

# GCD/OperationQueue migration
...
2. Зафиксируй инварианты и failure modes именно для задачи: **постепенно bridge legacy queues к structured concurrency без двойной синхронизации**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-13: «GCD/OperationQueue migration».
...
Особый фокус: постепенно bridge legacy queues к structured concurrency без двойной синхронизации.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-13.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
