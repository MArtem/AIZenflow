...
2. Зафиксируй инварианты и failure modes именно для задачи: **проверить closure captures, reference types, generics, delegates и cross-actor transfers**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-03: «Sendable audit».
...
Особый фокус: проверить closure captures, reference types, generics, delegates и cross-actor transfers.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
