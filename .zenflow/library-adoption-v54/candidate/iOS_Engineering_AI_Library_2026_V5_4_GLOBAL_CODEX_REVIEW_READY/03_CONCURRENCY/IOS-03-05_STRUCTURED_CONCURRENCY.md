...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать async let/task groups с cancellation/error propagation и понятным lifetime**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-03-05: «Structured concurrency».
...
Особый фокус: использовать async let/task groups с cancellation/error propagation и понятным lifetime.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-03-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
