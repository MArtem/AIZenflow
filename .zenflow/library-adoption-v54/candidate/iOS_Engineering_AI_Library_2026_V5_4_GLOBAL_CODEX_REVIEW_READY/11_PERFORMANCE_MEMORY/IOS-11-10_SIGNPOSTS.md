...
2. Зафиксируй инварианты и failure modes именно для задачи: **расставить meaningful intervals/events и privacy-safe metadata для Instruments/MetricKit**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-10: «Signposts».
...
Особый фокус: расставить meaningful intervals/events и privacy-safe metadata для Instruments/MetricKit.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
