...
id: IOS-11-01
type: skill
title: Performance investigation plan
...
2. Зафиксируй инварианты и failure modes именно для задачи: **выбрать Time Profiler, Allocations, Leaks, Memory Graph, Network, SwiftUI/Animation instruments по симптому**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-01: «Performance investigation plan».
...
Особый фокус: выбрать Time Profiler, Allocations, Leaks, Memory Graph, Network, SwiftUI/Animation instruments по симптому.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
