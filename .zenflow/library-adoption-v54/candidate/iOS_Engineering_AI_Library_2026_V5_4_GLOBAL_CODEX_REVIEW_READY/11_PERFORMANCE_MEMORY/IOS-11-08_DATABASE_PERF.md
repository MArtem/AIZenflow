...
2. Зафиксируй инварианты и failure modes именно для задачи: **fetch limits, predicates/indexes, faults, batch operations, N+1 и main-thread fetches**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-08: «Database performance».
...
Особый фокус: fetch limits, predicates/indexes, faults, batch operations, N+1 и main-thread fetches.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
