...
2. Зафиксируй инварианты и failure modes именно для задачи: **устранить busy loops, polling, excessive timers, background work и radio wakeups**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-07: «CPU/energy».
...
Особый фокус: устранить busy loops, polling, excessive timers, background work и radio wakeups.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
