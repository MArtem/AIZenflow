...
2. Зафиксируй инварианты и failure modes именно для задачи: **измерить pre-main/post-main, synchronous initialization, dependency setup, I/O и first-frame work**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-02: «App launch».
...
Особый фокус: измерить pre-main/post-main, synchronous initialization, dependency setup, I/O и first-frame work.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
