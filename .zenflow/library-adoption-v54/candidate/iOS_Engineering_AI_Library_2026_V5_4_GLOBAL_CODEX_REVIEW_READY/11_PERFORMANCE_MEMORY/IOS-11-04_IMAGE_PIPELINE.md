...
2. Зафиксируй инварианты и failure modes именно для задачи: **downsampling, decoding off-main, cache budgets, request deduplication, cancellation и memory pressure**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-04: «Image pipeline».
...
Особый фокус: downsampling, decoding off-main, cache budgets, request deduplication, cancellation и memory pressure.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
