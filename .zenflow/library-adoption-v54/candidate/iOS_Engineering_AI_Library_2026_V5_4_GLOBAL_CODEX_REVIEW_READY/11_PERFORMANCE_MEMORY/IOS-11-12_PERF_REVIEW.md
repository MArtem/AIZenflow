...
2. Зафиксируй инварианты и failure modes именно для задачи: **искать O(n²), repeated allocations, main-thread sync I/O, excessive copying и unbounded caches**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-12: «Performance code review».
...
Особый фокус: искать O(n²), repeated allocations, main-thread sync I/O, excessive copying и unbounded caches.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
