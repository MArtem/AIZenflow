...
2. Зафиксируй инварианты и failure modes именно для задачи: **payload size, compression, caching, connection reuse, serialization и perceived latency**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-09: «Network performance».
...
Особый фокус: payload size, compression, caching, connection reuse, serialization и perceived latency.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
