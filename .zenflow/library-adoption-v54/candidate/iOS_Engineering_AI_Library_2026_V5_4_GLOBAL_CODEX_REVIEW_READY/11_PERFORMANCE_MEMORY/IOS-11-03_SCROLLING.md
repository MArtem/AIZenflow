...
2. Зафиксируй инварианты и failure modes именно для задачи: **найти main-thread stalls, layout churn, image decode, diff size и over-invalidation**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-11-03: «Scrolling/hitching».
...
Особый фокус: найти main-thread stalls, layout churn, image decode, diff size и over-invalidation.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-11-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
