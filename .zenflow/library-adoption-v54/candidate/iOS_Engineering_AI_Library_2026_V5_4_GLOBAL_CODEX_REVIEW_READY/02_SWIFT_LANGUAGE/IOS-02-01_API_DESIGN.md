...
2. Зафиксируй инварианты и failure modes именно для задачи: **сделать API выразительным, source-compatible где нужно, с ясной ownership/error semantics и без stringly-typed контрактов**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-01: «Swift API design».
...
Особый фокус: сделать API выразительным, source-compatible где нужно, с ясной ownership/error semantics и без stringly-typed контрактов.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
