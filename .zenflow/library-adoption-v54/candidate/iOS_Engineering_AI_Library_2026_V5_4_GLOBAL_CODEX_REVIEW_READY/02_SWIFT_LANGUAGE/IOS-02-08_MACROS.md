...
2. Зафиксируй инварианты и failure modes именно для задачи: **оценить macro только при измеримой пользе, с диагностикой, тестированием expansion и контролем build complexity**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-08: «Swift macros».
...
Особый фокус: оценить macro только при измеримой пользе, с диагностикой, тестированием expansion и контролем build complexity.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
