...
2. Зафиксируй инварианты и failure modes именно для задачи: **locale-safe Date/Number/FormatStyle/Calendar/TimeZone обработка**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-11: «Foundation formatting».
...
Особый фокус: locale-safe Date/Number/FormatStyle/Calendar/TimeZone обработка.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
