...
id: IOS-02-13
type: skill
title: C/Objective-C interoperability
...
2. Зафиксируй инварианты и failure modes именно для задачи: **безопасно проектировать bridging, nullability, ownership, generated interfaces и migration path**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-13: «C/Objective-C interoperability».
...
Особый фокус: безопасно проектировать bridging, nullability, ownership, generated interfaces и migration path.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-13.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
