...
id: IOS-02-10
type: skill
title: Collections и algorithms
domain: Swift Language
priority: production
baseline: Swift 6 / modern iOS
---

# Collections и algorithms
...
2. Зафиксируй инварианты и failure modes именно для задачи: **выбрать структуры данных и алгоритмы с учётом complexity, allocation, copying и readability**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-10: «Collections и algorithms».
...
Особый фокус: выбрать структуры данных и алгоритмы с учётом complexity, allocation, copying и readability.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
