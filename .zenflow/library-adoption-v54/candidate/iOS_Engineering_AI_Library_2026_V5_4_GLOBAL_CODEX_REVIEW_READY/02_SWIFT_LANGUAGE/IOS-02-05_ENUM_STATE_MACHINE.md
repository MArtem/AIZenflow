...
id: IOS-02-05
type: skill
title: Enum/state machine modeling
domain: Swift Language
priority: production
baseline: Swift 6 / modern iOS
---

# Enum/state machine modeling
...
2. Зафиксируй инварианты и failure modes именно для задачи: **закодировать допустимые состояния и переходы в типах, исключая impossible states**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-05: «Enum/state machine modeling».
...
Особый фокус: закодировать допустимые состояния и переходы в типах, исключая impossible states.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
