...
2. Зафиксируй инварианты и failure modes именно для задачи: **использовать generics/existentials/opaque types/PAT только там, где это улучшает type safety и abstraction boundary**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-03: «Generics и protocols».
...
Особый фокус: использовать generics/existentials/opaque types/PAT только там, где это улучшает type safety и abstraction boundary.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
