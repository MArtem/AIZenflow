...
id: IOS-02-04
type: skill
title: Ownership и noncopyable types
domain: Swift Language
priority: production
baseline: Swift 6 / modern iOS
---

# Ownership и noncopyable types
...
2. Зафиксируй инварианты и failure modes именно для задачи: **оценить borrowing/consuming/noncopyable подходы для performance/ресурсных типов без преждевременной сложности**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-04: «Ownership и noncopyable types».
...
Особый фокус: оценить borrowing/consuming/noncopyable подходы для performance/ресурсных типов без преждевременной сложности.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
