...
2. Зафиксируй инварианты и failure modes именно для задачи: **спроектировать throws/errors mapping, recoverability, user-facing mapping, logging и retry policy**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-06: «Typed error model».
...
Особый фокус: спроектировать throws/errors mapping, recoverability, user-facing mapping, logging и retry policy.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
