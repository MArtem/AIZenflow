...
2. Зафиксируй инварианты и failure modes именно для задачи: **устойчиво декодировать versioned JSON, dates, lossy fields, polymorphism и schema drift**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-07: «Codable/serialization».
...
Особый фокус: устойчиво декодировать versioned JSON, dates, lossy fields, polymorphism и schema drift.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-07.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
