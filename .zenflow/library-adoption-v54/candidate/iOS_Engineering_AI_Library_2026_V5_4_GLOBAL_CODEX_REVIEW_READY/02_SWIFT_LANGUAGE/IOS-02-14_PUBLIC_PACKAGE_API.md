...
2. Зафиксируй инварианты и failure modes именно для задачи: **проектировать semver-friendly API, SPI, @inlinable exposure и compatibility tests**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-14: «Public package API».
...
Особый фокус: проектировать semver-friendly API, SPI, @inlinable exposure и compatibility tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
