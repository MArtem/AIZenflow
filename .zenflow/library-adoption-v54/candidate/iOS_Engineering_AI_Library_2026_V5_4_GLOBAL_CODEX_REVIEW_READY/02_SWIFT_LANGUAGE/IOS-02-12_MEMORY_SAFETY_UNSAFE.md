...
id: IOS-02-12
type: skill
title: Unsafe/memory safety audit
domain: Swift Language
priority: production
baseline: Swift 6 / modern iOS
---

# Unsafe/memory safety audit
...
2. Зафиксируй инварианты и failure modes именно для задачи: **минимизировать unsafe pointers/C interop, документировать lifetime/alignment/bounds и boundary tests**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-12: «Unsafe/memory safety audit».
...
Особый фокус: минимизировать unsafe pointers/C interop, документировать lifetime/alignment/bounds и boundary tests.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
