...
2. Зафиксируй инварианты и failure modes именно для задачи: **выбрать struct/class/enum по identity, mutation, sharing, performance и concurrency semantics**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-02-02: «Value vs reference semantics».
...
Особый фокус: выбрать struct/class/enum по identity, mutation, sharing, performance и concurrency semantics.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-02-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
