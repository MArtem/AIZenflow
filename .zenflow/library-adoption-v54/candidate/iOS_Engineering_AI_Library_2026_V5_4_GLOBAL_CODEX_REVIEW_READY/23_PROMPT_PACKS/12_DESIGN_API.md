# Спроектировать Swift API

## Назначение
Сделай invalid states unrepresentable, минимальный public surface, concurrency/lifetime/error semantics и examples.
...
Задача: Сделай invalid states unrepresentable, минимальный public surface, concurrency/lifetime/error semantics и examples.
