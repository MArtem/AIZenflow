...
## Назначение
Определи cursor/state machine, refresh, duplicate handling, cancellation, retry и stable UI identity.
...
Задача: Определи cursor/state machine, refresh, duplicate handling, cancellation, retry и stable UI identity.
