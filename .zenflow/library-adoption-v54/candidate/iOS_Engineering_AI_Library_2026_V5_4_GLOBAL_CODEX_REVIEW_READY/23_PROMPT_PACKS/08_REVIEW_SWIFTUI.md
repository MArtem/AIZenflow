...
## Назначение
Ищи duplicated state, identity bugs, over-invalidation, lifecycle leaks, async stale updates и a11y gaps.
...
Задача: Ищи duplicated state, identity bugs, over-invalidation, lifecycle leaks, async stale updates и a11y gaps.
