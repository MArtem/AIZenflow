...
## Назначение
Сначала объясни crash path и invariant violation, затем minimal fix + regression test + adjacent risk scan.
...
Задача: Сначала объясни crash path и invariant violation, затем minimal fix + regression test + adjacent risk scan.
