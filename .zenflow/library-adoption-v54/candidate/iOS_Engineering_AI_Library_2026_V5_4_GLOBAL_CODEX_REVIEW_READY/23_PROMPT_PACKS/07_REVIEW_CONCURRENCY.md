# PR concurrency review

## Назначение
Ищи Sendable/isolation/reentrancy/cancellation/task-lifetime проблемы, включая скрытые через closures/delegates.
...
Задача: Ищи Sendable/isolation/reentrancy/cancellation/task-lifetime проблемы, включая скрытые через closures/delegates.
