...
## Назначение
Permission UX, token lifecycle, categories/actions, payload validation, deep-link routing, analytics/privacy.
...
Задача: Permission UX, token lifecycle, categories/actions, payload validation, deep-link routing, analytics/privacy.
