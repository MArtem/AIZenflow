# Новая feature из Jira/issue

## Назначение
Преврати ticket в implementation plan, найди затронутые модули, перечисли неизвестные факты, затем реализуй минимально рискованно и добавь тесты.
...
Задача: Преврати ticket в implementation plan, найди затронутые модули, перечисли неизвестные факты, затем реализуй минимально рискованно и добавь тесты.
