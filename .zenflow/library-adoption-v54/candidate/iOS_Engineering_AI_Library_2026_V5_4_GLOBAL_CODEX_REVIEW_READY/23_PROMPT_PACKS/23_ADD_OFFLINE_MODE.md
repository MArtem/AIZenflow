...
## Назначение
Определи source of truth, sync queue, conflict policy, retry/idempotency, UX consistency и migrations.
...
Задача: Определи source of truth, sync queue, conflict policy, retry/idempotency, UX consistency и migrations.
