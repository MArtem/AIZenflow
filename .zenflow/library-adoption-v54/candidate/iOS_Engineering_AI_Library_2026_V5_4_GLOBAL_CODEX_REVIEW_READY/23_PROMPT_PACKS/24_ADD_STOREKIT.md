...
## Назначение
StoreKit 2 product/purchase/verification/current entitlements/updates/restore, subscription states, testing and observability.
...
Задача: StoreKit 2 product/purchase/verification/current entitlements/updates/restore, subscription states, testing and observability.
