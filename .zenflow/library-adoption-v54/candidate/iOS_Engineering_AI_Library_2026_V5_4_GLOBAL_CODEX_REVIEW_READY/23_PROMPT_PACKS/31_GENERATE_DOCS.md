...
## Назначение
Документируй responsibilities, public API, state/lifecycle, concurrency, dependencies, error modes, extension points, examples and ownership.
...
Задача: Документируй responsibilities, public API, state/lifecycle, concurrency, dependencies, error modes, extension points, examples and ownership.
