...
## Назначение
Найди retain path и lifetime mismatch; не добавляй weak вслепую; докажи, что объект деаллоцируется.
...
Задача: Найди retain path и lifetime mismatch; не добавляй weak вслепую; докажи, что объект деаллоцируется.
