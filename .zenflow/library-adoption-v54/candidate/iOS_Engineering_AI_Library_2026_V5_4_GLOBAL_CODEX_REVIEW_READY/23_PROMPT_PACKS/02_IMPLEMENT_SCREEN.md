...
## Назначение
Сначала определи state model и navigation, затем UI, async states, accessibility/localization, previews и tests.
...
Задача: Сначала определи state model и navigation, затем UI, async states, accessibility/localization, previews и tests.
