# Снизить memory footprint

## Назначение
Найди retained graphs/caches/buffers/images; определи budget и pressure behavior; не жертвуй correctness ради микровыигрыша.
...
Задача: Найди retained graphs/caches/buffers/images; определи budget и pressure behavior; не жертвуй correctness ради микровыигрыша.
