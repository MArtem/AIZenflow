...
## Назначение
Capability gating, provider/model boundary, structured outputs/tools, privacy, eval dataset, latency/fallback and abuse controls.
...
Задача: Capability gating, provider/model boundary, structured outputs/tools, privacy, eval dataset, latency/fallback and abuse controls.
