...
## Назначение
Контекст → forces → alternatives → decision → consequences → migration/rollback → review trigger.
...
Задача: Контекст → forces → alternatives → decision → consequences → migration/rollback → review trigger.
