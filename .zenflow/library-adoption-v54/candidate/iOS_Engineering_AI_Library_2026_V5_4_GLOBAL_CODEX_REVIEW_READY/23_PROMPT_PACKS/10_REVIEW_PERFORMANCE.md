...
## Назначение
Не гадать: укажи вероятные hot paths, какие метрики нужны, и только доказуемые проблемы помечай blocker.
...
Задача: Не гадать: укажи вероятные hot paths, какие метрики нужны, и только доказуемые проблемы помечай blocker.
