...
## Назначение
Typed request/response, auth, status/error mapping, cancellation, idempotency, retry/cache и tests.
...
Задача: Typed request/response, auth, status/error mapping, cancellation, idempotency, retry/cache и tests.
