...
## Назначение
Собери diagnostics, сгруппируй root causes, исправляй isolation по dependency order, запрети blanket unchecked fixes.
...
Задача: Собери diagnostics, сгруппируй root causes, исправляй isolation по dependency order, запрети blanket unchecked fixes.
