...
## Назначение
Entity/action schema, stable IDs, parameters, authorization, background behavior, discoverability and tests.
...
Задача: Entity/action schema, stable IDs, parameters, authorization, background behavior, discoverability and tests.
