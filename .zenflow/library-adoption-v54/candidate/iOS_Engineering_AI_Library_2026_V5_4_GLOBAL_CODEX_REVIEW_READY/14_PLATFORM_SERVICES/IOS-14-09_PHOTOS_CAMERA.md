...
2. Зафиксируй инварианты и failure modes именно для задачи: **limited library, permission flow, capture session lifecycle, orientation, interruptions и storage**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-09: «Photos/Camera».
...
Особый фокус: limited library, permission flow, capture session lifecycle, orientation, interruptions и storage.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-09.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
