...
2. Зафиксируй инварианты и failure modes именно для задачи: **authorization granularity, queries, background delivery, data minimization и sensitive logging rules**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-08: «HealthKit integration».
...
Особый фокус: authorization granularity, queries, background delivery, data minimization и sensitive logging rules.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-08.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
