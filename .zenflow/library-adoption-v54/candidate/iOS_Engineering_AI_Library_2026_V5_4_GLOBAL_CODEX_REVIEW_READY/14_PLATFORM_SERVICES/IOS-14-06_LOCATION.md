...
2. Зафиксируй инварианты и failure modes именно для задачи: **authorization precision, background modes, energy, geofencing limits и privacy UX**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-06: «Core Location».
...
Особый фокус: authorization precision, background modes, energy, geofencing limits и privacy UX.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-06.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
