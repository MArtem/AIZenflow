...
type: skill
title: StoreKit 2
domain: Apple Platform Services
priority: production
...
2. Зафиксируй инварианты и failure modes именно для задачи: **products, purchase verification, currentEntitlements, updates listener, restore, subscription states и testing**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-11: «StoreKit 2».
...
Особый фокус: products, purchase verification, currentEntitlements, updates listener, restore, subscription states и testing.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-11.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
