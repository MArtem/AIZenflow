...
2. Зафиксируй инварианты и failure modes именно для задачи: **memory/time budgets, app group boundaries, data handoff и extension-safe APIs**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-13: «Extensions/share».
...
Особый фокус: memory/time budgets, app group boundaries, data handoff и extension-safe APIs.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-13.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
