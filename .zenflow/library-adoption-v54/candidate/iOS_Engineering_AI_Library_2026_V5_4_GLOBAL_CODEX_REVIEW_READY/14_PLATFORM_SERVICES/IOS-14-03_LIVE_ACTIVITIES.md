...
2. Зафиксируй инварианты и failure modes именно для задачи: **ActivityKit state/content design, push updates, stale/end lifecycle, privacy и battery**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-03: «Live Activities».
...
Особый фокус: ActivityKit state/content design, push updates, stale/end lifecycle, privacy и battery.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-03.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
