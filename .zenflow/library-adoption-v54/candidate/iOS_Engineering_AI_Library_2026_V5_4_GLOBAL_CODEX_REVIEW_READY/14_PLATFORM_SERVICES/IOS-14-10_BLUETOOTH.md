...
2. Зафиксируй инварианты и failure modes именно для задачи: **state machine, restoration, permissions, reconnect, background constraints и protocol robustness**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-10: «CoreBluetooth».
...
Особый фокус: state machine, restoration, permissions, reconnect, background constraints и protocol robustness.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-10.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
