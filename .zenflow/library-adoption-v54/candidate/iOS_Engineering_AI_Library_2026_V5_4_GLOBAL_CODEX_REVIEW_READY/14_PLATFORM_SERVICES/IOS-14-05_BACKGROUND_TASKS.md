...
2. Зафиксируй инварианты и failure modes именно для задачи: **BGTaskScheduler budgets, expiration, idempotency, persistence и no guaranteed timing**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-05: «Background tasks».
...
Особый фокус: BGTaskScheduler budgets, expiration, idempotency, persistence и no guaranteed timing.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-05.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
