...
2. Зафиксируй инварианты и failure modes именно для задачи: **identity/account changes, sync conflicts, quotas, offline behavior и schema migration**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-12: «CloudKit/iCloud».
...
Особый фокус: identity/account changes, sync conflicts, quotas, offline behavior и schema migration.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-12.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
