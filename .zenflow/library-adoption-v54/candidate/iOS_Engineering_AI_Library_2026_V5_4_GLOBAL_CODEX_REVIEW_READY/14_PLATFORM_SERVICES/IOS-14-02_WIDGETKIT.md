...
2. Зафиксируй инварианты и failure modes именно для задачи: **timeline strategy, App Intent configuration, shared data, relevance, refresh budgets и placeholders**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-02: «WidgetKit».
...
Особый фокус: timeline strategy, App Intent configuration, shared data, relevance, refresh budgets и placeholders.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-02.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
