...
2. Зафиксируй инварианты и failure modes именно для задачи: **size/resizing/input/windowing и shared code без lowest-common-denominator UI**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-14: «Adaptive Apple platforms».
...
Особый фокус: size/resizing/input/windowing и shared code без lowest-common-denominator UI.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-14.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
