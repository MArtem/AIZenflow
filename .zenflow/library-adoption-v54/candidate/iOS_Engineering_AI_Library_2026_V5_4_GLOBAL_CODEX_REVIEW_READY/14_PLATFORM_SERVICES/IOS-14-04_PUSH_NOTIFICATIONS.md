...
2. Зафиксируй инварианты и failure modes именно для задачи: **token lifecycle, categories/actions, foreground handling, deep links, privacy и delivery assumptions**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-04: «Push notifications».
...
Особый фокус: token lifecycle, categories/actions, foreground handling, deep links, privacy и delivery assumptions.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-04.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
