...
2. Зафиксируй инварианты и failure modes именно для задачи: **моделировать discoverable actions/entities, parameters, authorization, background behavior и stable identifiers**.
...
## Готовый prompt
```text
Ты работаешь как Staff iOS engineer. Примени skill IOS-14-01: «App Intents».
...
Особый фокус: моделировать discoverable actions/entities, parameters, authorization, background behavior и stable identifiers.
...
Глубокая operational-версия этого skill: `31_DEEP_PLAYBOOKS/OP-IOS-14-01.md`. Она задаёт обязательные факты, инварианты, режимы исполнения, failure modes и verification ladder.
