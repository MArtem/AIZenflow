...
## PR-specific
- [ ] Review findings resolved or consciously accepted.
- [ ] No secrets/test credentials in diff.
- [ ] Generated files/resources consistent.
- [ ] Feature flag cleanup/owner/date documented if added.
