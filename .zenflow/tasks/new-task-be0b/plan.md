...
- [x] 9.1: зафиксировать promotion/release contract и подготовить варианты A/B/C; owner selected A (internal pilot), фактическая promotion/release операция не выполнялась. Selection receipt: `audit-2026-09-05/implementation/9.1-promotion-selection-2026-09-10.json`.
...
Завершено 29 из 30 implementation blocks (96.7%); это не процент production readiness. Promotion scope A
выбран: internal pilot only; stable QC ждёт user-owned manual workflow на текущем опубликованном HEAD,
а release/production readiness не заявляются.
