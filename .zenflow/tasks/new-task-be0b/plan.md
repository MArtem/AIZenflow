...
- [ ] Phase 7: run final static/runtime-authorized gates, exact-SHA independent review, publication, and remote parity (local gates PASS; push authorization pending).
