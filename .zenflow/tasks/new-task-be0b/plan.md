...
- [ ] 8.2: провести сложный multi-target consumer pilot; German locale boundary remediation PASS и семь clean-snapshot adapters PASS, но profile/workflow pin и runtime/matrix ещё не завершены.
