...
not an active authority. For current source-app work, use the routed baseline and current task state:
`../../AGENTS.md`, `../../docs/README.md`, `../../docs/CURRENT_USER_OVERRIDES.md`,
