...
## Purpose
This document defines mandatory production-quality review gates for any app implementation, refactor, review, or cleanup.
...
- App-specific product policy stays in the app/feature layer.
