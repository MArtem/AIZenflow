...
## Groups
- `./docs/documentation-split/app-specific/` — TchopApp-specific material: current app docs, task history, feed/card contracts, share-extension validation, Tchop package names, and project-specific continuity rules.
...
For a new project/task, copy only the `reusable` group first, then create new project-specific docs instead of importing TchopApp-specific files.
