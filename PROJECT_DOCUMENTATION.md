...
Use `./docs/TASK_TYPE_DOCUMENTATION_ROUTER.md`. This onboarding document is routed for project/code/package orientation; it is not an always-read startup document.
...
This worktree currently contains AI Fieldbook product work. Do not duplicate its product,
architecture, AI, iPhone-only, or verification decisions here. Load them only when AI Fieldbook is
the selected app from:

`/Users/Artem/.zenflow/worktrees/documentation-vault/apps/AIFieldbook/MANIFEST.md`

Tchop, MVVMExample, and BattleshipGame context belongs to their own canonical app boundaries and
is not part of this project's default orientation.
