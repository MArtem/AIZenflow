...
- **Repository path**: `./PackagesInUse/AppFormValidation`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppFormValidation")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppFormValidation`.
