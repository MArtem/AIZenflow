# AppDatabase Usage Guide

## Purpose

`AppDatabase` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- database boundary primitives and SwiftData/Core Data execution managers.

## Keep in the host app

- app schema, migrations, records, seeding, and persistence policy.

## Integration rule

1. Import `AppDatabase` directly where the reusable API is needed.
