...
@Metadata {
    @DisplayName("AppSwiftDataDatabase")
}
...
`AppSwiftDataDatabase` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
