...
@Metadata {
    @DisplayName("AppDatabaseComposition")
}
...
`AppDatabaseComposition` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
