...
public struct AppleAuthenticationIdentity: Sendable, Equatable {
    ...
    /// Apple-issued JWT identity proof that the backend can verify with Apple's public keys.
    public let identityToken: String?

    /// Apple-issued authorization code that the backend can exchange or validate.
    public let authorizationCode: String?

    /// Raw request nonce generated by the app and bound to the Apple authorization request.
    public let nonce: String?

    /// Request state generated by the app to correlate the returned Apple authorization.
...
public struct AppleAuthenticationManager: AppleAuthenticationManaging {
    ...
    public func identity(from authorization: ASAuthorization) throws -> AppleAuthenticationIdentity {
        ...
        return AppleAuthenticationIdentity(
            ...
            identityToken: makeString(from: credential.identityToken),
            authorizationCode: makeString(from: credential.authorizationCode),
    ...
    private func makeString(from data: Data?) -> String? {
        guard let data,
