# AppAppleAuthentication Package Contract
...
Standalone Sign in with Apple adapter package. It owns Apple authentication contracts only and does not depend on app auth/session packages.
