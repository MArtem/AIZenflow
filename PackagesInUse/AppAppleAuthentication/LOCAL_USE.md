# Local Source Use: AppAppleAuthentication
...
3. Remove `import AppAppleAuthentication` from host source files because the package is no longer compiled as a separate module.
