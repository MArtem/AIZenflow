...
- **Repository path**: `./PackagesInUse/AppPermissions`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppPermissions")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppPermissions`.
