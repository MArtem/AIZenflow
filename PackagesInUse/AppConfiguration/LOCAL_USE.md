# Local Source Use: AppConfiguration
...
3. Remove `import AppConfiguration` from host source files because the package is no longer compiled as a separate module.
