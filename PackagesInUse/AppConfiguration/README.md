...
- **Repository path**: `./PackagesInUse/AppConfiguration`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppConfiguration")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppConfiguration`.
