# Local Source Use: TchopProductLocalizationResources
...
3. Remove `import TchopProductLocalizationResources` from host source files because the package is no longer compiled as a separate module.
