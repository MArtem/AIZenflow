# AppWidgetSupport Usage Guide

## Purpose

`AppWidgetSupport` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- generic widget snapshot storage primitives.

## Keep in the host app

- widget timeline composition and product payload shape.

## Integration rule

1. Import `AppWidgetSupport` directly where the reusable API is needed.
