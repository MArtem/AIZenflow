# Local Source Use: AppWidgetSupport
...
3. Remove `import AppWidgetSupport` from host source files because the package is no longer compiled as a separate module.
