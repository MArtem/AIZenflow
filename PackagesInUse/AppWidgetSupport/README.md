...
- **Repository path**: `./PackagesInUse/AppWidgetSupport`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppWidgetSupport")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppWidgetSupport`.
