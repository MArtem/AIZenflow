# AppLocalization Usage Guide

## Purpose

`AppLocalization` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- bundle-backed localized lookup and locale override mechanics.

## Keep in the host app

- product copy and localization key taxonomy.

## Integration rule

1. Import `AppLocalization` directly where the reusable API is needed.
