...
- **Repository path**: `./PackagesInUse/AppGlassUI`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppGlassUI")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppGlassUI`.
