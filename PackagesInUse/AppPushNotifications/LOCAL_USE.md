# Local Source Use: AppPushNotifications
...
3. Remove `import AppPushNotifications` from host source files because the package is no longer compiled as a separate module.
