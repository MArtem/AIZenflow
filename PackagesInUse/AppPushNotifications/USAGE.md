# AppPushNotifications Usage Guide

## Purpose

`AppPushNotifications` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- APNs registration state, push payload parsing, and push manager primitives.

## Keep in the host app

- routing after push interpretation and notification permission UX.

## Integration rule

1. Import `AppPushNotifications` directly where the reusable API is needed.
