...
- **Repository path**: `./PackagesInUse/AppPushNotifications`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppPushNotifications")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppPushNotifications`.
