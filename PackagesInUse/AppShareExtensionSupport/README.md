...
- **Repository path**: `./PackagesInUse/AppShareExtensionSupport`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppShareExtensionSupport")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppShareExtensionSupport`.
