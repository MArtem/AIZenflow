# Local Source Use: AppShareExtensionSupport
...
3. Remove `import AppShareExtensionSupport` from host source files because the package is no longer compiled as a separate module.
