...
@Metadata {
    @DisplayName("AppShareExtensionSupport")
}
...
`AppShareExtensionSupport` is reusable infrastructure. It must expose mechanisms and stable contracts, not app-specific product decisions.
