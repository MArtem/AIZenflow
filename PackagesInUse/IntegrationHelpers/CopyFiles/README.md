...
3. Add required `Sources/**/*.swift` and resources through `./scripts/migrate_packages_in_use_project.py --apply` or an equivalent project edit that preserves the `PackagesInUse/IntegrationHelpers/CopyFiles` Xcode group.
