...
- **Repository path**: `./PackagesInUse/IntegrationHelpers/AppAnalyticsNavigationIntegration`
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/IntegrationHelpers/AppAnalyticsNavigationIntegration`.
...
3. Add required `Sources/**/*.swift` and resources through `./scripts/migrate_packages_in_use_project.py --apply` or an equivalent project edit that preserves the `PackagesInUse/IntegrationHelpers/AppAnalyticsNavigationIntegration` Xcode group.
