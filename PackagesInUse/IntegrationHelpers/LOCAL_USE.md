# Local Source Use: IntegrationHelpers
...
3. Remove `import IntegrationHelpers` from host source files because the package is no longer compiled as a separate module.
