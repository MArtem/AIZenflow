...
- **Repository path**: `./PackagesInUse/IntegrationHelpers/AppAnalyticsNetworkingIntegration`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/IntegrationHelpers/AppAnalyticsNetworkingIntegration")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/IntegrationHelpers/AppAnalyticsNetworkingIntegration`.
