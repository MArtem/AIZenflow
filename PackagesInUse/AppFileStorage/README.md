...
- **Repository path**: `./PackagesInUse/AppFileStorage`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppFileStorage")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppFileStorage`.
