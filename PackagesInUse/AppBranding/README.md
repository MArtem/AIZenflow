...
- **Repository path**: `./PackagesInUse/AppBranding`
...
```swift
dependencies: [
    .package(path: "../PackagesInUse/AppBranding")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesInUse/AppBranding`.
