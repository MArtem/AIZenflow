# Reuse Guide — TchopProductLocalizationResources
...
1. Copy this folder into the target project under `./Packages/TchopProductLocalizationResources`.
2. Run:

```zsh
cd ./Packages/TchopProductLocalizationResources
