...
- **Repository path**: `./PackagesForReuse/TchopProductLocalizationResources`
...
```swift
dependencies: [
    .package(path: "../PackagesForReuse/TchopProductLocalizationResources")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesForReuse/TchopProductLocalizationResources`.
