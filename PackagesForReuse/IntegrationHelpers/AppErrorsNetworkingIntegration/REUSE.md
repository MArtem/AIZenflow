# Reuse Guide — AppErrorsNetworkingIntegration
...
1. Copy this folder into the target project under `./Packages/AppErrorsNetworkingIntegration`.
2. Run:

```zsh
cd ./Packages/AppErrorsNetworkingIntegration
