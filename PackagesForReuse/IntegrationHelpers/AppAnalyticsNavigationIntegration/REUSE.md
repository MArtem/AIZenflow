# Reuse Guide — AppAnalyticsNavigationIntegration
...
1. Copy this folder into the target project under `./Packages/AppAnalyticsNavigationIntegration`.
2. Run:

```zsh
cd ./Packages/AppAnalyticsNavigationIntegration
