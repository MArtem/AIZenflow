# Reuse Guide — AppAnalyticsNetworkingIntegration
...
1. Copy this folder into the target project under `./Packages/AppAnalyticsNetworkingIntegration`.
2. Run:

```zsh
cd ./Packages/AppAnalyticsNetworkingIntegration
