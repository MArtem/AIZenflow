# Reuse Guide — AppAnalyticsPushNotificationsIntegration
...
1. Copy this folder into the target project under `./Packages/AppAnalyticsPushNotificationsIntegration`.
2. Run:

```zsh
cd ./Packages/AppAnalyticsPushNotificationsIntegration
