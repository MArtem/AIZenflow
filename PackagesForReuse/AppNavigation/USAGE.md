# AppNavigation Usage Guide

## Purpose

`AppNavigation` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- tab/router primitives, navigation transitions, snapshots, and diagnostics contracts.

## Keep in the host app

- route payloads, deep-link policy, and feature navigation semantics.

## Integration rule

1. Import `AppNavigation` directly where the reusable API is needed.
