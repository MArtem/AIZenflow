...
- **Repository path**: `./PackagesForReuse/AppNavigation`
...
```swift
dependencies: [
    .package(path: "../PackagesForReuse/AppNavigation")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesForReuse/AppNavigation`.
