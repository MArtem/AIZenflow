# AppConfiguration Usage Guide

## Purpose

`AppConfiguration` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- configuration snapshots, source metadata, staleness, throttling, and safe failure diagnostics.

## Keep in the host app

- environment selection policy and feature-flag semantics.

## Integration rule

1. Import `AppConfiguration` directly where the reusable API is needed.
