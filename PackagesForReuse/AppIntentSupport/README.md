...
- **Repository path**: `./PackagesForReuse/AppIntentSupport`
...
```swift
dependencies: [
    .package(path: "../PackagesForReuse/AppIntentSupport")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesForReuse/AppIntentSupport`.
