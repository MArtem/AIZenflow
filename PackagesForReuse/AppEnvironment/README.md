...
- **Repository path**: `./PackagesForReuse/AppEnvironment`
...
```swift
dependencies: [
    .package(path: "../PackagesForReuse/AppEnvironment")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesForReuse/AppEnvironment`.
