...
- **Repository path**: `./PackagesForReuse/AppAppleAuthentication`
...
```swift
dependencies: [
    .package(path: "../PackagesForReuse/AppAppleAuthentication")
],
targets: [
    .target(
        name: "YourTarget",
...
For Xcode, use **File → Add Package Dependencies… → Add Local…** and select `./PackagesForReuse/AppAppleAuthentication`.
