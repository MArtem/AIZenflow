# Reuse Guide — AppShareExtensionSupport
...
1. Copy this folder into the target project under `./Packages/AppShareExtensionSupport`.
2. Run:

```zsh
cd ./Packages/AppShareExtensionSupport
