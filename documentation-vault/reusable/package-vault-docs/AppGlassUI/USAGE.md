# AppGlassUI Usage Guide

## Purpose

`AppGlassUI` is a single-folder standalone package. Copy the whole folder when moving this capability into another project.

## Use this package for

- SwiftUI Liquid Glass availability checks and fallback chrome mechanics.

## Keep in the host app

- semantic colors, product visual roles, and where glass is used.

## Integration rule

1. Import `AppGlassUI` directly where the reusable API is needed.
