# Reuse Guide — TchopProductLocalizationResourcesAppLocalizationIntegration
...
1. Copy this folder into the target project under `./Packages/TchopProductLocalizationResourcesAppLocalizationIntegration`.
2. Run:

```zsh
cd ./Packages/TchopProductLocalizationResourcesAppLocalizationIntegration
