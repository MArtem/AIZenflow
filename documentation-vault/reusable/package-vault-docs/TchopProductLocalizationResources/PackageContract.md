# TchopProductLocalizationResources Package Contract
...
Standalone product resource package. It is intentionally product-specific, but still copyable as one folder and does not depend on AppLocalization.
