...
Standalone Foundation cache package. It owns memory/file cache mechanisms, record metadata, expiration, and cleanup without app-specific storage policies.
